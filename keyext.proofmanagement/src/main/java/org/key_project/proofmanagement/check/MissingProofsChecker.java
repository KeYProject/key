...
public class MissingProofsChecker implements Checker {
    ...
    private static void removeContractsWithProof(@NonNull Set<Contract> contracts, @NonNull CheckerData data)
    ...
    private static void reportContractsWithoutProof(@NonNull Set<Contract> contracts, @NonNull CheckerData data) {
