...
public class FilesChecker {
    ...
    private static boolean sourcesConsistent(@NonNull Path a, @NonNull Path b) {
        return pathsConsistent(a, b, ProofBundleHandler::getSourceFiles);
    }

    private static boolean classpathsConsistent(@NonNull Path a, @NonNull Path b) {
        return pathsConsistent(a, b, ProofBundleHandler::getClasspathFiles);
    }

    private static boolean bootclasspathsConsistent(@NonNull Path a, @NonNull Path b) {
        /*
     ...
     */
    public static byte[] createSHA256Checksum(@NonNull Path path)
