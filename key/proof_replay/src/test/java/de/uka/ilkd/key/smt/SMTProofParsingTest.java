...
public class SMTProofParsingTest {
    ...
    /**
     * Tests parsing with a large proof (contains most features of Z3 proof terms).
    ...
    /**
     * Tests parsing with a Z3 proof for the contraposition example of KeY.
     */
    @Test
    public void testContrapositionProofParsing() {
        URL large = SMTProofParsing.class.getResource("contraposition.smt2");
