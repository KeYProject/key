...
public class TestgenOptionsPanel extends SettingsPanel implements SettingsProvider {
    ...
    private static final String INFO_APPLY_SYMBOLIC_EX = "Performs bounded symbolic execution on the current proof tree." +
    ...
    private static final String INFO_MAX_PROCESSES = "Maximal number of SMT processes that are allowed to " +
            "run concurrently.";
    ...
    private static final String INFO_INVARIANT_FOR_ALL = "Includes class invariants in the test data constraints. " +
            "I.e., require the class invariant of all created objects to be true in the initial state.";
    private static final String INFO_MAX_UNWINDS = "Maximal number of loop unwinds or method calls on a branch that " +
    ...
    private static final String INFO_REMOVE_DUPLICATES = "Generate a single testcase for two or more nodes which " +
    ...
    private static final String INFO_RFL_SELECTION = "Enables initialization of protected, private, and ghost fields " +
            "with test data, " +
    ...
    private static final String INFO_OPEN_JML_PATH = "Set location of openjml.jar. OpenJML is a third-party " +
    ...
    private static final String INFO_OBJENESIS_PATH = "Set location of objenesis.jar. Objenesis is a thrid-party " +
            "library allows easy object creation from classes which do not have a (public) default constructur.";
    private static final String INFO_INCLUDE_POSTCONDITION = "Includes the negated post condition in the test data " +
    ...
    private JSpinner getMaxProcesses() {
        return addIntNumberField("Concurrent processes:", 0, Integer.MAX_VALUE, 1, INFO_MAX_PROCESSES,
                obj -> {
    ...
    private JSpinner getMaxUnwinds() {
        return addIntNumberField("Maximal unwinds:", 0, Integer.MAX_VALUE, 1, INFO_MAX_UNWINDS,
                e -> {
    ...
    private JCheckBox getRFLSelectionPanel() {
        return
                addCheckBox("Use reflection framework", INFO_RFL_SELECTION, false, val -> {
                    settings.setRFL(val);
                    settings.fireSettingsChanged();
                });
    }
    ...
    private JCheckBox getInvariantForall() {
        return addCheckBox("Require invariant for all objects", INFO_INVARIANT_FOR_ALL, false, val -> {
