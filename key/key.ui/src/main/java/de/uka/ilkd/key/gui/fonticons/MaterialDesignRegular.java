...
public enum MaterialDesignRegular implements IconFont {
    ...
    ADD('\ue145'), ADD_A_PHOTO('\ue439'), ADD_ALARM('\ue193'), ADD_ALERT('\ue003'), ADD_BOX(
            '\ue146'), ADD_CIRCLE('\ue147'), ADD_CIRCLE_OUTLINE('\ue148'), ADD_LOCATION(
                    '\ue567'), ADD_SHOPPING_CART('\ue854'), ADD_TO_PHOTOS('\ue39d'), ADD_TO_QUEUE(
    ...
    WC('\ue63d'), WEB('\ue051'), WEB_ASSET('\ue069'), WEEKEND('\ue16b'), WHATSHOT(
            '\ue80e'), WIDGETS('\ue1bd'), WIFI('\ue63e'), WIFI_LOCK(
                    '\ue1e1'), WIFI_TETHERING('\ue1e2'), WORK('\ue8f9'), WRAP_TEXT(
                            '\ue25b'), YOUTUBE_SEARCHED_FOR('\ue8fa'), ZOOM_IN(
