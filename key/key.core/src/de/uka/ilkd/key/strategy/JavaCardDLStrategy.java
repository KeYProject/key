...
public class JavaCardDLStrategy extends AbstractFeatureStrategy {
    ...
    private void setUpStringNormalisation(RuleSetDispatchFeature d) {
        ...
        bindRuleSet(
                ...
                add(longConst(100), ScaleFeature.createScaled(
                        FindDepthFeature.INSTANCE, 10)));

        bindRuleSet(
                d,
                "defOpsStringEquality",
                add(NonDuplicateAppModPositionFeature.INSTANCE,
                        ifZero(add(applyTF("leftStr", not(stringLiteral)),
        ...
        bindRuleSet(
                ...
                ifZero(applyTF(instOf("str"), stringLiteral), inftyConst(),
                        longConst(500)));
        ...
        bindRuleSet(
                ...
                ifZero(MatchedIfFeature.INSTANCE,
                        ifZero(add(applyTF(instOf("leftStr"), stringLiteral),
    ...
    private void setupPolySimp(RuleSetDispatchFeature d, IntegerLDT numbers) {
        ...
        // 
        bindRuleSet(d, "defOps_expandModulo", add(longConst(-600), IsInRangeProvable.INSTANCE));
                ...
                add(applyTF("divDenom", tf.literal),
                        not(sum(superTerm, SuperTermGenerator
                                .upwardsWithIndex(
                                        ...
                                        getServices()), not(subsumedModulus))));
