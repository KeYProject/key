 ...
 * <ul>
 *    <li>Functionality to load files via {@link #load(Profile, File, List<File>, File, List<File>, Properties, boolean)}.</li>
...
public interface UserInterfaceControl {
   ...
   void removeProverTaskListener(ProverTaskListener ptl);
     ...
     * </p>
     * @param profile An optional {@link Profile} to use. If it is {@code null} the default profile {@link AbstractProfile#getDefaultProfile()} is used.
