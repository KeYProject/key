 ...
 *
 * If a block is encountered during a proof, {@link BlockContract} is used
 * instead.
 * 
 * @author lanzinger
 */
public class FunctionalBlockContract implements Contract {
    ...
    public ProofOblInput createProofObl(InitConfig initConfig,
        ...
        return new FunctionalBlockContractPO(initConfig,
    ...
    public Contract setTarget(KeYJavaType newKJT, IObserverFunction newPM) {
        return new FunctionalBlockContract(contract.setTarget(newKJT, newPM),
                id);
    }
    ...
    /**
     * 
     * @return the corresponding block contract.
     */
