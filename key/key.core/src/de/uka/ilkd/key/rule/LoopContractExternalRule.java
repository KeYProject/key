 ...
 *
 * <p>
 * The validity of all {@link LoopContract}s that were used in the application
 * of this rule must be proven in a {@link FunctionalLoopContractPO} before the
...
public final class LoopContractExternalRule extends AbstractLoopContractRule {
    ...
    public ImmutableList<Goal> apply(final Goal goal, final Services services,
        ...
        final Term[] preconditions = createPreconditions(instantiation.self,
                contract, heaps, localInVariables, conditionsAndClausesBuilder,
                services);
        final Term[] assumptions = createUsageAssumptions(localOutVariables,
