 ...
 * @author lanzinger
 */
public abstract class AbstractLoopContractRule
    ...
    public static ImmutableSet<LoopContract> getApplicableContracts(
            ...
            final Goal goal) {
        ImmutableSet<LoopContract> collectedContracts = specifications
                .getLoopContracts(block, modality);
        if (modality == Modality.BOX) {
            ...
            collectedContracts = collectedContracts.union(specifications
                    .getLoopContracts(block, Modality.DIA_TRANSACTION));
        }
    ...
    protected static ImmutableSet<LoopContract> filterAppliedContracts(
            final ImmutableSet<LoopContract> collectedContracts,
            final Goal goal) {
        ImmutableSet<LoopContract> result = DefaultImmutableSet
                .<LoopContract> nil();
    ...
    public boolean isApplicable(final Goal goal,
        ...
        final ImmutableSet<LoopContract> contracts = getApplicableContracts(
        ...
        for (LoopContract contract : contracts) {
            ...
            // (b) the block starts with a for loop whose head has already been
            // applied
    ...
    protected Map<LocationVariable, Function> createAndRegisterAnonymisationVariables(
            ...
            final LoopContract contract, final TermServices services) {
