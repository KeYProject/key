 ...
 *
 * <p>
 * The validity of all {@link BlockContract}s that were used in the application
 * of this rule must be proven in a {@link FunctionalBlockContractPO} before the
 * current proof is considered closed.
 * </p>
 *
...
public final class BlockContractExternalRule extends AbstractBlockContractRule {
    ...
    private static Term[] createPreconditions(final Instantiation instantiation,
        ...
        final Term selfConditions = conditionsAndClausesBuilder
                .buildSelfConditions(heaps, contract.getMethod(),
                        contract.getKJT(), instantiation.self, services);
    ...
    private static Term[] createUpdates(final Term contextUpdate,
        ...
        final Term[] updates = new Term[] { contextUpdate, remembranceUpdate,
                anonymisationUpdate };
        return updates;
    }
    ...
    public boolean isApplicable(final Goal goal,
        ...
        return !InfFlowCheckInfo.isInfFlow(goal)
                && super.isApplicable(goal, occurrence);
    }
    ...
    public ImmutableList<Goal> apply(final Goal goal, final Services services,
        ...
        BlockContractExternalBuiltInRuleApp application = (BlockContractExternalBuiltInRuleApp) ruleApp;
        ...
        final Term[] preconditions = createPreconditions(instantiation,
        ...
        final Term[] updates = createUpdates(instantiation.update, heaps,
                anonymisationHeaps, variables, conditionsAndClausesBuilder,
                services);
        ...
        final ComplexRuleJustificationBySpec cjust = (ComplexRuleJustificationBySpec) goal
                .proof().getInitConfig().getJustifInfo().getJustification(this);
