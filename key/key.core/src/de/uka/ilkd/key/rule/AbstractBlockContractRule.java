...
public abstract class AbstractBlockContractRule implements BuiltInRule  {
    ...
    /*
     * TODO The following methods are only used for information flow contracts.
     * They should be put into GoalsConfigurator (or a separate inner class).
     */
     ...
     */
    protected static final class VariablesCreatorAndRegistrar {
    ...
    protected static final class UpdatesBuilder extends TermBuilder {
    ...
    protected static final class ConditionsAndClausesBuilder extends TermBuilder {
