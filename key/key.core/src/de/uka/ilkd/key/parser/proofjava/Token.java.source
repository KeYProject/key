...
/* Augmented by the inner class Token.GTToken for ">" treatment */
...
public class Token {
    ...
    public static final Token newToken(int ofKind) {
        switch (ofKind) {
        case ProofJavaParserConstants.RUNSIGNEDSHIFT:
        case ProofJavaParserConstants.RSIGNEDSHIFT:
        case ProofJavaParserConstants.GT:
            return new RealKindToken(ProofJavaParserConstants.GT);
        case ProofJavaParserConstants.IMPLICITIDENTIFIER:
        case ProofJavaParserConstants.LT:
            return new RealKindToken(ProofJavaParserConstants.LT);
        default:
            return new Token();
        }
    }
