...
public class TestTermBuilder {
    ...
    public void testNumberIsVeryBigPositiveInteger() {
        ...
        int[] expected = new int[] { 1, 6, 5, 7, 6, 1, 5, 2, 3, 7, 6, 5, 2, 4, 2, 3, 1, 8, 6, 4, 9,
                3, 6, 7, 4, 9, 6, 2, 1, 4, 3, 6, 9, 2, 6, 1, 3, 4, 9, 6, 1, 2, 7, 4, 6, 9, 8, 7, 1,
                2, 6, 4, 3, 2, 6, 1, 4, 8, 9, 7, 6, 2, 8, 9, 7, 3, 6, 4 };
    ...
    private void testDoubleLongPatterns(String number) {
        ...
        DoubleLiteral literal = services.getTypeConverter().getDoubleLDT().translateTerm(doubleTerm,
                null, services);
