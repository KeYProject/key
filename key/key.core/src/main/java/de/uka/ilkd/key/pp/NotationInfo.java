...
public final class NotationInfo {
     ...
     */
    private Map<Object, Notation> notationTable;
     ...
     */
    private Map<Object, Notation> createPrettyNotation(Services services) {
        Map<Object, Notation> tbl = createDefaultNotation();
        for (LDT ldt : services.getTypeConverter().getLDTs()) {
            var funcs = ldt.getFunctions();
            for (Operator op : funcs) {
                if (op instanceof Function) {
                    var func = (Function) op;
                    var mixFitInfo = func.getMixFitInfo();
                    if (mixFitInfo != null) {
                        final var symbol = mixFitInfo.getSymbol();
                        switch (mixFitInfo.getKind()) {
                        case PREFIX:
                            tbl.put(op, new Notation.Prefix(symbol, getPriorityPrefix(symbol),
                                    PRIORITY_ATOM));
                            break;
                        case INFIX:
                            var args = getPriorityInfixArguments(symbol);
                            tbl.put(op, new Notation.Infix(symbol, getPriorityInfix(symbol), args,
                                    args));
                            break;
                        case POSTFIX:
                            tbl.put(op, new Notation.Postfix(symbol));
                            break;
                        }
                    }
                }
        ...
        var floatLDT = services.getTypeConverter().getFloatLDT();
        var doubleLDT = services.getTypeConverter().getDoubleLDT();
        ...
        /*
         * //arithmetic operators final IntegerLDT integerLDT =
         * services.getTypeConverter().getIntegerLDT(); tbl.put(integerLDT.getNumberSymbol(), new
         * Notation.NumLiteral()); tbl.put(integerLDT.getCharSymbol(), new Notation.CharLiteral());
         * tbl.put(integerLDT.getLessThan(), new Notation.Infix("<", PRIORITY_COMPARISON,
         * PRIORITY_ARITH_WEAK, PRIORITY_ARITH_WEAK)); tbl.put(integerLDT.getGreaterThan(), new
         * Notation.Infix("> ", PRIORITY_COMPARISON, PRIORITY_ARITH_WEAK, PRIORITY_ARITH_WEAK));
         * tbl.put(integerLDT.getLessOrEquals(), new Notation.Infix("<=", PRIORITY_COMPARISON,
         * PRIORITY_ARITH_WEAK, PRIORITY_ARITH_WEAK)); tbl.put(integerLDT.getGreaterOrEquals(), new
         * Notation.Infix(">=", PRIORITY_COMPARISON, PRIORITY_ARITH_WEAK, PRIORITY_ARITH_WEAK));
         * tbl.put(integerLDT.getSub(), new Notation.Infix("-", PRIORITY_ARITH_WEAK,
         * PRIORITY_ARITH_WEAK, PRIORITY_BELOW_ARITH_WEAK)); tbl.put(integerLDT.getAdd(), new
         * Notation.Infix("+", PRIORITY_ARITH_WEAK, PRIORITY_ARITH_WEAK,
         * PRIORITY_BELOW_ARITH_WEAK)); tbl.put(integerLDT.getMul(), new Notation.Infix("*",
         * PRIORITY_ARITH_STRONG, PRIORITY_ARITH_STRONG, PRIORITY_BELOW_ARITH_STRONG));
         * tbl.put(integerLDT.getDiv(), new Notation.Infix("/", PRIORITY_ARITH_STRONG,
         * PRIORITY_ARITH_STRONG, PRIORITY_BELOW_ARITH_STRONG)); tbl.put(integerLDT.getMod(), new
         * Notation.Infix("%", PRIORITY_ARITH_STRONG, PRIORITY_ARITH_STRONG,
         * PRIORITY_BELOW_ARITH_STRONG)); tbl.put(integerLDT.getNeg(),new Notation.Prefix("-",
         * PRIORITY_BOTTOM, PRIORITY_ATOM)); tbl.put(integerLDT.getNegativeNumberSign(), new
         * Notation.Prefix("-", PRIORITY_BOTTOM, PRIORITY_ATOM));
         *
         * final FloatLDT floatLDT = services.getTypeConverter().getFloatLDT();
         * tbl.put(floatLDT.getFloatSymbol(), new Notation.FloatLiteral());
         * tbl.put(floatLDT.getJavaUnaryMinus(), new Notation.Prefix("-", PRIORITY_BOTTOM,
         * PRIORITY_ATOM)); tbl.put(floatLDT.getLessThan(), new Notation.Infix("<",
         ...
         * PRIORITY_ARITH_WEAK, PRIORITY_ARITH_WEAK)); tbl.put(floatLDT.getLessOrEquals(), new
         * Notation.Infix("<=", PRIORITY_COMPARISON, PRIORITY_ARITH_WEAK, PRIORITY_ARITH_WEAK));
         * tbl.put(floatLDT.getGreaterOrEquals(), new Notation.Infix(">=", PRIORITY_COMPARISON,
         * PRIORITY_ARITH_WEAK, PRIORITY_ARITH_WEAK)); tbl.put(floatLDT.getSub(), new
         * Notation.Infix("-", PRIORITY_ARITH_WEAK, PRIORITY_ARITH_WEAK,
         * PRIORITY_BELOW_ARITH_WEAK)); tbl.put(floatLDT.getAdd(), new Notation.Infix("+",
         ...
         * PRIORITY_ARITH_STRONG, PRIORITY_BELOW_ARITH_STRONG)); tbl.put(floatLDT.getDiv(), new
         * Notation.Infix("/", PRIORITY_ARITH_STRONG, PRIORITY_ARITH_STRONG,
         * PRIORITY_BELOW_ARITH_STRONG)); tbl.put(floatLDT.getNeg(),new Notation.Prefix("-",
         * PRIORITY_BOTTOM, PRIORITY_ATOM));
         *
         * final DoubleLDT doubleLDT = services.getTypeConverter().getDoubleLDT();
         * tbl.put(doubleLDT.getDoubleSymbol(), new Notation.DoubleLiteral());
         * tbl.put(doubleLDT.getJavaUnaryMinus(), new Notation.Prefix("-", PRIORITY_BOTTOM,
         * PRIORITY_ATOM)); tbl.put(doubleLDT.getLessThan(), new Notation.Infix("<",
         * PRIORITY_COMPARISON, PRIORITY_ARITH_WEAK, PRIORITY_ARITH_WEAK));
         * tbl.put(doubleLDT.getGreaterThan(), new Notation.Infix(">", PRIORITY_COMPARISON,
         * PRIORITY_ARITH_WEAK, PRIORITY_ARITH_WEAK)); tbl.put(doubleLDT.getLessOrEquals(), new
         * Notation.Infix("<=", PRIORITY_COMPARISON, PRIORITY_ARITH_WEAK, PRIORITY_ARITH_WEAK));
         * tbl.put(doubleLDT.getGreaterOrEquals(), new Notation.Infix(">=", PRIORITY_COMPARISON,
         * PRIORITY_ARITH_WEAK, PRIORITY_ARITH_WEAK)); tbl.put(doubleLDT.getSub(), new
         * Notation.Infix("-", PRIORITY_ARITH_WEAK, PRIORITY_ARITH_WEAK,
         * PRIORITY_BELOW_ARITH_WEAK)); tbl.put(doubleLDT.getAdd(), new Notation.Infix("+",
         * PRIORITY_ARITH_WEAK, PRIORITY_ARITH_WEAK, PRIORITY_BELOW_ARITH_WEAK));
         * tbl.put(doubleLDT.getMul(), new Notation.Infix("*", PRIORITY_ARITH_STRONG,
         * PRIORITY_ARITH_STRONG, PRIORITY_BELOW_ARITH_STRONG)); tbl.put(doubleLDT.getDiv(), new
         * Notation.Infix("/", PRIORITY_ARITH_STRONG, PRIORITY_ARITH_STRONG,
         * PRIORITY_BELOW_ARITH_STRONG)); tbl.put(doubleLDT.getNeg(),new Notation.Prefix("-",
         * PRIORITY_BOTTOM, PRIORITY_ATOM));
         */
    ...
    private int getPriorityPrefix(String symbol) {
        return PRIORITY_BOTTOM;
    }

    private int getPriorityInfixArguments(String symbol) {
        return getPriorityInfix(symbol) + 1;
    }

    private int getPriorityInfix(String symbol) {
        char c = symbol.charAt(0); // first character determines over precedence
        switch (c) {
        case '<':
        case '>':
        ...
        case '+':
        case '-':
            return PRIORITY_ARITH_WEAK;
        case '*':
        case '/':
        case '%':
            return PRIORITY_ARITH_STRONG;
        default:
            return PRIORITY_ATOM;
        }
    }
     ...
     * @param services
     */
    private Map<Object, Notation> createUnicodeNotation(Services services) {
        Map<Object, Notation> tbl = createPrettyNotation(services);
