...
public final class SpecificationRepository {
    ...
    private final Map<Pair<LoopStatement, Integer>, ImmutableSet<LoopContract>>
            ...
            new LinkedHashMap<>();
    private final Map<MergePointStatement, ImmutableSet<MergeContract>> mergeContracts = new LinkedHashMap<>();
    ...
    public ImmutableSet<ClassAxiom> getClassAxioms(KeYJavaType selfKjt) {
        ...
        if (result == null) {
            ...
            for (KeYJavaType kjt : services.getJavaInfo()
                ...
                final IObserverFunction freeInvSymbol = services.getJavaInfo()
                        .getInvFree();
                ...
                final ClassAxiom invFreeRepresentsAxiom = new RepresentsAxiom(
                        "Free class invariant axiom for " + kjt.getFullName(),
                        freeInvSymbol, kjt, new Private(), null, freeInvDef, selfVar,
                        ImmutableSLList.nil(), null);
