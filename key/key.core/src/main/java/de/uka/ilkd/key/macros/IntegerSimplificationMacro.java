...
public class IntegerSimplificationMacro extends AbstractPropositionalExpansionMacro {
    ...
    private static final Set<String> ADMITTED_RULES_SET = asSet(new String[] { "add_eq_back",
            ...
            "polySimp_addLiterals", "polySimp_elimOne", "polySimp_elimOneLeft0",
            "polySimp_mulAssoc", "polySimp_mulLiterals", "pow_literals", "precOfInt",
            "precOfIntPair", "precOfPairInt", "prod_empty", "prod_one", "qeq_literals",
            "square_nonneg", "sub", "sub_literals", "sub_sub_elim", "sub_zero_1", "sub_zero_2",
            "sum_empty", "sum_zero", "times_minus_one_1", "times_minus_one_2", "times_one_1",
            "times_one_2", "times_zero_1", "times_zero_2", "translateJavaAddInt",
            "translateJavaAddLong", "translateJavaCastByte", "translateJavaCastChar",
            "translateJavaCastInt", "translateJavaCastLong", "translateJavaCastShort",
            "translateJavaDivInt", "translateJavaDivLong", "translateJavaMod",
