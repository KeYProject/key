...
class TextualTranslator extends JmlParserBaseVisitor<Object> {
    ...
    public Object visitAccessible_clause(JmlParser.Accessible_clauseContext ctx) {
        ...
        Name[] heaps = visitTargetHeap(ctx.targetHeap());
        final LabeledParserRuleContext ctx2 = createLabeledRuleContext(ctx, OriginTermLabel.SpecType.ACCESSIBLE, ctx.entity_name());
        for (Name heap : heaps) {
            if (depends) {
    ...
    public Object visitAssignable_clause(JmlParser.Assignable_clauseContext ctx) {
        Name[] heaps = visitTargetHeap(ctx.targetHeap());
        final LabeledParserRuleContext ctx2 = createLabeledRuleContext(ctx, OriginTermLabel.SpecType.ASSIGNABLE, ctx.entity_name());
        for (Name heap : heaps) {
    ...
    public Object visitVariant_function(JmlParser.Variant_functionContext ctx) {
        final LabeledParserRuleContext ctx2 = createLabeledRuleContext(ctx, OriginTermLabel.SpecType.DECREASES, ctx.entity_name());
        if (loopContract != null) {
    ...
    public Object visitInitially_clause(JmlParser.Initially_clauseContext ctx) {
        TextualJMLInitially initially = new TextualJMLInitially(mods, ctx);
    ...
    public Object visitSignals_only_clause(JmlParser.Signals_only_clauseContext ctx) {
        ...
        methodContract.addClause(SIGNALS_ONLY,
                createLabeledRuleContext(ctx, OriginTermLabel.SpecType.SIGNALS_ONLY, ctx.entity_name()));
        return null;
    }
    ...
    private LabeledParserRuleContext createLabeledRuleContext(
            ...
            JmlParser.Entity_nameContext nameContext) {
        return new LabeledParserRuleContext(ctx, TextualJMLConstruct.createTermLabel(specType, ctx.start,
    ...
    public Object visitClass_axiom(JmlParser.Class_axiomContext ctx) {
        TextualJMLClassAxiom inv = new TextualJMLClassAxiom(mods,
    ...
    public Object visitLoop_invariant(JmlParser.Loop_invariantContext ctx) {
        ...
        Name[] heaps = visitTargetHeap(ctx.targetHeap());
        for (Name heap : heaps) {
            loopContract.addClause(type, heap, createLabeledRuleContext(ctx,
