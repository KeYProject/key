...
public class ConstructorDeclaration extends MethodDeclaration implements Constructor {
    public ConstructorDeclaration(PositionInfo pi, List<Comment> comments, @Nonnull ImmutableArray<Modifier> modArray, TypeReference returnType, Comment[] voidComments, ProgramElementName name, ImmutableArray<ParameterDeclaration> parameters, Throws exceptions, StatementBlock body, boolean parentIsInterfaceDeclaration) {
        super(pi, comments, modArray, returnType, voidComments, name, parameters, exceptions, body, parentIsInterfaceDeclaration);
    }
