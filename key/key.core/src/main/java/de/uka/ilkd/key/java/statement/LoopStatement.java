...
public abstract class LoopStatement extends JavaStatement
    ...
    public LoopStatement(PositionInfo pi, List<Comment> comments, ILoopInit inits, IForUpdates updates,
    ...
    public LoopStatement() {
        this((PositionInfo) null, null, null, null, null, null);
    }
    ...
    public LoopStatement(Expression guard) {
        this(null, null, null, null, new Guard(guard), null);
    }
    ...
    public LoopStatement(Expression guard, Statement body) {
        this(null, null, null, null, new Guard(guard), body);
    }
    ...
    public LoopStatement(LoopInitializer[] inits, Expression guard,
        ...
        this.updates = new ForUpdates
                (new ImmutableArray<>(Objects.requireNonNullElseGet(updates, () -> new Expression[0])));
     ...
     */
    public LoopStatement(ILoopInit inits, IGuard guard, IForUpdates updates, Statement body, ExtList comments) {
        super(comments);
        this.body = body;
        this.updates = updates;
        this.inits = inits;
    ...
    public LoopStatement(ILoopInit inits, IGuard guard,
                         IForUpdates updates, Statement body) {
        this(null, null, inits, updates, guard, body);
    }

    private static ExtList add(ExtList e, Object o) {
        e.add(o);
        return e;
    }
