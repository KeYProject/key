...
public class Extends extends InheritanceSpecification {
    ...
    public Extends(PositionInfo pi, List<Comment> comments, ImmutableArray<TypeReference> supertypes) {
        super(pi, comments, supertypes);
    }

    public Extends(ImmutableArray<TypeReference> supertypes) {
        super(null, null, supertypes);
    }
