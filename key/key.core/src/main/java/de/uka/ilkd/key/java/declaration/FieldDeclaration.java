...
public final class FieldDeclaration extends VariableDeclaration implements MemberDeclaration {
    private final ImmutableArray<FieldSpecification> fieldSpecs;

    public FieldDeclaration(PositionInfo pi, List<Comment> comments, @Nonnull ImmutableArray<Modifier> modArray,
                            TypeReference typeReference, boolean parentIsInterfaceDeclaration,
                            ImmutableArray<FieldSpecification> fieldSpecs) {
        super(pi, comments, modArray, typeReference, parentIsInterfaceDeclaration);
    ...
    public FieldDeclaration(ExtList children,
        ...
        fieldSpecs = new
                ImmutableArray<>(children.collect(FieldSpecification.class));
    }
