...
public final class DoubleLDT extends LDT implements FloatingPointLDT {
    ...
    /*
     * @Override public Function getFunctionFor(String operatorSymbol, Services services) { //
     * Floating point extensions with "\fp_" case "nan": return getIsNaN(); case "zero": return
     * getIsZero(); case "infinite": return getIsInfinite(); case "nice": return getIsNice(); case
     * "abs": return getAbs(); case "negative": return getIsNegative(); case "positive": return
     * getIsPositive(); case "subnormal": return getIsSubnormal(); case "normal": return
     * getIsNormal(); } return null; }
     */
