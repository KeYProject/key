...
public final class SynchronizedBlock extends JavaStatement
    ...
    public SynchronizedBlock(PositionInfo pi, List<Comment> comments, Expression expression, StatementBlock body,
