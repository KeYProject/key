...
public class ClassDeclaration extends TypeDeclaration implements Statement {
    ...
    public ClassDeclaration(PositionInfo pi, List<Comment> comments, @Nonnull ImmutableArray<Modifier> modArray, ProgramElementName name, ProgramElementName fullName, ImmutableArray<MemberDeclaration> members, boolean parentIsInterfaceDeclaration, boolean isLibrary, Extends extending, Implements implementing, boolean isInnerClass, boolean isLocalClass, boolean isAnonymousClass) {
