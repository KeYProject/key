...
public final class JavaInfo {
    ...
    private HashMap<KeYJavaType, ObserverFunction> staticFreeInvs = new LinkedHashMap<>();
...
//            return "[Y";
    ...
    /**
     * Returns the special symbol <code>&lt;inv_free&gt;</code> which stands for the free class invariant of an object.
     *
     * @see #getInvProgramVar()
     */
    public IObserverFunction getInvFree() {
        if (invFree == null || invFree.getHeapCount(services) != HeapContext.getModHeaps(services, false).size()) {
            ...
            if (invFree == null) {
                invFree = new ObserverFunction("<inv_free>",
                        Sort.FORMULA,
                        null,
                        services.getTypeConverter().getHeapLDT().targetSort(),
                        getJavaLangObject(),
    ...
    /**
     * Returns the special program variable symbol <code>&lt;inv_free&gt;</code>
     * which stands for the free class invariant of an object.
     *
     * @see #getFreeInv()
     */
    ...
    /**
     * Returns the special symbol <code>&lt;$inv&gt;</code> which stands for the static invariant of a type.
     */
    ...
    /**
     * Returns the special symbol <code>&lt$inv_free&gt;</code> which stands for the static invariant of a type.
     */
    public IObserverFunction getStaticInvFree(KeYJavaType target) {
        ...
        if (inv == null) {
            ...
            if (inv == null) {
                inv = new ObserverFunction("<$inv_free>",
                        Sort.FORMULA,
                        null,
                        services.getTypeConverter().getHeapLDT().targetSort(),
                        target,
