...
public class LocalVariableDeclaration
    ...
    public LocalVariableDeclaration(PositionInfo pi, List<Comment> comments, @Nonnull ImmutableArray<Modifier> modArray,
                                    TypeReference typeReference, boolean parentIsInterfaceDeclaration,
                                    ImmutableArray<VariableSpecification> varSpecs) {
    ...
    /**
     * Local variable declaration.
     * @deprecated weigl: This constructor makes no sense.
     */
    @Deprecated
    public LocalVariableDeclaration() {
        this(null, null, new ImmutableArray<>(), null, false, null);
    }
