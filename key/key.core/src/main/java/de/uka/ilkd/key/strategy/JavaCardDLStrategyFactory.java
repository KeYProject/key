...
public class JavaCardDLStrategyFactory implements StrategyFactory {
    ...
    public static final String TOOL_TIP_PROOF_SPLITTING_OFF =
            "<html>" + "Do never split formulas (if-then-else expressions,<br>"
    ...
    public static final String TOOL_TIP_LOOP_INVARIANT = "<html>"
            + "Use loop invariants for loops.<br>" + "Three properties have to be shown:<br>"
    ...
    public static final String TOOL_TIP_LOOP_SCOPE_INVARIANT = "<html>"
            ...
            + "the presence of<br/>" + "potentially exceptional program behavior.</p>" + "</html>";
    ...
    public static final String TOOL_TIP_BLOCK_CONTRACT_EXTERNAL =
            "<html>" + "Java blocks are replaced by their contracts.<br>"
                    + "Two properties are shown:" + "<ul><li>Precondition of contract holds</li>"
                    + "<li>Postcondition holds after block terminates</li>" + "</ul></html>";
    public static final String TOOL_TIP_BLOCK_EXPAND = "<html>"
            + "Do not use block contracts for Java blocks. Expand Java blocks." + "</html>";
    ...
    public static final String TOOL_TIP_ARITHMETIC_MODEL_SEARCH =
            "<html>" + "Support for non-linear inequations and model search.<br>"
                    + "In addition, this performs:" + "<ul>"
    ...
    public static final String TOOL_TIP_QUANTIFIER_NO_SPLITS =
            "<html>" + "Instantiate quantified formulas automatically<br>"
                    ...
                    + "formulas that contain queries are not instantiated<br>" + "automatically."
                    + "</html>";
    ...
    private static OneOfStrategyPropertyDefinition getStopAt() {
        return new OneOfStrategyPropertyDefinition(StrategyProperties.STOPMODE_OPTIONS_KEY,
                ...
                new StrategyPropertyValueDefinition(StrategyProperties.STOPMODE_NONCLOSE,
    ...
    private static OneOfStrategyPropertyDefinition getLoopTreatment() {
        return new OneOfStrategyPropertyDefinition(StrategyProperties.LOOP_OPTIONS_KEY,
                "Loop treatment", 2,
                /*
                 * NOTE (DS, 2019-04-10): Deactivated the built-in loop scope rule since we now have
                 * the loop scope taclets which are based on the same theory, but offer several
                 * advantages.
                 */
    ...
    private static OneOfStrategyPropertyDefinition getQueryTreatment() {
        final OneOfStrategyPropertyDefinition expandLocalQueries =
                new OneOfStrategyPropertyDefinition(StrategyProperties.QUERYAXIOM_OPTIONS_KEY,
                        ...
                        new StrategyPropertyValueDefinition(StrategyProperties.QUERYAXIOM_OFF,
                                "Off", TOOL_TIP_EXPAND_LOCAL_QUERIES_OFF));
        return new OneOfStrategyPropertyDefinition(StrategyProperties.QUERY_OPTIONS_KEY,
                ...
                new StrategyPropertyValueDefinition(StrategyProperties.QUERY_ON, "On",
                        TOOL_TIP_QUERY_ON),
                new StrategyPropertyValueDefinition(StrategyProperties.QUERY_RESTRICTED,
    ...
    private static OneOfStrategyPropertyDefinition getArithmeticTreatment() {
        return new OneOfStrategyPropertyDefinition(StrategyProperties.NON_LIN_ARITH_OPTIONS_KEY,
                ...
                new StrategyPropertyValueDefinition(StrategyProperties.NON_LIN_ARITH_DEF_OPS,
    ...
    private static OneOfStrategyPropertyDefinition getQuantifierTreatment() {
        return new OneOfStrategyPropertyDefinition(StrategyProperties.QUANTIFIERS_OPTIONS_KEY,
                ...
                new StrategyPropertyValueDefinition(
                        ...
                        "No Splits with Progs", TOOL_TIP_QUANTIFIER_NO_SPLITS_WITH_PROGS, 2, 4),
                new StrategyPropertyValueDefinition(StrategyProperties.QUANTIFIERS_INSTANTIATE,
    ...
    private static OneOfStrategyPropertyDefinition getClassAxiom() {
        return new OneOfStrategyPropertyDefinition(StrategyProperties.CLASS_AXIOM_OPTIONS_KEY,
                ...
                new StrategyPropertyValueDefinition(StrategyProperties.CLASS_AXIOM_DELAYED,
    ...
    private static OneOfStrategyPropertyDefinition getAutoInduction() {
        return new OneOfStrategyPropertyDefinition(StrategyProperties.AUTO_INDUCTION_OPTIONS_KEY,
                "Auto Induction",
                new StrategyPropertyValueDefinition(StrategyProperties.AUTO_INDUCTION_LEMMA_ON,
