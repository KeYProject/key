...
public abstract class LDT implements Named {
    ...
    /**
     * get the function in this LDT for an operation identified by generic operatorSymbol. If the
     * LDT does not support this named function, it should return null.
     *
    ...
    public @Nullable Function getFunctionFor(String operatorSymbol, MixFitInfo.Kind kind,
            Services services) {
