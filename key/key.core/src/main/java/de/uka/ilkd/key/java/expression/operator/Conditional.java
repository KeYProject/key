 ...
 */
public final class Conditional extends Operator {
    public Conditional(PositionInfo pi, List<Comment> comments,
                       Expression cond, Expression then, Expression otherwise) {
        super(pi, comments, new ImmutableArray<>(cond, then, otherwise));
    }
