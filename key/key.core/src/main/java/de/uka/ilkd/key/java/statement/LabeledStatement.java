...
public final class LabeledStatement extends JavaStatement
    ...
    public LabeledStatement(PositionInfo pi, List<Comment> comments, Label name, Statement body,
                            PosInProgram firstActiveChildPos, int prefixLength, MethodFrame innerMostMethodFrame) {
        super(pi, comments);
        this.name = name;
        this.body = body;
    ...
    public ImmutableArray<ProgramPrefix> getPrefixElements() {
        if (body instanceof StatementBlock) {
            ...
            return StatementBlock.
                    computePrefixElements(new ImmutableArray<>(body),
                            this);
        }
