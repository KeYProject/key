...
public class HeapSimplificationMacro extends AbstractPropositionalExpansionMacro {
    ...
    private static final Set<String> ADMITTED_RULES_SET = asSet(new String[] { "selectOfStore",
            ...
            "createdInHeapWithSingleton", "createdInHeapWithAllFields",
            "createdInHeapWithArrayRange", "createdInHeapWithSingletonEQ",
            "createdInHeapWithUnionEQ", "createdInHeapWithSetMinusFreshLocsEQ",
            "createdInHeapWithAllFieldsEQ", "createdInHeapWithArrayRangeEQ",
            "createdInHeapWithSelectEQ", "createdInHeapWithObserverEQ",
            ...
            // alpha rules
            "impRight", "andLeft", "orRight", "close", "closeTrue", "closeFalse",
            "ifthenelse_negated",
