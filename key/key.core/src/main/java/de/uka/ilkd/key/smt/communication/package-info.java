 ...
 *      {@link de.uka.ilkd.key.smt.communication.BufferedMessageReader} to split the received
 *      strings into separate messages. </li>
 *     <li> {@link de.uka.ilkd.key.smt.communication.SolverCommunicationSocket} defines the (solver
 *      specific) behaviour for handling solver results.</li>
 *     <li> {@link de.uka.ilkd.key.smt.communication.SolverCommunication} stores the messages sent
 *      to and from the external solver.</li>
 * </ul>
 */
