...
public final class FloatLDT extends LDT implements FloatingPointLDT {
    ...
    /*
     * @Override public Function getFunctionFor(String operatorSymbol, Services services) { case
     * "nan": return getIsNaN(); case "zero": return getIsZero(); case "infinite": return
     * getIsInfinite(); case "nice": return getIsNice(); case "abs": return getAbs(); case
     * "negative": return getIsNegative(); case "positive": return getIsPositive(); case
     * "subnormal": return getIsSubnormal();
     *
