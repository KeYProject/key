...
public class NUIController {
	...
	public void initialize() {
		...
		componentFactory.createComponent("treeView", left, "treeView.fxml", posComponent);
	...
	protected void handleLoadComponent(ActionEvent e) {
		...
		if (posComponent.containsKey(componentName)) {
			...
			case "right":
				...
				break;
			case "bottom":
				componentFactory.createComponent(componentName, down, componentResource, posComponent);
			default:
				break;
			}
		}
