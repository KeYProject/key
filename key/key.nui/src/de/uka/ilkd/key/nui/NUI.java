...
public class NUI extends Application {
    ...
    private void loadComponent(String fileName) throws Exception {
        ...
        System.out.println("FXML " + component.getId() + " was loaded!");
        ...
        System.out.println(
                "Controller " + nuiController.toString() + " was loaded!");
