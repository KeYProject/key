...
public final class ComponentFactory {
     ...
     *
     */
    private static class ComponentMapEntry {
        /**
        ...
        /**
         * Creates a new ComponentMapEntry consisting of a FXMLLoader loader and
         * a Parent parent.
         * 
         * @param loader
         *            The FXMLLoader.
    ...
    /**
     * Returns the singleton instance of the ComponentFactory. <b> The resource
     * directory MUST be set before using the ComponentFactory </b>, use static-access
     * ComponentFactory.
     * {@link de.uka.ilkd.key.nui.ComponentFactory#setResourceDirectory(String)
     * setResourceDirectory(String)}.
     * 
     ...
     * 
     * @param resourceDir
     *            The relative path to the resource directory with the FXML
     *            files.
     */
     ...
     * Controllers.
     */
    private static final Map<String, ComponentMapEntry> componentMap = new HashMap<>();
    ...
    public Parent createComponent(final String id, final String resource) {
        ...
        try {
            final FXMLLoader loader = new FXMLLoader(getClass()
                    .getResource(ComponentFactory.resourceDir + resource));
     ...
     * 
     * @return the Controller, or <tt> null </tt>, if no component with this ID
     *         is currently stored
     */
     ...
     *            The Components FXID or another identifier specified at
     *            construction.
     * @return boolean True iff the component is already stored.
     * 
     */
