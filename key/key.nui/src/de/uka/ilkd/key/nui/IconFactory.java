...
public class IconFactory {
    ...
    /**
     * Returns the image keyHole scaled to the given size, where x indicates the
    ...
    /**
     * Returns the image keyHoleClosed scaled to the given size, where x
     * indicates the width and y the height.
     * 
     * @param x
     *            The desired width of the image
     * @param y
    ...
    /**
     * Returns the image keyFolderBlue scaled to the given size, where x
     * indicates the width and y the height.
     * 
     * @param x
     *            The desired width of the image
    ...
    /**
     * Returns the image keyFolderGray scaled to the given size, where x
     * indicates the width and y the height.
     * 
     * @param x
     *            The desired width of the image
