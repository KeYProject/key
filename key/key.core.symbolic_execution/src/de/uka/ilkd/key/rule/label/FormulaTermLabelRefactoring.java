   ...
   protected boolean shouldRefactorSpecificationApplication(Rule rule, Goal goal, Object hint) {
      if (goal != null) {
         ...
         if ((rule instanceof WhileInvariantRule && WhileInvariantRule.INITIAL_INVARIANT_ONLY_HINT.equals(hint)) ||
             ...
             (rule instanceof BlockContractInternalRule && BlockContractInternalRule.FULL_PRECONDITION_TERM_HINT.equals(hint)) ||
             (rule instanceof BlockContractInternalRule && BlockContractInternalRule.NEW_POSTCONDITION_TERM_HINT.equals(hint)) ||
