...
/**
   ...
   public void xxxtestNewProof() throws ProofInputException, IOException, ParserConfigurationException, SAXException, ProblemLoaderException {
      ...
      SymbolicExecutionEnvironment<DefaultUserInterfaceControl> env = createSymbolicExecutionEnvironment(testCaseDirectory, javaPathInkeyRepDirectory, containerTypeName, methodFullName, null, false, false, false, false, false, false, false, false, false, false);
      try {
         // Resume
   ...
   public void testProofFile() throws ProofInputException, IOException, ProblemLoaderException {
      ...
      // Create proof environment for symbolic execution
      SymbolicExecutionEnvironment<DefaultUserInterfaceControl> env = createSymbolicExecutionEnvironment(testCaseDirectory, javaPathInkeyRepDirectory, false, false, false, false, false, false, false, false, false, false, false);
      try {
         // Do test steps
         doParallelSiteProofTest(env);
      }
