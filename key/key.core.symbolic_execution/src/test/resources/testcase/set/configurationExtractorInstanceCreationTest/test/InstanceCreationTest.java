...
public class InstanceCreationTest {
	...
	public int compute() {
		InstanceCreationTest.classWrapper = new InstanceCreationTestWrapper(1);
		...
		if (next != null) {
			...
			return InstanceCreationTest.classWrapper.value + instanceWrapper.value + next.instanceWrapper.value + localWrapper.value;
		}
		else {
			return -100;
		}
