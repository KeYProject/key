...
public class MiscKit {
     ...
     *             element.
     * @param node a program element that might be a descendant of (or identical
    ...
    /**
     * Transformation that renames a program element. If the new name is
     * different from the old one, a new Identifier is created and replaces the
     * old one.
     *
