...
public class MethodKit {
    ...
    public static MethodDeclaration createAdapterMethod(ReferencePrefix delegationObject,
        ...
        clone.setComments(new ASTArrayList<Comment>(
                new DocComment("/** generated by createAdapterMethod */")));
    ...
    public static ClassDeclaration createPackerClass(String packerClassName,
        ...
        // modified class?
        packClass = factory
                .createClassDeclaration(modifierlist, factory.createIdentifier(packerClassName),
                        factory.createExtends(factory.createTypeReference(
