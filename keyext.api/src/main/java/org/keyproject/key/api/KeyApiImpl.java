...
public record KeyApiImpl(KeyAdapter adapter) implements KeyApi {
    ...
    @Override
    public CompletableFuture<MacroStatistic> script(Proof proof, String scriptLine, StreategyOptions options) {
        return null;
    }

    @Override
    public CompletableFuture<MacroStatistic> macro(Proof id, String macroId, StreategyOptions options) {
        return null;
    }
