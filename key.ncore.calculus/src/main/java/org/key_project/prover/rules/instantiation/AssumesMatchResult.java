...
/// record
/// keeps for a given formula the list of successful instantiations for the sequent formula as well
/// as
/// their corresponding math results (match conditions) that break down the candidate formula to
/// instantiations
...
/// the
/// candidate information is used to decide whether to split the goal or not. See
/// [AssumesFormulaInstantiation]
...
/// found at
/// the i-th position of list `matchConditions`.
///
///
