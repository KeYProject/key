 ...
 */
public NotFreeIn{if(!(first.isVariable())){throw new RuntimeException("Expected a SchemaVariable "+"that has been only allowed to match "+"variables");}}
...
public boolean equals(Object o){if(!(o instanceof NotFreeIn(SchemaVariable first1,SchemaVariable second1))){return false;}return first1==first()&&second1==second();}
