...
/**
 * Implementations of this interface know which schema variables have been matched and their respective
 * instantiations.
 */
public interface SVInstantiations {

    /**
     * retrieves the schema variable of the specified name if it has already been instantiated, otherwise {@code null}
     * is returned
     ...
     * @param name Name of the schema variable
     * @return the instantiation of the schema variable, {@code null} if no instantiation for a schema variable of the
     ...
     * @return the instantiation of the schema variable, {@code null} if no instantiation for the schema variable is
     * available
     */
    ...
    /**
     * returns a map that contains all instantiated schema variables and their respective instantiation
     * @return a map that contains all instantiated schema variables and their respective instantiation
     */
    ImmutableMap<SchemaVariable, InstantiationEntry<?>> getInstantiationMap();

    /**
     * <p>returns a new {@link SVInstantiations} object that contains all instantiations contained in {@code this} and
     * the {@code other} {@link SVInstantiations} object
     *</p>
     * <p>
     * For performance reasons it is the responsibility of the caller to ensure that the union can be computed, e.g.
     * to ensure that no schema variable is instantiated with different values
     * </p><p>
     * Implementations might perform their own (partial) checks and throw a runtime exception if this assumption is violated.
     * </p>
