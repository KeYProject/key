...
/**
 * This record contains information about a modification of a formula in a sequent. The provided position
 * information describes the position of the sub-formula/term in the original formula that has been replaced.
