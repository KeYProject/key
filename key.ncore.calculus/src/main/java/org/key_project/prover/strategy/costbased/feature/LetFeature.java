 ...
 */
public class LetFeature<Goal extends ProofGoal<@NonNull Goal>> implements Feature<Goal> {

    private final TermBuffer<Goal> var;
    private final ProjectionToTerm<Goal> value;
    private final Feature<Goal> body;

    public static <Goal extends ProofGoal<@NonNull Goal>> Feature<Goal> create(TermBuffer<Goal> var,
            ProjectionToTerm<Goal> value, Feature<Goal> body) {
        return new LetFeature<>(var, value, body);
    }

    private LetFeature(TermBuffer<Goal> var, ProjectionToTerm<Goal> value, Feature<Goal> body) {
        this.var = var;
        this.value = value;
        this.body = body;
    }
