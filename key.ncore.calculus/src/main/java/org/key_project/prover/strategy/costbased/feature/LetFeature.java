...
// @StableCost: a let-binding is transparent -- its bound value is a ProjectionToTerm over the
// app/find term and its body is recursed; local iff the body is. (Reuse only applies while the
// find position is unmodified, so the projected focus term is stable.)
@StableCost
