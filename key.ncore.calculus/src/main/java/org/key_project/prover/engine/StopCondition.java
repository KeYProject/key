 ...
 */
public interface StopCondition<P extends ProofObject<G>, G extends ProofGoal<G>> {
    /**
     ...
     * @param proof The current {@link ProofObject}.
     * @return The maximal amount of work or {@code 0} if it is unknown.
     */
    int getMaximalWork(int maxApplications, long timeout, P proof);
     ...
     */
    boolean isGoalAllowed(int maxApplications, long timeout, P proof, long startTime,
            int countApplied, G goal);

    /**
     * Returns the reason why the previous check via
     * {@link #isGoalAllowed(int, long, P, long, int, G)} has
     ...
     */
    String getGoalNotAllowedMessage(int maxApplications, long timeout, P proof,
            long startTime, int countApplied, G goal);
     ...
     */
    boolean shouldStop(int maxApplications, long timeout, P proof, long startTime,
     ...
     */
    String getStopMessage(int maxApplications, long timeout, P proof, long startTime,
            int countApplied, SingleRuleApplicationInfo singleRuleApplicationInfo);
}
