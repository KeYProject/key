 ...
 * @author christoph
 */
public class FinishAuxiliaryComputationMacro implements ProofMacro {
    ...
    public void applyTo(KeYMediator mediator,
        ...
        addContractApplicationTaclets(initiatingGoal, proof, initiatingGoal);
...
//        return TB.and(TB.or(goalFormulas1), TB.or(goalFormulas2));
    ...
    private void addContractApplicationTaclets(Goal goal,
                                               Proof symbExecProof,
                                               Goal initiatingGoal) {
        for (Rule r : symbExecProof.env().getRegisteredRules()) {
            if (r instanceof Taclet) {
                ...
                if (t.getSurviveSymbExec()) {
                    goal.addTaclet(t, SVInstantiations.EMPTY_SVINSTANTIATIONS, true);
