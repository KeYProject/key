...
public class TryCloseWithoutSplittingMacro implements ProofMacro {
     ...
     */
    public TryCloseWithoutSplittingMacro() {
        this.numberSteps = -1;
    }
     ...
     */
    public TryCloseWithoutSplittingMacro(int numberSteps) {
    ...
    public String getName() {
        return "Close provable goals below without splits";
    }
    ...
    public void applyTo(final KeYMediator mediator, PosInOccurrence posInOcc) {
        ...
        final String oldDepMode =
                properties.getProperty(StrategyProperties.DEP_OPTIONS_KEY);
        ...
        // deactivate dependency contracts
        properties.put(StrategyProperties.DEP_OPTIONS_KEY,
        ...
        mediator.addAutoModeListener(new AutoModeListener() {
            ...
            public void autoModeStopped(ProofEvent e) {
                ...
                // set splitting back to old setting
                properties.put(StrategyProperties.SPLITTING_OPTIONS_KEY, oldSplittingMode);
                // set dependency contract option back to old setting
                properties.put(StrategyProperties.DEP_OPTIONS_KEY, oldDepMode);
                strategySettings.setActiveStrategyProperties(properties);
