...
public class TGWorker extends SwingWorker<Void, Void> implements InterruptListener, StopRequest {
	...
	public TGWorker(TGInfoDialog tgInfoDialog){
		...
		this.testGenerator = new MainWindowTestGenerator(getMediator(), originalProof);
	}
   ...
   public static class MainWindowTestGenerator extends AbstractTestGenerator {
       ...
       */
      @Override
      protected Proof createProof(KeYMediator mediator, Proof oldProof, String newName, Sequent newSequent) {
       ...
       */
      public void removeGeneratedProofs(KeYMediator mediator) {
