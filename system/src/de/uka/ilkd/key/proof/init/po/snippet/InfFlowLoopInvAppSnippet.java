...
public class InfFlowLoopInvAppSnippet extends ReplaceAndRegisterMethod
    ...
    public Term produce(BasicSnippetData d, ProofObligationVars poVars1,
        ...
        Term preCond1 = f1.create(BasicPOSnippetFactory.Snippet.LOOP_INV);
        Term preCond2 = f2.create(BasicPOSnippetFactory.Snippet.LOOP_INV);
        

        InfFlowPOSnippetFactory iff =
                POSnippetFactory.getInfFlowFactory(d, poVars1, poVars2);
        Term inOutRelations =
                iff.create(InfFlowPOSnippetFactory.Snippet.INF_FLOW_INPUT_OUTPUT_RELATION);
