 ...
 *          <li>{@code a<<l>> ~~> b<<l>>} The application {@link Term} {@code a} contains the label before. Use an application {@link TermLabelPolicy} to ensure that it is maintained. Implementations should not iterate over subterms!</li>
 *          <li>{@code Update[...]<<l>> ~~> Update[...new...]<<l>>} The application {@link Term} {@code Update} contains a {@link Modality}. Use a modality {@link TermLabelPolicy} to ensure that it is maintained. Implementations should not iterate over subterms!</li>
 *          <li>{@code 2 + 3 ~~> 5<>a>>}: Implement a {@link TermLabelUpdate} which adds, sorts or removes {@link TermLabel} before a new {@link Term} is created.</li>
 *          <li>{@code 2<<a>> + 3<<b>> ~~> 5<<a>>}: TODO: Only possible with a {@link TermLabelUpdate}.</li>
 *          <li>{@code 2 + (3<<a>> - 1<<b>>) ~~> 4<<a>>}: TODO: Only possible with a {@link TermLabelUpdate}.</li>
