...
public class SuccTaclet extends FindTaclet{
    ...
    protected void applyReplacewith(TermLabelState termLabelState, TacletGoalTemplate gt, 
       ...
       if (gt instanceof AntecSuccTacletGoalTemplate) {
          ...
          replaceAtPos(termLabelState, replWith.succedent(), currentSequent, posOfFind, services, matchCond, new TacletLabelHint(TacletOperation.REPLACE_AT_SUCCEDENT, replWith));
          addToAntec(termLabelState, replWith.antecedent(), currentSequent, null, services, matchCond, posOfFind, new TacletLabelHint(TacletOperation.REPLACE_TO_ANTECEDENT, replWith));	   	    	    
       } 
    }
