...
import de.uka.ilkd.asmkey.logic.AccessDFInfoContainer;
...
/** This condition check if a rule #R may access a function dynamic
 * function; this is determined by static analysis.
 * @author Stanislas Nanchen
 */
public final class MayAccessCondition extends AbstractTwoSchemaVariablesCondition{

    public MayAccessCondition(boolean may, SchemaVariable r, SchemaVariable t) {
	super(may, r, t);
    }
	...
	Term term = (Term) subst;
        ...
        if (var == x) {
            ...
            if (ty == null) {
                ...
                return (AsmUtil.mayAccess((AccessDFInfoContainer) term, ty)) == equal;
            }
        } else if (var == y) {
            ...
            if (tx == null) {
                ...
                return (AsmUtil.mayAccess((AccessDFInfoContainer) tx, term)) == equal;
            }
        } else {
            return true;
        }
