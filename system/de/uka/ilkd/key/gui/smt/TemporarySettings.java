...
public class TemporarySettings extends Settings {
		    ...
		    public void eventChange() {
		        ...
		        setSelected(((TemporarySolverSettings) getUserObject()).useForMulitpleProvers);
                	...
                	return "All provers for which this option is activated\n" +
                		...
                		"is applied.\n\n"+
                		"At least two provers must be activated to enable the rule\n"+
                		"'multiple provers'.";
                    }
	...
	TableComponent data[] = {
		    ...
		    public String getInfo(){
			return "Specify how many different generic sorts are allowed\n"+
			 "within a taclet.\n\n"+
			 "Be aware of the fact that to many different generic sorts can\n" +
