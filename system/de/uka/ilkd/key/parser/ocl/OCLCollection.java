...
class OCLCollection {
     ...
     */
    public OCLCollection(Term element, int collectionType) throws OCLTranslationError {
     ...
     * @throws OCLTranslationError 
     */
    public OCLCollection(Term element) throws OCLTranslationError {
     ...
     * @throws OCLTranslationError 
     */
    public OCLCollection union(OCLCollection c) throws OCLTranslationError {
     ...
     * @throws OCLTranslationError 
     */
    public OCLCollection collect(Services services, Term collectTerm) throws OCLTranslationError {
     ...
     * @throws OCLTranslationError 
     */
    public OCLCollection collect(Services services, Association assoc, String name) throws OCLTranslationError {
     ...
     * @throws OCLTranslationError 
     */
    public OCLCollection select(LogicVariable selectVar, Term selectTerm) throws OCLTranslationError {
