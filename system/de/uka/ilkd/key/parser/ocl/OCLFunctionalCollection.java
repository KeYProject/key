...
class OCLFunctionalCollection {
     ...
     */
    protected OCLFunctionalCollection(int collectionType, Term element) throws OCLTranslationError {
     ...
     * @throws OCLTranslationError 
     */
    protected OCLFunctionalCollection(Term element) throws OCLTranslationError {
    ...
    protected OCLFunctionalCollection(Term lowerBound, 
                         Term upperBound, 
                         Function leq) throws OCLTranslationError {
     ...
     * @throws OCLTranslationError 
     */
    protected OCLFunctionalCollection union(OCLCollection c) throws OCLTranslationError {
     ...
     * @throws OCLTranslationError 
     */
    public OCLFunctionalCollection collect(Term collectTerm) throws OCLTranslationError {
        ...
        Term restriction = tf.createFunctionTerm(f,params);

        int collectionType = (this.collectionType == OCLCollection.OCL_SEQUENCE) ? 
                OCLCollection.OCL_SEQUENCE : OCLCollection.OCL_BAG;
        
        return new OCLFunctionalCollection(restriction,collectionType);
    }
     ...
     * @throws OCLTranslationError 
     */
    public OCLFunctionalCollection select(LogicVariable selectVar, Term selectTerm) throws OCLTranslationError {
        ...
        return new OCLFunctionalCollection(restriction,this.collectionType);
    }
