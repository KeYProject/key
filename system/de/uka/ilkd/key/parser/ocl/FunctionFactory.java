...
public class FunctionFactory {
    ...
    public Function createSelectFunction(LogicVariable selectVar,
            Term selectTerm,
            int collectionType) throws OCLTranslationError
    {
...
//        Function selectE = new RigidFunction( new Name(csort.elementSort().toString()+"::select"),
    ...
    private void raiseError(String msg) throws OCLTranslationError{
		throw new OCLTranslationError("Error while generating Functions: " + msg);
	}
    ...
    public Term including(Term setSymbol, Term element) throws OCLTranslationError {
    ...
    public Term excluding(Term setSymbol, Term element) throws OCLTranslationError {
    ...
    public Term union(Term t1, Term t2) throws OCLTranslationError {
    ...
    public Term createRangedSet(Term lowerBound, Term upperBound, Function leq) throws OCLTranslationError {
    ...
    public Term createRangedBag(Term lowerBound, Term upperBound, Function leq) throws OCLTranslationError {
    ...
    public Term createRangedSequence(Term lowerBound, Term upperBound, Function leq) throws OCLTranslationError {
    ...
    public Term unionAndSimplify(Term t1, Term t2) throws OCLTranslationError {
