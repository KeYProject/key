...
/* Augmented by the inner class Token.RealkindToken for ">" treatment */
...
public class Token {
    ...
    public static final Token newToken(int ofKind) {
        switch (ofKind) {
        case SchemaJavaParserConstants.RUNSIGNEDSHIFT:
        case SchemaJavaParserConstants.RSIGNEDSHIFT:
        case SchemaJavaParserConstants.GT:
            return new RealKindToken(SchemaJavaParserConstants.GT);
        case SchemaJavaParserConstants.IMPLICITIDENTIFIER:
        case SchemaJavaParserConstants.LT:
            return new RealKindToken(SchemaJavaParserConstants.LT);
        default:
            return new Token();
        }
    }

    public static class RealKindToken extends Token {

        int realKind;

        public RealKindToken(int k) {
            realKind = k;
        }
