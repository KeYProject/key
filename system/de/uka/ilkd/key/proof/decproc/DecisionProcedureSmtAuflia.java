...
public abstract class DecisionProcedureSmtAuflia extends AbstractDecisionProcedure {
    ...
    private static final String logDir = Main.KEY_CONFIG_DIR + File.separator + "SmtTrans_Logs";
    private static final String logFileCreateError = "SMT log file could not be created!\n";
    
    private static final String archiveDir = Main.KEY_CONFIG_DIR + File.separator + "SmtBench_Archive";
