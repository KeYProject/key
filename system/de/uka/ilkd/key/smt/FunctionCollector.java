        ...
        private boolean isFunction (Term t, Services services) {
                ...
                if (t.op() instanceof ArrayOp) {
                        isFun = true;
                                ...
                                && !(t.op() == services.getTypeConverter().getIntegerLDT().getAdd()
                                                || t.op() == services.getTypeConverter().getIntegerLDT().getSub()
                                                || t.op() == services.getTypeConverter().getIntegerLDT().getNeg()
                                                || t.op() == services.getTypeConverter().getIntegerLDT().getMul()
                                                || t.op() == services.getTypeConverter().getIntegerLDT().getDiv()
                                                || t.op() == services.getTypeConverter().getIntegerLDT().getLessThan()
                                                || t.op() == services.getTypeConverter().getIntegerLDT().getGreaterThan()
                                                || t.op() == services.getTypeConverter().getIntegerLDT().getLessOrEquals()
                                                || t.op() == services.getTypeConverter().getIntegerLDT().getGreaterOrEquals()
                                                || t.op() == services.getTypeConverter().getIntegerLDT().getNumberSymbol()
                                ) && !(t.sort() == Sort.FORMULA)
                                ) {
                        isFun = true;
                }
