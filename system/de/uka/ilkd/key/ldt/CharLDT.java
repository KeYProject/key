...
public final class CharLDT extends AbstractIntegerLDT {
    
    private static final Name NAME = new Name("jchar");
    
    
    public CharLDT(Namespace sorts, Namespace functions) {
        super((Sort)sorts.lookup(NAME), PrimitiveType.JAVA_CHAR, functions);
    }
