...
public final class ShortLDT extends AbstractIntegerLDT {
    
    private static final Name NAME = new Name("jshort");
    
    
    public ShortLDT(Namespace sorts, Namespace functions) {
        super((Sort)sorts.lookup(NAME), PrimitiveType.JAVA_SHORT, functions);   
    }
