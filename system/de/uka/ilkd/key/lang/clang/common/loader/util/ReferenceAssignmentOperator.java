...
public class ReferenceAssignmentOperator extends cetus.hir.BinaryOperator {
        public static final ReferenceAssignmentOperator REFERENCE_ASSIGNMENT = new ReferenceAssignmentOperator(0);

        private ReferenceAssignmentOperator(int value) {
                super(value);
        }
