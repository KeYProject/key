...
/**
 * ProgramSV sort that matches on expressions of value type.
 * 
 * @author oleg.myrk@gmail.com
 */
public class ValueExpressionSort extends BaseExpressionProgramSVSort {

        public ValueExpressionSort() {
                super(new Name("ClangValueExpression"));
        }
