...
public final class NotEquals extends BaseClangExpression {
        ...
        public KeYJavaType getTypePair(IClangEnvironment environment) {
                ...
                if (!(typePair0.getJavaType() == typePair1.getJavaType() &&
                        ...
                        throw new TypeErrorException("Inequality applied to incompatible types (no promotions)", this);
