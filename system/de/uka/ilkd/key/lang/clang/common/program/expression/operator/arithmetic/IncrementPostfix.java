...
public final class IncrementPostfix extends BaseClangExpression {
        
        public IncrementPostfix(IClangExpression expression) {
                super(expression);
        }

        public IncrementPostfix(ExtList children, IncrementPostfix original) {
                super(children, original);
        }
        
        public IProgramElement copy(ExtList children) {
                return new IncrementPostfix(children, this);
        }
        
        public void dispatch(IClangProgramDispatcher p) throws java.lang.Exception {
                p.dispatchIncrementPostfix(this);
        }
        ...
        public KeYJavaType getTypePair(IClangEnvironment environment) {
                ...
                if (isLvalue == Boolean.FALSE)
                        throw new TypeErrorException("IncrementPostfix must be applied to a lvalue", this);
                ...
                if (!(ArithmeticUtils.isNonPromotableType(valueTypePair.getJavaType()) ||
                        ...
                        throw new TypeErrorException("IncrementPostfix applied to incompatible type (no promotions)", this);
