...
/**
 * ProgramSV sort that matches on program variables.
 * 
 * @author oleg.myrk@gmail.com
 */
public class VariableSort extends BaseVariableProgramSVSort {

        public VariableSort() {
                super(new Name("ClangVariable"));
        }

        protected boolean canStandFor(IProgramElement pe, IClangEnvironment context) {
                return (pe instanceof IClangVariable);
        }
}