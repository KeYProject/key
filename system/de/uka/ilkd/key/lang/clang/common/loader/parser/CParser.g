...
//compoundStatement2 [CompoundStatement init_stmt] returns [CompoundStatement stmt]{
compoundStatement2 [CompoundStatement stmt]{
				//stmt = null;
                //Added by Daniel
                //stmt = init_stmt;
                //
        ...
        :       lcur:LCURLY^ {linenum = lcur.getLine();}
                ...
                rcur:RCURLY 
                {
                	linenum = rcur.getLine();
                   	//putPragma(rcur,stmt);
                    symtab = prev_symtab;
                    //System.out.println("CParser::compoundStatement2() ==> stmt = " + stmt);
                }
        ;
...

{
  ...
  public void setCountingTokens(boolean ct) 
  {
	...
	public void setParser(CParser p){
		parser = p;
	}
 /*
