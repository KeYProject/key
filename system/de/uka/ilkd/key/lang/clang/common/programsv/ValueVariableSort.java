...
/**
 * ProgramSV sort that matches on program variables of value type.
 * 
 * @author oleg.myrk@gmail.com
 */
public class ValueVariableSort extends BaseVariableProgramSVSort {

        public ValueVariableSort() {
                super(new Name("ClangValueVariable"));
        }
