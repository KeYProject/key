...
public class ValueOfOperator extends cetus.hir.UnaryOperator {
        public static final ValueOfOperator VALUE_OF = new ValueOfOperator(0);

        private ValueOfOperator(int value) {
                super(value);
        }
