 ...
 * are from type String and the corresponding values are ArithmeticTypeDecl types
...
public class HashMapFromStringToArithmeticTypeDecl implements java.io.Serializable {
    
    /** the wrapped HashMap */
    private HashMap map;

    /** creates an empty HashMap with keys of type String and values of
     * type ArithmeticTypeDecl
     */
    public HashMapFromStringToArithmeticTypeDecl() {
	map=new HashMap();
    }

    /** used by clone, handsover a HashMap map */
    private HashMapFromStringToArithmeticTypeDecl(HashMap map) {
	this.map=map;
    }
    ...
    public Object clone() {
	return new HashMapFromStringToArithmeticTypeDecl((HashMap)map.clone());
    }
    ...
    public boolean containsValue(ArithmeticTypeDecl val) {
	return map.containsValue(val);
    }

    /** @return value of ArithmeticTypeDecl that is mapped to key, null if key has no
    * mapping */
    
    public ArithmeticTypeDecl get(String key) {
	return (ArithmeticTypeDecl)map.get(key);
    }
     ...
     */
    public ArithmeticTypeDecl put(String key, ArithmeticTypeDecl val) {
	return (ArithmeticTypeDecl)map.put(key,val);
    }

    /** removes mapping for the specified key
     * @return the deleted value 
     */
    public ArithmeticTypeDecl remove(String key) {
	return (ArithmeticTypeDecl)map.remove(key);
    }
    ...
    /** @return IteratorOfArithmeticTypeDecl with all values */
    public IteratorOfArithmeticTypeDecl values() {
    ...
    private static class HashMapValueIterator implements IteratorOfArithmeticTypeDecl{
	...
	public ArithmeticTypeDecl next() {
	    return (ArithmeticTypeDecl)it.next();
	}
