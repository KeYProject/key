...
/**
 * Rigid constant <code>{parent}::MIN : int</code>.
 * @author oleg.myrk@gmail.com
 */
public class MinConstant extends BaseRigidOperator implements IFunction {        
        private final IntegerSort parent;
        
        public MinConstant(IntegerSort parent, Sort intSort) {
                super(  new Name(parent.name() + "::MIN"),
                        intSort,
                        new Sort[0]
                        );
                this.parent = parent;
