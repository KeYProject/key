...
/**
 * Meta operation that computes division quotient of two integer literals.
 * 
 * @author oleg.myrk@gmail.com
 */
public class DivMetaOp extends BaseClangMetaOp {

        public DivMetaOp() {
                super(new Name("#ClangDiv"), 2);
        }
        ...
        protected Term calculate(Term term, IClangEnvironment context) {
                ...
                BigInteger result = arg1.divide(arg2);
