...
class PrimitiveScheme implements TypeScheme {
    public static final PrimitiveScheme INSTANCE = new PrimitiveScheme();
    
    
    private PrimitiveScheme() {}
    ...
    public boolean subSchemeOf(TypeScheme ts) {
        return (ts instanceof PrimitiveScheme);
    }
