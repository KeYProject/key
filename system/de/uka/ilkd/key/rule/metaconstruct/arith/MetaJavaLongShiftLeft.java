 ...
 */
public class MetaJavaLongShiftLeft extends AbstractMetaOperator {

    public MetaJavaLongShiftLeft() {
	super(new Name("#JavaLongShiftLeft"), 2);
    }
	...
	return term.op() instanceof MetaJavaLongShiftLeft && term.arity()==arity();
    }
