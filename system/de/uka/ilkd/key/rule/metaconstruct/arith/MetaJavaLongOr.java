 ...
 */
public class MetaJavaLongOr extends AbstractMetaOperator {

    public MetaJavaLongOr() {
	super(new Name("#JavaLongOr"), 2);
    }
	...
	return term.op() instanceof MetaJavaLongOr && term.arity()==arity();
    }
