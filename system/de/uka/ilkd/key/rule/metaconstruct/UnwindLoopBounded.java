...
/** @author gladisch 
 * This class performs unwinding of loops. Unlike the class UnwindLoop this
 * class performs upto several unwindings at once and then entirely removes 
 * the loop. This is desired for k-bounded testing where k is the number
 * of considered loop iteration. k has usually the value 1,2, or 3.
 * Here is an example for k=1 e.g. 
 * <code>
 * while ( i<10 ) {
 *   i++
 * }  
 ...
 * </code>           
 */
public class UnwindLoopBounded extends ProgramMetaConstruct implements MetaConstructWithSV {
     ...
     */
    public UnwindLoopBounded(SchemaVariable innerLabel, SchemaVariable outerLabel, 
                      LoopStatement loop) {
	super("#unwind-loop-bounded", loop); 
	...
	final WhileLoopTransformation2 w = 
	    new WhileLoopTransformation2(originalLoop,
					(ProgramElementName)
