 ...
 */
public abstract class MetaField extends AbstractMetaOperator {

    public MetaField(String name, boolean isStatic) {
	super(new Name(name), isStatic ? 0 : 1 );
    }
    ...
    public abstract Term calculate(Term term, SVInstantiations svInst,
			  Services services);
