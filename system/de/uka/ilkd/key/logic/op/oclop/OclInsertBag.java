 ...
 */
public class OclInsertBag extends TermSymbol {
       
    public OclInsertBag() {
	super(new Name("$insert_bag"), OclSort.BAG_OF_OCLANY);
    }
	...
	return CollectionSort
	    .getCollectionSort(CollectionSort.BAG,
			       elemSort);
    }
    ...
    public String proofToString() {
       ...
       s+="("+OclSort.OCLANY+","+OclSort.BAG_OF_OCLANY;
       s+=");\n";
       return s;
    }
}
