...
/**
 * Represents an empty OCL Sequence.
 ...
 */
public class OclEmptySequence extends TermSymbol {
       
    public OclEmptySequence() {
	super(new Name("$empty_sequence"), OclSort.SEQUENCE_OF_OCLANY);
    }
