...
/**
 * Represents the OCL operations: at(), first(), last()
 */
public class OclSequenceElems extends TermSymbol {

    private int arity;
   
    public OclSequenceElems(Name name, int arity) {
	super(name, OclSort.OCLANY);
	this.arity = arity;
    }
