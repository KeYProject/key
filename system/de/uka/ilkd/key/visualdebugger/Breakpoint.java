 ...
 * in the source code. Breakpoints are either <em>enabled</em>
 * or <em>disabled</em>. 
 */
public class Breakpoint {
     ...
     * @param id the SourceElementId identifying uniquely an occurrence of
    ...
    /**
     * enables or disables the breakpoint
     * @param enabled boolean indicating if the breakpoint has to be enabled or disabled
     */
    ...
    /**
     * the occurrence of the source element in the code to which the breakpoint is attached
     * @return the {@link SourceElementId} referring to an occurrence of a source code element 
     */
