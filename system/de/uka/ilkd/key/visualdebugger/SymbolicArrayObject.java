...
public class SymbolicArrayObject extends SymbolicObject {
    ...
    public void setIndexConfiguration(SetOfTerm constraints){                
        ...
        for (Iterator it2 = this.indexTerm2EquClass.values().iterator();it2.hasNext();){
         
            EquClass cl =(EquClass) it2.next();
            this.equClass2Repr.put(cl, getRepres(cl));
/*            System.out.println("AAAAAAAAAAA");
            System.out.println("Class "+cl.members );
            System.out.println("Repr "+this.getRepres(cl));
*/        }
    ...
    public SymbolicArrayObject(Term cl, ClassType t,Services s,SetOfTerm possibleIndexTerms){
...
//        System.out.println(this.index2S0);
        HashSet s = new HashSet((this.isPrimitiveType())? index2term.keySet(): this.index2SO.keySet());
 ...
 //   public getal
    ...
    public void setValueTermForIndex(Term index, Term value){
        ...
        if (indexTerm2EquClass.containsKey(index) && 
                this.equClass2Repr.containsKey(indexTerm2EquClass.get(index)) 
        )
