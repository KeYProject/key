...
/** 
 * Starts and runs a proof attempt mostly separated from 
 * the rest of the KeY system. It may be used for non-user 
 * visible sub proofs.
 */
public class ProofStarter {
     ...
     * @param maxSteps the int limiting the maximal amount of steps
     * done in automatic proof mode     
     * @throws an IllegalArgumentException if <tt>maxSteps</tt> is lesser than zero
     */
   public void setMaxSteps(int maxSteps) {
     ...
     * @param po the ProofOblInput with the proof (proof attempt is only 
    ...
    public boolean run(ProofEnvironment env) {
        ...
        try {
            ...
            VisualDebugger.print("ProofStarter: Applied "+countApplied+" Rules");
        } catch(Throwable e) {
...
//  - Note: This should be removed
    public void applySimplificationOnGoals(ListOfGoal goals) {
        ...
        while (i.hasNext()) {          
            ...
            if (p.getSettings().getDecisionProcedureSettings()
                    .useSimplify()) {
                ...
                p.getUserConstraint().getConstraint());
