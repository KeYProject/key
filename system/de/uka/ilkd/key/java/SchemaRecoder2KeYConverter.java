...
public class SchemaRecoder2KeYConverter extends Recoder2KeYConverter {
	...
	public ExecutionContext convert(
		...
		return new ExecutionContext((TypeReference) callConvert(ec
				.getTypeReference()), (ReferencePrefix) callConvert(ec
				.getRuntimeInstance()));
	}
	...
	public For convert(recoder.java.statement.For f) {
		...
		if (f.getInitializers() != null
				&& f.getInitializers().getLoopInitializer(0) instanceof de.uka.ilkd.key.java.recoderext.ExpressionSVWrapper) {
			de.uka.ilkd.key.java.recoderext.ExpressionSVWrapper esvw = (de.uka.ilkd.key.java.recoderext.ExpressionSVWrapper) f
					.getInitializers().getLoopInitializer(0); // brrrr!
		...
		if (f.getUpdates() != null
				&& f.getUpdates().getExpression(0) instanceof de.uka.ilkd.key.java.recoderext.ExpressionSVWrapper) {
			de.uka.ilkd.key.java.recoderext.ExpressionSVWrapper esvw = (de.uka.ilkd.key.java.recoderext.ExpressionSVWrapper) f
					.getUpdates().getExpression(0);
