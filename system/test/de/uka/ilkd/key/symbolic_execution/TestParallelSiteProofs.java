...
public class TestParallelSiteProofs extends AbstractSymbolicExecutionTestCase {
   ...
   public void testNewProof() throws ProofInputException, IOException, ParserConfigurationException, SAXException, ProblemLoaderException {
      ...
      SymbolicExecutionEnvironment<CustomConsoleUserInterface> env = createSymbolicExecutionEnvironment(keyRepDirectory, javaPathInkeyRepDirectory, containerTypeName, methodFullName, null, false, false);
      // Resume
   ...
   public void testProofFile() throws ProofInputException, IOException, ProblemLoaderException {
      ...
      // Create proof environment for symbolic execution
      SymbolicExecutionEnvironment<CustomConsoleUserInterface> env = createSymbolicExecutionEnvironment(keyRepDirectory, javaPathInkeyRepDirectory, false, false);
      // Do test steps
      doParallelSiteProofTest(env);
   }
