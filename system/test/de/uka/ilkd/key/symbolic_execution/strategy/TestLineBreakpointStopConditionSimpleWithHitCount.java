...
public class TestLineBreakpointStopConditionSimpleWithHitCount extends AbstractSymbolicExecutionTestCase {
   ...
   public void testBreakpointStopCondition() throws ProofInputException, IOException, ParserConfigurationException, SAXException, ProblemLoaderException {
      ...
      // Define test settings
         ...
         LineBreakpointStopCondition firstBreakpoint = new LineBreakpointStopCondition(keyRepDirectory+"\\examples\\_testcase\\set\\lineBreakpointsWithHitcountTest\\test\\BreakpointStopCallerAndLoop.java", 16, -1, env, callerMain, env.getBuilder().getProof(), allBreakpoints, null, true, false, 15, 21);
         LineBreakpointStopCondition secondBreakpoint = new LineBreakpointStopCondition(keyRepDirectory+"\\examples\\_testcase\\set\\lineBreakpointsWithHitcountTest\\test\\BreakpointStopCallerAndLoop.java", 10, 2, env, callerLoop, env.getBuilder().getProof(), allBreakpoints, null, true, false, 8, 13);
         LineBreakpointStopCondition thirdBreakpoint = new LineBreakpointStopCondition(keyRepDirectory+"\\examples\\_testcase\\set\\lineBreakpointsWithHitcountTest\\test\\BreakpointStopCallee.java", 7, -1, env, calleeMain, env.getBuilder().getProof(), allBreakpoints, null, true, false, 6, 9);
