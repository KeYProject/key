...
public class TestKeYWatchpointGlobalVariablesOnSatisfiable extends
   ...
   public void testBreakpointStopCondition() throws ProofInputException, IOException, ParserConfigurationException, SAXException, ProblemLoaderException {
      ...
      try{
         ...
         String javaPathInkeyRepDirectory = "examples/_testcase/set/keyWatchpointGlobalVariablesOnSatisfiable/test/GlobalVariablesOnSatisfiable.java";
         String containerTypeName = "GlobalVariablesOnSatisfiable";
         final String methodFullName = "doSomething";
         String oraclePathInkeyRepDirectoryFile = "examples/_testcase/set/keyWatchpointGlobalVariablesOnSatisfiable/oracle/GlobalVariablesOnSatisfiable";
         ...
         KeYWatchpointStopCondition globalVariableCondition = new KeYWatchpointStopCondition(keyRepDirectory+"\\examples\\_testcase\\set\\keyWatchpointGlobalVariablesOnSatisfiable\\test\\GlobalVariablesOnSatisfiable.java", -1, env, env.getBuilder().getProof(), allBreakpoints, "x_global==17", true, true, containerType, false);
