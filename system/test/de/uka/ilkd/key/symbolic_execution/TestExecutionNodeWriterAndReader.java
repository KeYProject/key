...
public class TestExecutionNodeWriterAndReader extends TestCase {
   ...
   protected IExecutionNode createModel() {
      ...
      KeYlessValue bnVar1Value = new KeYlessValue(bnVar1, "myType", "myValue", "value of bnVar1", true, false);
      bnVar1.setValue(bnVar1Value);
      KeYlessVariable bnVar2 = new KeYlessVariable(null, false, -1, "bnVar2");
      bn.addVariable(bnVar2);
      KeYlessValue bnVar2Value = new KeYlessValue(bnVar2, "myTypeAgain", "myValueAgain", "value of bnVar2", false, true);
      bnVar2.setValue(bnVar2Value);
      ...
      s.addVariable(sVar1);
      KeYlessValue sVar1Value = new KeYlessValue(sVar1, "myType", "myValue", "value of sVar1", false, false);
      sVar1.setValue(sVar1Value);
      KeYlessVariable sVar1_1 = new KeYlessVariable(sVar1Value, true, 2, "sVar1_1");
      sVar1Value.addChildVariable(sVar1_1);
      KeYlessValue sVar1_1Value = new KeYlessValue(sVar1_1, "myType", "myValue", "value of sVar1_1", true, true);
      sVar1_1.setValue(sVar1_1Value);
      KeYlessVariable sVar1_1_1 = new KeYlessVariable(sVar1_1Value, true, 1, "sVar1_1_1");
      sVar1_1Value.addChildVariable(sVar1_1_1);
      KeYlessValue sVar1_1_1Value = new KeYlessValue(sVar1_1_1, "myType", "myValue", "value of sVar1_1_1", true, false);
      sVar1_1_1.setValue(sVar1_1_1Value);
      KeYlessVariable sVar1_2 = new KeYlessVariable(sVar1Value, true, 2, "sVar1_2");
      sVar1Value.addChildVariable(sVar1_2);
      KeYlessValue sVar1_2Value = new KeYlessValue(sVar1_2, "myType", "myValue", "value of sVar1_2", false, true);
      sVar1_2.setValue(sVar1_2Value);
      KeYlessVariable sVar1_2_1 = new KeYlessVariable(sVar1_2Value, true, 2, "sVar1_2_1");
      sVar1_2Value.addChildVariable(sVar1_2_1);
      KeYlessValue sVar1_2_1Value = new KeYlessValue(sVar1_2_1, "myType", "myValue", "value of sVar1_2_1", false, false);
      sVar1_2_1.setValue(sVar1_2_1Value);
      KeYlessVariable sVar1_2_2 = new KeYlessVariable(sVar1_2Value, true, 2, "sVar1_2_2");
      sVar1_2Value.addChildVariable(sVar1_2_2);
      KeYlessValue sVar1_2_2Value = new KeYlessValue(sVar1_2_2, "myType", "myValue", "value of sVar1_2_2", true, true);
      sVar1_2_2.setValue(sVar1_2_2Value);
      return root;
   }
}
