...
public class TestTermBuilder extends TestCase {
    ...
    public void testNumberIsNegativeInt() {
       ...
       for (int i = 0; i<numbers.length; i++) {
           checkDigits(tb.zTerm(services, numbers[i]), 
    ...
    public void testNumberIsVeryBigPositiveInteger() {
        ...
        checkDigits(tb.zTerm(services, number), expected, services.getTypeConverter().getIntegerLDT(), true);
    }
    ...
    public void testNumberIsVerySmallNegativeInteger() {
        ...
        checkDigits(tb.zTerm(services, number), expected, services.getTypeConverter().getIntegerLDT(), false);
    }
