// @(#)$Id: JMLObjectToValueRelation.java 1.1.1.1 Mon, 09 May 2005 15:27:50 +0200 engelc $
...
public /*@ pure @*/ class JMLObjectToValueRelation
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/
        JMLValueSet elementImage(Object dv)
    {
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ pure @*/ boolean has(Object dv, JMLType rv)
    {
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ 
        JMLObjectToValueRelation removeFromDomain(Object dv)
    {
        if (!domain_.has(dv)) {
            return(this);
        }
