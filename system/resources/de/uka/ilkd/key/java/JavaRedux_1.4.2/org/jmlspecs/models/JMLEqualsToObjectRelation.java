// @(#)$Id: JMLEqualsToObjectRelation.java 1.1.1.1 Mon, 09 May 2005 15:27:50 +0200 engelc $
...
public /*@ pure @*/ class JMLEqualsToObjectRelation
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/
        JMLObjectSet elementImage(Object dv)
    {
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ pure @*/ boolean has(Object dv, Object rv)
    {
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ 
        JMLEqualsToObjectRelation removeFromDomain(Object dv)
    {
        if (!domain_.has(dv)) {
            return(this);
        }
