// @(#)$Id: JMLEqualsToEqualsRelation.java 1.3 Mon, 09 May 2005 15:27:50 +0200 engelc $
...
public /*@ pure @*/ class JMLEqualsToEqualsRelation
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/
        JMLEqualsSet elementImage(Object dv)
    {
    ...
    /*@  public normal_behavior
      ...
      @*/
    public /*@ non_null @*/ 
        JMLEqualsToEqualsRelation removeFromDomain(Object dv)
    {
        if (!domain_.has(dv)) {
            return(this);
        }
