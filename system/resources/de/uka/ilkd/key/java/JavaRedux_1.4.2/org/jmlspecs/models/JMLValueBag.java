// @(#)$Id: JMLValueBag.java 1.2 Mon, 09 May 2005 15:27:50 +0200 engelc $
    ...
    extends JMLValueBagSpecs implements JMLCollection
{
    ...
    /*@ also
      ...
      @*/
    public JMLValueBag insert(JMLType elem, int cnt)
    ...
    /*@ public normal_behavior
      ...
      @ |}
      @*/
    public /*@ non_null @*/ JMLValueBag remove(JMLType elem) {
    ...
    /*@ public normal_behavior
      ...
      @    requires 0 <= cnt;
      @*/
    public /*@ non_null @*/ JMLValueBag remove(JMLType elem, int cnt)
    ...
    /*@   public normal_behavior
      ...
      @		   ==> \result.count(e) == count(e) ));
      @*/
    public /*@ non_null @*/ JMLValueBag removeAll(JMLType elem) {
        JMLValueBagEntry matchingEntry = getMatchingEntry(elem);
        if (matchingEntry != null) {
            JMLListValueNode nl = the_list.removeBE(matchingEntry);
    ...
    public /*@ non_null @*/ JMLValueSequence toSequence() {
        ...
        JMLValueBagEnumerator enum = elements();
