// @(#)$Id: JMLEqualsBag.java 1.4 Tue, 17 May 2005 14:57:40 +0200 engelc $
     ...
     implements JMLCollection
{
    ...
    /*@ 
      ...
      @    |}
      @*/
    public /*@ non_null @*/ JMLEqualsBag insert(Object elem)
    ...
    /*@ 
      ...
      @*/
    public /*@ non_null @*/ JMLEqualsBag insert(Object elem, int cnt)
    ...
    /*@ public normal_behavior
      ...
      @ |}
      @*/
    public /*@ non_null @*/ JMLEqualsBag remove(Object elem) {
    ...
    /*@ public normal_behavior
      ...
      @    requires 0 <= cnt;
      @*/
    public /*@ non_null @*/ JMLEqualsBag remove(Object elem, int cnt)
    ...
    /*@   public normal_behavior
      ...
      @		   ==> \result.count(e) == count(e) ));
      @*/
    public /*@ non_null @*/ JMLEqualsBag removeAll(Object elem) {
        JMLEqualsBagEntry matchingEntry = getMatchingEntry(elem);
        if (matchingEntry != null) {
            JMLListValueNode nl = the_list.removeBE(matchingEntry);
    ...
    public /*@ non_null @*/ JMLEqualsSequence toSequence() {
        ...
        JMLEqualsBagEnumerator enum = elements();
