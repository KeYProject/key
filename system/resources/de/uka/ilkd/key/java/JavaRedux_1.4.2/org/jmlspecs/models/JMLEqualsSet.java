// @(#)$Id: JMLEqualsSet.java 1.2 Mon, 09 May 2005 15:27:50 +0200 engelc $
    ...
    implements JMLCollection
{
        ...
        throws IllegalStateException
    {
        ...
        /*@ non_null @*/ JMLEqualsSet ret = new JMLEqualsSet(EMPTY);

        //@ loop_invariant !ret.containsNull;
        /*@ maintaining 0 <= i && i <= int_size() && ret.size >= 1
          @	  && (\forall JMLEqualsSet s; s.int_size() <= i;
        ...
        for (int i = 0; i < int_size(); i++) {
            ...
            while (size_i_and_smaller_subsets.hasMoreElements()) {
                ...
                JMLEqualsSet subset = (JMLEqualsSet)s;
    ...
    public /*@ non_null @*/ JMLEqualsBag toBag() {
        ...
        JMLEqualsSetEnumerator enum = elements();
