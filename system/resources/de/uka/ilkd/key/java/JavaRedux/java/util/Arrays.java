 ...
 * This is taken from the specification for Java 1.4 and has been modified to be usable with KeY.
 * @version $Revision: 2258 $ KeY
 * @author Ajani Thomas
 * @author Gary T. Leavens
 * @author Daniel Bruns
 */
public /*@ nullable_by_default @*/ class Arrays {
...
//    public static int binarySearch(Object[] a, Object key, /*@nullable*/ Comparator c);
    ...
    /*@  public behavior
      ...
      @   ensures (\forall int i; fromIndex <= i && i < toIndex; 
      @            a[i] == val);
      @   ensures (\forall int i; (0 <= i && i < fromIndex) || (toIndex <= i && i < a.length); a[i] == \old(a[i]));
      @   signals_only ArrayStoreException;
      @ also
      @  public normal_behavior
      @   requires a != null && fromIndex == toIndex;
