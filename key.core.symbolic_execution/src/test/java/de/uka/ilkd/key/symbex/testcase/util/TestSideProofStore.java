...
package de.uka.ilkd.key.symbex.testcase.util;
...
import de.uka.ilkd.key.symbex.util.SideProofStore;
import de.uka.ilkd.key.symbex.util.SideProofStore.Entry;
import de.uka.ilkd.key.symbex.util.event.ISideProofStoreListener;
import de.uka.ilkd.key.symbex.util.event.SideProofStoreEvent;
...
public class TestSideProofStore {
    ...
    /**
     * Tests {@link SideProofStore#isEnabled()} and {@link SideProofStore#setEnabled(boolean)}
     * together with the thrown events and the event management.
     */
    @Test
