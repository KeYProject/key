...
public class TestProgramMethodPO extends AbstractSymbolicExecutionTestCase {
     ...
     */
    @Test
    public void testComplicatedMethod() throws IOException, ProofInputException, ParserConfigurationException,
     ...
     */
    @Test
    public void testReturnMethod_Precondition() throws IOException, ProofInputException, ParserConfigurationException,
            SAXException, ProblemLoaderException {
     ...
     */
    @Test
    public void testReturnMethod() throws IOException, ProofInputException, ParserConfigurationException,
            SAXException, ProblemLoaderException {
        doTest("/set/methodPOTest/test/MethodPOTest.java",
                "MethodPOTest",
                "returnMethod",
    ...
    protected void doTest(String javaPathInkeyRepDirectory,
        ...
        try {
            ...
            assertTrue(StringUtil.equalIgnoreWhiteSpace(expectedTryContent, tryContent), "Expected \"" + expectedTryContent + "\" but is \"" + tryContent + "\".");
            // Resume
