 ...
 */
public record TreeSettings(boolean mergeBranchConditions,boolean useUnicode,boolean usePrettyPrinting,boolean variablesAreOnlyComputedFromUpdates,boolean simplifyConditions)implements ITreeSettings{
/**
 * Constructor.
 *
 * @param mergeBranchConditions {@code true} merge branch conditions which means that a branch
 ...
 * {@inheritDoc}
 */
@Override public boolean mergeBranchConditions(){return mergeBranchConditions;}

/**
 * {@inheritDoc}
 */
@Override public boolean useUnicode(){return useUnicode;}

/**
 * {@inheritDoc}
 */
@Override public boolean usePrettyPrinting(){return usePrettyPrinting;}

/**
 * {@inheritDoc}
 */
@Override public boolean variablesAreOnlyComputedFromUpdates(){return variablesAreOnlyComputedFromUpdates;}

/**
 * {@inheritDoc}
 */
@Override public boolean simplifyConditions(){return simplifyConditions;}}
