...
public class SWTBotSequentDisplaySettingsMenuFactoryTest extends AbstractSWTBotKeYEditorTest {
   ...
   public void testPackageHiding() throws Exception {
      ISequentViewTestSteps steps = new ISequentViewTestSteps() {
         @Override
         public void test(IJavaProject project, KeYEnvironment<DefaultUserInterfaceControl> environment, Proof proof, SWTWorkbenchBot bot, SWTBotEditor editor, KeYEditor keyEditor, SWTBotEclipseEditor textEditor, SwingBotJFrame keyMainFrame) {
    ...
    * @throws Exception Occurred Exception.
    */
   protected void doSequentTest(final ISequentViewTestSteps sequentSteps) throws Exception {
      ...
      try {
         ...
         doEditorTest("SWTBotSequentDisplaySettingsMenuFactoryTest_testPrettySyntax", 
