...
public class RefactoringUtil {
    ...
    * 
    * @param project
    *           Project to get the package fragments from.
    * @return Package fragments containing java source files.
    * @throws JavaModelException
    *            Thrown if either the {@link IPackageFragmentRoot}s cannot be returned by the
    *            project or the children cannot be returned by the fragment root.
    */
    ...
    *           ArrayList of IJavaProjects to fill.
    * @param refactoringStartingProject
    *           Given project for which we search in the required project list of the other
    *           projects.
    * @throws JavaModelException
    *            Thrown if either the list of all Java Projects cannot be returned or the required
    *            project names cannot be accessed for any project.
    */
    ...
    * 
    * @param pack
    *           {@link IPackageFragment} we want the classes from.
    * @return ArrayList of Strings of all the fully qualified class names.
    * @throws JavaModelException
    *            Thrown when the compilation units of the given package cannot be returned.
    */
   ...
   /**
    * Given a possible empty list of changes, the return object for the refactoring participants is
    * determined and returned.
    * 
    * @param textFileChanges
    *           A potentially empty list of {@link TextFileChange}s.
   ...
   public static Change assembleChangeObject(ArrayList<TextFileChange> textFileChanges) {
      // Return null if only shared changes, otherwise gather changes to JML for classes with no
      // java changes.
      ...
      // Create a composite change to gather all the changes (effect in preview: a tree item one
      // level higher without preview is added)
      else {
    ...
    * 
    * @param unit
    *           {@link ICompilationUnit} defining the file for which the change is.
    * @param editsToCombine
    *           list of edits.
    * @return the {@link TextFileChange} comprising all the {@link ReplaceEdit}s of the given list.
    * @throws JavaModelException
    *            thrown if the resource corresponding to the compilation unit could not be found.
    */
