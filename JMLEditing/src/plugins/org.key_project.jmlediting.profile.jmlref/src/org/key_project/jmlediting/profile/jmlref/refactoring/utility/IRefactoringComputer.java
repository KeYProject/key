...
public interface IRefactoringComputer {
    ...
    /**
     * Method which computes the needed changes to the JML annotations of a given 
     * java source file.
     * 
     ...
     * @throws JavaModelException Thrown if the compilation unit or the project cannot be accessed as intended.
     */
