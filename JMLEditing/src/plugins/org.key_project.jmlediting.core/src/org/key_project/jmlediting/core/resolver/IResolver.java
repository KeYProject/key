...
/**
 * The IResolver Interface, that specifies three public methods.
...
public interface IResolver {
     ...
     * @throws ResolverException if the IASTNode is not build correctly, or the data can not be extracted.
     */
