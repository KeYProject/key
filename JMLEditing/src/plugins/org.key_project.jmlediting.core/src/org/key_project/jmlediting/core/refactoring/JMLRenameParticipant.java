 ...
 *          Use /org.key_project.jmlediting.core.test/data/template/RefactoringRenameTestClass.java
...
public class JMLRenameParticipant extends RenameParticipant {
    ...
    public Change createChange(IProgressMonitor pm) throws CoreException,
        ...
        // Changes from Java not yet done!! => new parsing does not solve the problem
        // ICompilationUnit unit = fField.getCompilationUnit();
        // if (unit == null)
        // return null;
