...
public class SWTBotJMLProfileDialogTest {
   ...
   public void openGlobalProfileSettings() {
      JMLEditingUITestUtils.openJMLProfilePreferencePage(bot);
   }
   ...
   public void testDeleteUsedProfile() throws CoreException, InterruptedException {
      ...
      JMLEditingUITestUtils.openJMLProfileProperties(bot, project.getProject());
