...
public class ParseErrorMarkerTest {
   ...
   private static String PROJECT_NAME = ParseErrorMarkerTest.class.getSimpleName();
   private static String PACKAGE_NAME = ParseErrorMarkerTest.class.getPackage().getName();
   ...
   public void checkErrorMarkers() throws CoreException {
      ...
      final List<Integer> errorLines = UITestUtils.getAllErrorLines(testFile);
