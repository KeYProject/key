...
example.name = Toy Bank 2
example.additionalFile.1 = src/banking_example2/Bank.java
example.additionalFile.2 = src/banking_example2/UserAccount.java
example.additionalFile.3 = src/banking_example2/BankAccount.java
