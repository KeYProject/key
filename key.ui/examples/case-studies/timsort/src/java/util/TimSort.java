 ...
 * @author Josh Bloch
 */
public /*@ spec_safe_math @*/ class TimSort {
    ...
    /*@ private invariant
      ...
      @        (\bigint)runBase[i] + runLen[i] == runBase[i+1]);
      @*/
    ...
    static void sort(/*@ nullable @*/ Object[] a, int lo, int hi, Comparator/*<? super T>*/ c) {
        ...
        /*@ loop_invariant
          ...
          @        (\bigint)ts.runBase[i] + ts.runLen[i] == ts.runBase[i+1])
	  @ && (\typeof(ts.tmp) == \type(Object[]) && \dl_inInt(ts.minGallop))
	  @ && (ts.stackSize > 0 ==> ts.runBase[0] == \old(lo))
	  @ && (ts.stackSize == 0 ==> (nRemaining > 0 && ts.runBase[0] == 0));
          @ assignable
          @   ts.stackSize,
          @   ts.tmp,
          @   ts.runBase[0 .. (\bigint)ts.runBase.length-1],
	...
	/*@ loop_invariant 
	  ...
	  @*/
	    ...
	    /*@ loop_invariant 
	      ...
	      @ decreases ((\bigint)right - left) + 1, right;
	      @ assignable \nothing;
	      @*/
            while (left < right) {
    ...
    /*@ private normal_behavior
      ...
      @   \result >= MIN_MERGE/2;
      @*/
    private static /*@ pure @*/ int minRunLength(int n) {
        assert n >= 0;
    ...
    /*@ private normal_behavior
      ...
      @   && \dl_elemBiggerThanNextTwo(this.runLen, (\bigint)stackSize-4)
      @   && \dl_elemBiggerThanNextTwo(this.runLen, (\bigint)stackSize-3)
    ...
    /*@ private normal_behavior
      ...
      @   this.a[0 .. (\bigint)this.a.length-1];
      @*/
    private void mergeCollapse_android() {
        /*@ loop_invariant
          @    (0 < stackSize && stackSize <= runLen.length)
          @ && (   (\sum int i; 0<=i && i<stackSize; (\bigint)runLen[i])
          @     == \old((\sum int i; 0<=i && i<stackSize; (\bigint)runLen[i])))
          @ && (\forall \bigint i; 0<=i && i<(\bigint)stackSize-3;
          @        \dl_elemInv(runLen, i, MIN_MERGE/2))
          @ && \dl_elemLargerThanBound(runLen, (\bigint)stackSize-3, MIN_MERGE/2)
          @ && \dl_elemLargerThanBound(runLen, (\bigint)stackSize-2, MIN_MERGE/2)
          @ && \dl_elemLargerThanBound(runLen, (\bigint)stackSize-1, 1)
    ...
    /*@ private normal_behavior
      ...
      @   0 <= \result && \result <= len;
      @*/
    private static /*@ strictly_pure @*/ int gallopLeft(/*@ nullable @*/ Object key, /*@ nullable @*/ Object[] a, int base, int len, int hint,
                                      Comparator/*<? super T>*/ c) {
    ...
    /*@ private normal_behavior
      ...
      @   0 <= \result && \result <= len;
      @*/
    private static /*@ strictly_pure @*/ int gallopRight(/*@ nullable @*/ Object key, /*@ nullable @*/ Object[] a, int base, int len,
	...
	@ requires true;
	@ ensures len1 == 0 
	@   || ( len1 == 1 && len2 > 0 && cursor2 >= 0 && (\bigint)cursor2 + len2 <= a.length && dest >= 0
	@        && (\bigint)dest + len2 < a.length && cursor1 < a.length && 
	@           cursor1 < \old(len1) && cursor1 >=0) 
	@   || ( len2 == 0 && len1 > 1 && cursor1 >=0 && (\bigint)cursor1 + len1 <= \old(len1) 
	@        && (\bigint)dest + len1 <= a.length && dest >= 0);
	...
	/*@ loop_invariant 
	  ...
	  @    (\bigint)cursor1 + len1 == \old(len1)    &&
	  @    (\bigint)cursor2 + len2 == (\bigint)base2 + \old(len2) &&
	  @    (\bigint)dest + len1 == cursor2;
	...
	@ requires true;
	@ ensures len2 == 0 
	@   || (   len2 == 1 && len1 > 0 && dest >= len1
	@       && dest < a.length && cursor2 < \old(len2)
	@       && len1 <= (\bigint)cursor1 + 1 && cursor1 < a.length)
	@   || (   len1 == 0 && len2 > 1  && len2 <= \old(len2)
        @       && len2 <= (\bigint)dest + 1 && dest < a.length);
	@ assignable this.a[0 .. (\bigint)this.a.length-1];
	@*/
       {  
	/*@ loop_invariant
	@    0 < len1 && len1 < \old(len1)
	@ && 1 < len2 && len2 <= \old(len2)
	@ && (\bigint)cursor1 + 1 == (\bigint)base1 + len1
	@ && (\bigint)cursor2 + 1 == len2
	@ && dest == (\bigint)cursor1 + len2;
	@ decreases dest;
	@ assignable this.a[0 .. (\bigint)this.a.length-1];
	@*/
         outer: while (true) {
