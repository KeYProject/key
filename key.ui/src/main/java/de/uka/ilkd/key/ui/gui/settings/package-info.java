 ...
 * {@link de.uka.ilkd.key.ui.gui.settings.SettingsProvider} to
 * {@link de.uka.ilkd.key.ui.gui.settings.SettingsManager#getInstance()}. The typical built-in
 * settings
 * are already register within this method.
 * <p>
 * Also you could consider using an extension:
 * {@link de.uka.ilkd.key.ui.gui.extension.api.KeYGuiExtension.Settings}.
 *
