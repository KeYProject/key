...
import de.uka.ilkd.key.ui.gui.actions.*;
import de.uka.ilkd.key.ui.gui.actions.useractions.ProofLoadUserAction;
import de.uka.ilkd.key.ui.gui.configuration.Config;
import de.uka.ilkd.key.ui.gui.docking.DockingHelper;
import de.uka.ilkd.key.ui.gui.extension.api.KeYGuiExtension;
import de.uka.ilkd.key.ui.gui.extension.api.TabPanel;
import de.uka.ilkd.key.ui.gui.extension.impl.KeYGuiExtensionFacade;
import de.uka.ilkd.key.ui.gui.fonticons.IconFactory;
import de.uka.ilkd.key.ui.gui.help.HelpFacade;
import de.uka.ilkd.key.ui.gui.help.HelpInfo;
import de.uka.ilkd.key.ui.gui.nodeviews.*;
import de.uka.ilkd.key.ui.gui.notification.NotificationManager;
import de.uka.ilkd.key.ui.gui.notification.events.ExitKeYEvent;
import de.uka.ilkd.key.ui.gui.notification.events.NotificationEvent;
import de.uka.ilkd.key.ui.gui.plugins.action_history.ActionHistoryExtension;
import de.uka.ilkd.key.ui.gui.proofdiff.ProofDiffFrame;
import de.uka.ilkd.key.ui.gui.prooftree.ProofTreeView;
import de.uka.ilkd.key.ui.gui.settings.FontSizeFacade;
import de.uka.ilkd.key.ui.gui.settings.SettingsManager;
import de.uka.ilkd.key.ui.gui.smt.DropdownSelectionButton;
import de.uka.ilkd.key.ui.gui.sourceview.SourceViewFrame;
import de.uka.ilkd.key.ui.gui.utilities.LruCached;
