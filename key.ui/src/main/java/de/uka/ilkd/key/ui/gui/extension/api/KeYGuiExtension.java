...
package de.uka.ilkd.key.ui.gui.extension.api;
...
public interface KeYGuiExtension {
    ...
    interface MainMenu {
         ...
         * <p>
         * Actions should use the {@link KeyAction#PATH} and
         * {@link KeyAction#PRIORITY} to control their position in the
         * menu.
         *
