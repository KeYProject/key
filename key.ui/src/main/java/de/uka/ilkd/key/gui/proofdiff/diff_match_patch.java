...
public class diff_match_patch {
     ...
     */
    public @NonNull LinkedList<Diff> diff_main(@NonNull String text1, @NonNull String text2) {
     ...
     * @return Linked List of Diff objects.
     */
    public @NonNull LinkedList<Diff> diff_main(@NonNull String text1, @NonNull String text2, boolean checklines) {
     ...
     * @return Linked List of Diff objects.
     */
    private @NonNull LinkedList<Diff> diff_main(@NonNull String text1, @NonNull String text2, boolean checklines,
                                                long deadline) {
     ...
     * @return Linked List of Diff objects.
     */
    private @NonNull LinkedList<Diff> diff_compute(@NonNull String text1, @NonNull String text2, boolean checklines,
                                                   long deadline) {
     ...
     * @return Linked List of Diff objects.
     */
    private @NonNull LinkedList<Diff> diff_lineMode(@NonNull String text1, @NonNull String text2, long deadline) {
     ...
     */
    protected @NonNull LinkedList<Diff> diff_bisect(@NonNull String text1, @NonNull String text2, long deadline) {
     ...
     * @return LinkedList of Diff objects.
     */
    private @NonNull LinkedList<Diff> diff_bisectSplit(@NonNull String text1, @NonNull String text2, int x, int y,
                                                       long deadline) {
     ...
     */
    protected @NonNull LinesToCharsResult diff_linesToChars(@NonNull String text1, @NonNull String text2) {
     ...
     */
    private @NonNull String diff_linesToCharsMunge(@NonNull String text, @NonNull List<String> lineArray,
                                                   @NonNull Map<String, Integer> lineHash) {
        int lineStart = 0;
        int lineEnd = -1;
        String line;
     ...
     * @param lineArray List of unique strings.
     */
    protected void diff_charsToLines(@NonNull LinkedList<Diff> diffs, @NonNull List<String> lineArray) {
        StringBuilder text;
        for (Diff diff : diffs) {
     ...
     *         match.
     */
    protected String @Nullable [] diff_halfMatch(@NonNull String text1, @NonNull String text2) {
        if (Diff_Timeout <= 0) {
     ...
     *         there was no match.
     */
    private String @Nullable [] diff_halfMatchI(@NonNull String longtext, @NonNull String shorttext, int i) {
     ...
     * @return The score.
     */
    private int diff_cleanupSemanticScore(@NonNull String one, @NonNull String two) {
     ...
     * @param diffs LinkedList of Diff objects.
     */
    public void diff_cleanupEfficiency(@NonNull LinkedList<Diff> diffs) {
        if (diffs.isEmpty()) {
            return;
        }
        boolean changes = false;
     ...
     */
    public int diff_xIndex(@NonNull LinkedList<Diff> diffs, int loc) {
        int chars1 = 0;
        int chars2 = 0;
        int last_chars1 = 0;
        int last_chars2 = 0;
     ...
     */
    public @NonNull String diff_prettyHtml(@NonNull LinkedList<Diff> diffs) {
     ...
     * @return Source text.
     */
    public @NonNull String diff_text1(@NonNull LinkedList<Diff> diffs) {
     ...
     */
    public @NonNull String diff_text2(@NonNull LinkedList<Diff> diffs) {
        StringBuilder text = new StringBuilder();
        for (Diff aDiff : diffs) {
            if (aDiff.operation != Operation.DELETE) {
                text.append(aDiff.text);
     ...
     */
    public int diff_levenshtein(@NonNull LinkedList<Diff> diffs) {
        int levenshtein = 0;
        int insertions = 0;
        int deletions = 0;
        for (Diff aDiff : diffs) {
     ...
     * @return Delta text.
     */
    public @NonNull String diff_toDelta(@NonNull LinkedList<Diff> diffs) {
        StringBuilder text = new StringBuilder();
        for (Diff aDiff : diffs) {
            switch (aDiff.operation) {
            case INSERT:
     ...
     */
    public @NonNull LinkedList<Diff> diff_fromDelta(@NonNull String text1, @NonNull String delta)
     ...
     */
    public int match_main(@NonNull String text, @NonNull String pattern, int loc) {
        // Check for null inputs.
     ...
     * @return Best match index or -1.
     */
    protected int match_bitap(@NonNull String text, @NonNull String pattern, int loc) {
     ...
     */
    private double match_bitapScore(int e, int x, int loc, @NonNull String pattern) {
     ...
     */
    protected void patch_addContext(@NonNull Patch patch, @NonNull String text) {
        if (text.length() == 0) {
            return;
        }
     ...
     */
    public @NonNull LinkedList<Patch> patch_make(@NonNull String text1, @NonNull String text2) {
        if (text1 == null || text2 == null) {
     ...
     * @return LinkedList of Patch objects.
     */
    public @NonNull LinkedList<Patch> patch_make(@NonNull LinkedList<Diff> diffs) {
        if (diffs == null) {
            throw new IllegalArgumentException("Null inputs. (patch_make)");
        }
     ...
     */
    @Deprecated
    public @NonNull LinkedList<Patch> patch_make(@NonNull String text1, String text2, @NonNull LinkedList<Diff> diffs) {
        return patch_make(text1, diffs);
    }
     ...
     * @return LinkedList of Patch objects.
     */
    public @NonNull LinkedList<Patch> patch_make(@NonNull String text1, @NonNull LinkedList<Diff> diffs) {
     ...
     */
    public Object @NonNull [] patch_apply(@NonNull LinkedList<Patch> patches, String text) {
        if (patches.isEmpty()) {
     ...
     */
    public @NonNull String patch_addPadding(@NonNull LinkedList<Patch> patches) {
     ...
     */
    public void patch_splitMax(@NonNull LinkedList<Patch> patches) {
     ...
     */
    public @NonNull String patch_toText(@NonNull List<Patch> patches) {
        StringBuilder text = new StringBuilder();
        for (Patch aPatch : patches) {
            text.append(aPatch);
        }
     ...
     * @throws IllegalArgumentException If invalid input.
     */
    public @NonNull List<Patch> patch_fromText(@NonNull String textline) throws IllegalArgumentException {
     ...
     */
    private static @NonNull String unescapeForEncodeUriCompatability(@NonNull String str) {
