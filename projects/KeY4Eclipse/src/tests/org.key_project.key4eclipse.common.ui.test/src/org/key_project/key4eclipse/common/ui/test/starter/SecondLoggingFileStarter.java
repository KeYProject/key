 ...
 */
public class SecondLoggingFileStarter implements IFileStarter, ITestedStarter {
   /**
    * The unique ID of this starter.
    */
   public static final String ID = "org.key_project.key4eclipse.common.ui.test.starter.SecondLoggingFileStarterID";

   /**
    * The unique Name of this starter.
    */
   public static final String NAME = "Second File Starter";

   /**
    * The description of this starter.
    */
   public static final String DESCRIPTION = "Description of Second File Starter";
