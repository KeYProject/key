 ...
 */
public class InvariantTest extends AbstractKeYTest {
   /**
    * Tests attributes.
    */
   @Test
   public void testClassAndInterfaceInvariants() throws Exception {
      testKeyConnection("InvariantTest_testClassAndInterfaceInvariants",
                        "data/typeInvariantTest/test",
                        null,
                        DSPackageManagement.FLAT_LIST,
                        Activator.PLUGIN_ID,
                        "data/typeInvariantTest/oracle/typeInvariantTest.dbc");
   }
}