...
public class DSFinderFactoryMinus1 implements IDSFinderFactory {
   @Override
   ...
   public IDSFinder createFinder(IDSConnection connection) {
      return new FinderMinus1(connection);
   }
   
   public static class FinderMinus1 extends DefaultDSFinder {
      public FinderMinus1(IDSConnection connection) {
         super(connection);
      }
   }
}