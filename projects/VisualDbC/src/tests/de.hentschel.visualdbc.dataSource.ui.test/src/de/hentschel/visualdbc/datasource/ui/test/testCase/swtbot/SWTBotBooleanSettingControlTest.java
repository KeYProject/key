 ...
 */
public class SWTBotBooleanSettingControlTest extends TestCase {
   /**
   ...
   protected void doTest(Boolean[] valuesToSetByApi,
      ...
      // Create control
      final ISettingControl settingControl = SettingControlUtil.createSettingControl("de.hentschel.visualdbc.datasource.ui.setting.BooleanSettingControl");
      ...
      IRunnableWithResult<Control> createRun = new AbstractRunnableWithResult<Control>() {
         ...
         public void run() {
            ...
            shell.setText("SWTBotBooleanSettingControlTest");
      ...
      SWTBotShell botShell = bot.shell("SWTBotBooleanSettingControlTest");
      SWTBotCheckBox botBox = botShell.bot().checkBox();
      // Test initial value
      ...
      assertEquals(false, botBox.isChecked());
      ...
      for (Boolean toSet : valuesToSetByApi) {
         ...
         assertEquals(toSet.booleanValue(), botBox.isChecked());
