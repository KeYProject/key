 ...
 * @generated
 */
public class DbCNavigatorLinkHelper implements ILinkHelper {
   ...
   public IStructuredSelection findSelection(IEditorInput anInput) {
      IDiagramDocument document = DbCDiagramEditorPlugin.getInstance()
   ...
   public void activateEditor(IWorkbenchPage aPage,
      ...
      DbCAbstractNavigatorItem abstractNavigatorItem = (DbCAbstractNavigatorItem) aSelection
            .getFirstElement();
      ...
      if (abstractNavigatorItem instanceof DbCNavigatorItem) {
         ...
         if (navigatorGroup.getParent() instanceof DbCNavigatorItem) {
            navigatorView = ((DbCNavigatorItem) navigatorGroup.getParent())
                  .getView();
         }
      }
