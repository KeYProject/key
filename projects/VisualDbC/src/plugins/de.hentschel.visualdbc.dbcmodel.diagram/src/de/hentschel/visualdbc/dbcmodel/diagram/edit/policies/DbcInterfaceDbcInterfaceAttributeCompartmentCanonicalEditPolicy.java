 ...
 * @generated
 */
public class DbcInterfaceDbcInterfaceAttributeCompartmentCanonicalEditPolicy
   ...
   protected List getSemanticChildrenList() {
      ...
      List<DbCNodeDescriptor> childDescriptors = DbCDiagramUpdater
            .getDbcInterfaceDbcInterfaceAttributeCompartment_7053SemanticChildren(viewObject);
   ...
   protected void refreshSemantic() {
      ...
      List<DbCNodeDescriptor> childDescriptors = DbCDiagramUpdater
            .getDbcInterfaceDbcInterfaceAttributeCompartment_7053SemanticChildren((View) getHost()
                  .getModel());
