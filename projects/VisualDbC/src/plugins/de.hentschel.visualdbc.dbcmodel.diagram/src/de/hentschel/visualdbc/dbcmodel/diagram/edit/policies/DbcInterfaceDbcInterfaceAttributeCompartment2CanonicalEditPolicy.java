 ...
 * @generated
 */
public class DbcInterfaceDbcInterfaceAttributeCompartment2CanonicalEditPolicy
   ...
   protected EStructuralFeature getFeatureToSynchronize() {
      return DbcmodelPackage.eINSTANCE.getAbstractDbcInterface_Attributes();
   }
   ...
   protected List getSemanticChildrenList() {
      ...
      List<DbCNodeDescriptor> childDescriptors = DbCDiagramUpdater
            .getDbcInterfaceDbcInterfaceAttributeCompartment_7058SemanticChildren(viewObject);
   ...
   private boolean isMyDiagramElement(View view) {
      return DbcAttributeEditPart.VISUAL_ID == DbCVisualIDRegistry
            .getVisualID(view);
   }
   ...
   protected void refreshSemantic() {
      ...
      List<DbCNodeDescriptor> childDescriptors = DbCDiagramUpdater
            .getDbcInterfaceDbcInterfaceAttributeCompartment_7058SemanticChildren((View) getHost()
                  .getModel());
