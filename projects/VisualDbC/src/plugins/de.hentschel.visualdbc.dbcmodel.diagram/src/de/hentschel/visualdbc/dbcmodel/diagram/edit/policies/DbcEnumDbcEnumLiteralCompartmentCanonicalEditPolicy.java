 ...
 * @generated
 */
public class DbcEnumDbcEnumLiteralCompartmentCanonicalEditPolicy extends
      CanonicalEditPolicy {
   ...
   protected List getSemanticChildrenList() {
      ...
      List<DbCNodeDescriptor> childDescriptors = DbCDiagramUpdater
            .getDbcEnumDbcEnumLiteralCompartment_7056SemanticChildren(viewObject);
   ...
   protected void refreshSemantic() {
      ...
      List<DbCNodeDescriptor> childDescriptors = DbCDiagramUpdater
            .getDbcEnumDbcEnumLiteralCompartment_7056SemanticChildren((View) getHost()
                  .getModel());
