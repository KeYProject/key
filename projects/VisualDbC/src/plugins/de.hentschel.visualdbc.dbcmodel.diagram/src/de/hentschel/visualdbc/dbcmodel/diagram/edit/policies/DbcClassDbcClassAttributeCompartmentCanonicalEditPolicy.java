 ...
 * @generated
 */
public class DbcClassDbcClassAttributeCompartmentCanonicalEditPolicy extends
      CanonicalEditPolicy {
   ...
   protected List getSemanticChildrenList() {
      ...
      List<DbCNodeDescriptor> childDescriptors = DbCDiagramUpdater
            .getDbcClassDbcClassAttributeCompartment_7051SemanticChildren(viewObject);
   ...
   protected void refreshSemantic() {
      ...
      List<DbCNodeDescriptor> childDescriptors = DbCDiagramUpdater
            .getDbcClassDbcClassAttributeCompartment_7051SemanticChildren((View) getHost()
                  .getModel());
