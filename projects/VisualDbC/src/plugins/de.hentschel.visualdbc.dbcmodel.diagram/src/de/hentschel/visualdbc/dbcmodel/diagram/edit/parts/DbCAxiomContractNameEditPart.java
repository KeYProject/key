 ...
 * @generated
 */
public class DbCAxiomContractNameEditPart extends CompartmentEditPart implements
      ITextAwareEditPart {
    ...
    * @generated
    */
   public DbCAxiomContractNameEditPart(View view) {
      super(view);
   }
   ...
   public IParser getParser() {
      if (parser == null) {
         parser = DbCParserProvider
               .getParser(
                     DbCElementTypes.DbCAxiomContract_3037,
                     getParserElement(),
                     DbCVisualIDRegistry
                           .getType(de.hentschel.visualdbc.dbcmodel.diagram.edit.parts.DbCAxiomContractNameEditPart.VISUAL_ID));
      }
      return parser;
   }
