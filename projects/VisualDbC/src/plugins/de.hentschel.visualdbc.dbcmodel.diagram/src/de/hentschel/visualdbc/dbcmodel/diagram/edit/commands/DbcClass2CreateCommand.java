 ...
 * @generated
 */
public class DbcClass2CreateCommand extends EditElementCommand {

   /**
    * @generated
    */
   public DbcClass2CreateCommand(CreateElementRequest req) {
   ...
   protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
      ...
      DbcClass newElement = DbcmodelFactory.eINSTANCE.createDbcClass();
    ...
    * @generated
    */
   protected void doConfigure(DbcClass newElement, IProgressMonitor monitor,
         IAdaptable info) throws ExecutionException {
