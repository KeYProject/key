 ...
 * @generated
 */
public class DbcOperationContractPostEditPart extends CompartmentEditPart
    ...
    * @generated
    */
   public DbcOperationContractPostEditPart(View view) {
      super(view);
   }
      ...
      if (parser == null) {
         parser = DbCParserProvider
               .getParser(
                     ...
                     getParserElement(),
                     DbCVisualIDRegistry
                           .getType(de.hentschel.visualdbc.dbcmodel.diagram.edit.parts.DbcOperationContractPostEditPart.VISUAL_ID));
      }
      return parser;
   }
