 ...
 * @generated
 */
public class DbcAxiomDefinitionEditPart extends CompartmentEditPart implements
      ITextAwareEditPart {
    ...
    * @generated
    */
   public DbcAxiomDefinitionEditPart(View view) {
      super(view);
   }
      ...
      if (parser == null) {
         parser = DbCParserProvider
               .getParser(
                     ...
                     getParserElement(),
                     DbCVisualIDRegistry
                           .getType(de.hentschel.visualdbc.dbcmodel.diagram.edit.parts.DbcAxiomDefinitionEditPart.VISUAL_ID));
      }
      return parser;
   }
