...
import de.hentschel.visualdbc.dbcmodel.diagram.edit.policies.DbcInterface2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class DbcInterface2EditPart extends ShapeNodeEditPart {
    ...
    * @generated
    */
   public DbcInterface2EditPart(View view) {
      super(view);
   }
   ...
   protected void createDefaultEditPolicies() {
      ...
      installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
            new DbcInterface2ItemSemanticEditPolicy());
   ...
   protected boolean addFixedChild(EditPart childEditPart) {
      if (childEditPart instanceof DbcInterfaceName2EditPart) {
         ((DbcInterfaceName2EditPart) childEditPart).setLabel(getPrimaryShape()
               .getFigureDbcInterfaceNameFigure());
         return true;
      }
      if (childEditPart instanceof DbcInterfaceDbcInterfaceMainCompartmentEditPart) {
         IFigure pane = getPrimaryShape()
               .getFigureDbcInterfaceMainCompartmentRectangle();
         setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
         pane.add(((DbcInterfaceDbcInterfaceMainCompartmentEditPart) childEditPart)
               .getFigure());
         return true;
      }
      if (childEditPart instanceof DbcInterfaceDbcInterfaceAttributeCompartmentEditPart) {
         IFigure pane = getPrimaryShape()
               .getFigureDbcInterfaceAttributeCompartmentRectangle();
         setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
         pane.add(((DbcInterfaceDbcInterfaceAttributeCompartmentEditPart) childEditPart)
               .getFigure());
         return true;
      }
      return false;
   ...
   protected boolean removeFixedChild(EditPart childEditPart) {
      ...
      if (childEditPart instanceof DbcInterfaceDbcInterfaceMainCompartmentEditPart) {
         IFigure pane = getPrimaryShape()
               .getFigureDbcInterfaceMainCompartmentRectangle();
         setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
         pane.remove(((DbcInterfaceDbcInterfaceMainCompartmentEditPart) childEditPart)
               .getFigure());
         return true;
      }
      if (childEditPart instanceof DbcInterfaceDbcInterfaceAttributeCompartmentEditPart) {
         IFigure pane = getPrimaryShape()
               .getFigureDbcInterfaceAttributeCompartmentRectangle();
         setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
         pane.remove(((DbcInterfaceDbcInterfaceAttributeCompartmentEditPart) childEditPart)
               .getFigure());
         return true;
      }
      return false;
   ...
   protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
      ...
      if (editPart instanceof DbcInterfaceDbcInterfaceAttributeCompartmentEditPart) {
         return getPrimaryShape()
               .getFigureDbcInterfaceAttributeCompartmentRectangle();
      }
   ...
   public EditPart getPrimaryChildEditPart() {
      return getChildBySemanticHint(DbCVisualIDRegistry
            .getType(DbcInterfaceName2EditPart.VISUAL_ID));
   }
   ...
   public List<IElementType> getMARelTypesOnSourceAndTarget(
      ...
      if (targetEditPart instanceof de.hentschel.visualdbc.dbcmodel.diagram.edit.parts.DbcInterface2EditPart) {
         types.add(DbCElementTypes.DbcInterfaceExtends_4004);
      }
      return types;
   }
