...
import de.hentschel.visualdbc.dbcmodel.diagram.edit.policies.DbcClassItemSemanticEditPolicy;
 ...
 * @generated
 */
public class DbcClassEditPart extends ShapeNodeEditPart {
    ...
    * @generated
    */
   public DbcClassEditPart(View view) {
      super(view);
   }
   ...
   protected void createDefaultEditPolicies() {
      ...
      installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
            new DbcClassItemSemanticEditPolicy());
   ...
   protected boolean addFixedChild(EditPart childEditPart) {
      if (childEditPart instanceof DbcClassNameEditPart) {
         ((DbcClassNameEditPart) childEditPart).setLabel(getPrimaryShape()
               .getFigureDbcClassNameFigure());
         return true;
      }
      if (childEditPart instanceof DbcClassDbcClassMainCompartment2EditPart) {
         IFigure pane = getPrimaryShape()
               .getFigureDbcClassMainCompartmentRectangle();
         setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
         pane.add(((DbcClassDbcClassMainCompartment2EditPart) childEditPart)
               .getFigure());
         return true;
      }
      if (childEditPart instanceof DbcClassDbcClassAttributeCompartment2EditPart) {
         IFigure pane = getPrimaryShape()
               .getFigureDbcClassAttributeCompartmentRectangle();
         setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
         pane.add(((DbcClassDbcClassAttributeCompartment2EditPart) childEditPart)
               .getFigure());
         return true;
      }
      return false;
   ...
   protected boolean removeFixedChild(EditPart childEditPart) {
      ...
      if (childEditPart instanceof DbcClassDbcClassMainCompartment2EditPart) {
         IFigure pane = getPrimaryShape()
               .getFigureDbcClassMainCompartmentRectangle();
         setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
         pane.remove(((DbcClassDbcClassMainCompartment2EditPart) childEditPart)
               .getFigure());
         return true;
      }
      if (childEditPart instanceof DbcClassDbcClassAttributeCompartment2EditPart) {
         IFigure pane = getPrimaryShape()
               .getFigureDbcClassAttributeCompartmentRectangle();
         setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
         pane.remove(((DbcClassDbcClassAttributeCompartment2EditPart) childEditPart)
               .getFigure());
         return true;
      }
      return false;
   ...
   protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
      ...
      if (editPart instanceof DbcClassDbcClassAttributeCompartment2EditPart) {
   ...
   public EditPart getPrimaryChildEditPart() {
      return getChildBySemanticHint(DbCVisualIDRegistry
            .getType(DbcClassNameEditPart.VISUAL_ID));
   }
   ...
   public List<IElementType> getMARelTypesOnSourceAndTarget(
      ...
      if (targetEditPart instanceof de.hentschel.visualdbc.dbcmodel.diagram.edit.parts.DbcClassEditPart) {
         types.add(DbCElementTypes.DbcClassExtends_4003);
      }
