...
import de.hentschel.visualdbc.dbcmodel.diagram.edit.policies.DbcPackage2ItemSemanticEditPolicy;
import de.hentschel.visualdbc.dbcmodel.diagram.part.DbCVisualIDRegistry;

/**
 * @generated
 */
public class DbcPackage2EditPart extends ShapeNodeEditPart {
    ...
    * @generated
    */
   public DbcPackage2EditPart(View view) {
      super(view);
   }
   ...
   protected void createDefaultEditPolicies() {
      ...
      installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
            new DbcPackage2ItemSemanticEditPolicy());
   ...
   protected boolean addFixedChild(EditPart childEditPart) {
      if (childEditPart instanceof DbcPackageName2EditPart) {
         ((DbcPackageName2EditPart) childEditPart).setLabel(getPrimaryShape()
               .getFigureDbcPackageNameFigure());
         return true;
      }
      if (childEditPart instanceof DbcPackageDbcPackageCompartment2EditPart) {
         IFigure pane = getPrimaryShape()
               .getFigureDbcPackageCompartmentRectangle();
         setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
         pane.add(((DbcPackageDbcPackageCompartment2EditPart) childEditPart)
               .getFigure());
         return true;
      }
      return false;
   ...
   protected boolean removeFixedChild(EditPart childEditPart) {
      ...
      if (childEditPart instanceof DbcPackageDbcPackageCompartment2EditPart) {
         IFigure pane = getPrimaryShape()
               .getFigureDbcPackageCompartmentRectangle();
         setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
         pane.remove(((DbcPackageDbcPackageCompartment2EditPart) childEditPart)
               .getFigure());
         return true;
      }
      return false;
   ...
   public EditPart getPrimaryChildEditPart() {
      return getChildBySemanticHint(DbCVisualIDRegistry
            .getType(DbcPackageName2EditPart.VISUAL_ID));
   }
