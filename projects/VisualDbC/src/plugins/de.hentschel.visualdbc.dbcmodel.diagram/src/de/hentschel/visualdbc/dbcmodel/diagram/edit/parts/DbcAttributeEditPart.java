 ...
 * @generated
 */
public class DbcAttributeEditPart extends CompartmentEditPart implements
      ITextAwareEditPart {
      ...
      if (parser == null) {
         parser = DbCParserProvider
               .getParser(
                     ...
                     getParserElement(),
                     DbCVisualIDRegistry
                           .getType(de.hentschel.visualdbc.dbcmodel.diagram.edit.parts.DbcAttributeEditPart.VISUAL_ID));
      }
      return parser;
   }
   ...
   protected void handleNotificationEvent(Notification event) {
      ...
      if (NotationPackage.eINSTANCE.getFontStyle_FontColor().equals(feature)) {
         ...
         // Begin Changes MHE
         if (DbcmodelPackage.Literals.DBC_ATTRIBUTE__VISIBILITY.equals(event
               .getFeature())) {
            refreshLabel();
         }
         // End Changes MHE         
   ...
   protected IFigure createFigurePrim() {
      return new DbcAttributeFigure();
   }

   /**
    * @generated
    */
   public class DbcAttributeFigure extends WrappingLabel {
