 ...
 * @generated
 */
public class DbcMethodSignatureReturnTypeEditPart extends CompartmentEditPart
    ...
    * @generated
    */
   public DbcMethodSignatureReturnTypeEditPart(View view) {
      super(view);
   }
      ...
      if (parser == null) {
         parser = DbCParserProvider
               .getParser(
                     ...
                     getParserElement(),
                     DbCVisualIDRegistry
                           .getType(de.hentschel.visualdbc.dbcmodel.diagram.edit.parts.DbcMethodSignatureReturnTypeEditPart.VISUAL_ID));
      }
      return parser;
   }
   ...
   protected void handleNotificationEvent(Notification event) {
      ...
      if (NotationPackage.eINSTANCE.getFontStyle_FontColor().equals(feature)) {
         ...
         // Begin Changes MHE
         if (DbcmodelPackage.Literals.ABSTRACT_DBC_OPERATION__VISIBILITY
