 ...
 * @generated
 */
public class DbcOperationContractPreEditPart extends CompartmentEditPart
    ...
    * @generated
    */
   public DbcOperationContractPreEditPart(View view) {
      super(view);
   }
      ...
      if (parser == null) {
         parser = DbCParserProvider
               .getParser(
                     ...
                     getParserElement(),
                     DbCVisualIDRegistry
                           .getType(de.hentschel.visualdbc.dbcmodel.diagram.edit.parts.DbcOperationContractPreEditPart.VISUAL_ID));
      }
      return parser;
   }
