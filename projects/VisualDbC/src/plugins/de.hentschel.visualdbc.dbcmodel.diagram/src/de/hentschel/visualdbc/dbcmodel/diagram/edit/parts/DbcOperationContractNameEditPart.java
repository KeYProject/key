 ...
 * @generated
 */
public class DbcOperationContractNameEditPart extends CompartmentEditPart
    ...
    * @generated
    */
   public DbcOperationContractNameEditPart(View view) {
      super(view);
   }
      ...
      if (parser == null) {
         parser = DbCParserProvider
               .getParser(
                     ...
                     getParserElement(),
                     DbCVisualIDRegistry
                           .getType(de.hentschel.visualdbc.dbcmodel.diagram.edit.parts.DbcOperationContractNameEditPart.VISUAL_ID));
      }
      return parser;
   }
   ...
   protected void handleNotificationEvent(Notification event) {
      ...
      if (NotationPackage.eINSTANCE.getFontStyle_FontColor().equals(feature)) {
         ...
         // Begin Changes MHE
         if (DbcmodelPackage.Literals.DBC_OPERATION_CONTRACT__TERMINATION
