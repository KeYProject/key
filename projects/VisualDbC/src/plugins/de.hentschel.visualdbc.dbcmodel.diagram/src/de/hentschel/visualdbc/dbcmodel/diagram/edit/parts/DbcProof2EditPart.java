...
import de.hentschel.visualdbc.dbcmodel.diagram.edit.policies.DbcProof2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class DbcProof2EditPart extends ShapeNodeEditPart {
    ...
    * @generated
    */
   public DbcProof2EditPart(View view) {
      super(view);
   }
   ...
   protected void createDefaultEditPolicies() {
      ...
      installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
            new DbcProof2ItemSemanticEditPolicy());
   ...
   protected boolean addFixedChild(EditPart childEditPart) {
      if (childEditPart instanceof DbcProofObligation2EditPart) {
         ((DbcProofObligation2EditPart) childEditPart)
   ...
   public EditPart getPrimaryChildEditPart() {
      return getChildBySemanticHint(DbCVisualIDRegistry
            .getType(DbcProofObligation2EditPart.VISUAL_ID));
   }
