 ...
 * @generated
 */
public class DbcProofReferenceKindEditPart extends LabelEditPart implements
      ITextAwareEditPart {
   ...
   static {
      registerSnapBackPosition(
            DbCVisualIDRegistry
                  .getType(de.hentschel.visualdbc.dbcmodel.diagram.edit.parts.DbcProofReferenceKindEditPart.VISUAL_ID),
            new Point(0, 40));
   }
    ...
    * @generated
    */
   public DbcProofReferenceKindEditPart(View view) {
      super(view);
   }
   ...
   protected void createDefaultEditPolicies() {
      ...
      installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
            new DbcModelEditPart.LinkLabelDragPolicy());
   }
   ...
   protected IFigure createFigurePrim() {
      return new DbcProofReferenceLabelFigure();
   }

   /**
    * @generated
    */
   public class DbcProofReferenceLabelFigure extends WrappingLabel {

      /**
       * @generated
       */
      public DbcProofReferenceLabelFigure() {
         this.setText("");
      }
