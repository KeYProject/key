 ...
 * @generated
 */
public class DbcProofObligation2EditPart extends CompartmentEditPart implements
      ITextAwareEditPart {
    ...
    * @generated
    */
   public DbcProofObligation2EditPart(View view) {
      super(view);
   }
      ...
      if (parser == null) {
         parser = DbCParserProvider
               .getParser(
                     ...
                     getParserElement(),
                     DbCVisualIDRegistry
                           .getType(de.hentschel.visualdbc.dbcmodel.diagram.edit.parts.DbcProofObligation2EditPart.VISUAL_ID));
      }
      return parser;
   }
   ...
   protected void handleNotificationEvent(Notification event) {
      ...
      if (NotationPackage.eINSTANCE.getFontStyle_FontColor().equals(feature)) {
         ...
         // Begin Changes MHE
         if (DbcmodelPackage.Literals.DBC_PROOF__STATUS.equals(event
               .getFeature())) {
            refreshLabel();
         }
         // End Changes MHE         
