 ...
 * @generated
 */
public class DbcPackageName2EditPart extends CompartmentEditPart implements
      ITextAwareEditPart {
    ...
    * @generated
    */
   public DbcPackageName2EditPart(View view) {
      super(view);
   }
      ...
      if (parser == null) {
         parser = DbCParserProvider
               .getParser(
                     ...
                     getParserElement(),
                     DbCVisualIDRegistry
                           .getType(de.hentschel.visualdbc.dbcmodel.diagram.edit.parts.DbcPackageName2EditPart.VISUAL_ID));
      }
      return parser;
   }
