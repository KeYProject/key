 ...
 * @generated
 */
public class DbcConstructorSignatureEditPart extends CompartmentEditPart
    ...
    * @generated
    */
   public DbcConstructorSignatureEditPart(View view) {
      super(view);
   }
      ...
      if (parser == null) {
         parser = DbCParserProvider
               .getParser(
                     ...
                     getParserElement(),
                     DbCVisualIDRegistry
                           .getType(de.hentschel.visualdbc.dbcmodel.diagram.edit.parts.DbcConstructorSignatureEditPart.VISUAL_ID));
      }
      return parser;
   }
