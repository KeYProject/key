 ...
 * @generated
 */
public class DbcEnumDbcEnumAttributeCompartment2CanonicalEditPolicy extends
      CanonicalEditPolicy {
   ...
   protected List getSemanticChildrenList() {
      ...
      List<DbCNodeDescriptor> childDescriptors = DbCDiagramUpdater
            .getDbcEnumDbcEnumAttributeCompartment_7062SemanticChildren(viewObject);
   ...
   protected void refreshSemantic() {
      ...
      List<DbCNodeDescriptor> childDescriptors = DbCDiagramUpdater
            .getDbcEnumDbcEnumAttributeCompartment_7062SemanticChildren((View) getHost()
                  .getModel());
