 ...
 * @generated
 */
public class DbcClassDbcClassAttributeCompartment2CanonicalEditPolicy extends
      CanonicalEditPolicy {
   ...
   protected List getSemanticChildrenList() {
      ...
      List<DbCNodeDescriptor> childDescriptors = DbCDiagramUpdater
            .getDbcClassDbcClassAttributeCompartment_7060SemanticChildren(viewObject);
   ...
   protected void refreshSemantic() {
      ...
      List<DbCNodeDescriptor> childDescriptors = DbCDiagramUpdater
            .getDbcClassDbcClassAttributeCompartment_7060SemanticChildren((View) getHost()
                  .getModel());
