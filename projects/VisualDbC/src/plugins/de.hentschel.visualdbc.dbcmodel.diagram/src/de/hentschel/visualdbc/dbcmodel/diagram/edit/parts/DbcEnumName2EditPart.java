 ...
 * @generated
 */
public class DbcEnumName2EditPart extends CompartmentEditPart implements
      ITextAwareEditPart {
    ...
    * @generated
    */
   public DbcEnumName2EditPart(View view) {
      super(view);
   }
      ...
      if (parser == null) {
         parser = DbCParserProvider
               .getParser(
                     ...
                     getParserElement(),
                     DbCVisualIDRegistry
                           .getType(de.hentschel.visualdbc.dbcmodel.diagram.edit.parts.DbcEnumName2EditPart.VISUAL_ID));
      }
      return parser;
   }
