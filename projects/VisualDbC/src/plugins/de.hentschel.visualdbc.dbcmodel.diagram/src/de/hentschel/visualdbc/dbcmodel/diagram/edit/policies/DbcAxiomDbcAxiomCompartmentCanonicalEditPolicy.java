 ...
 * @generated
 */
public class DbcAxiomDbcAxiomCompartmentCanonicalEditPolicy extends
      CanonicalEditPolicy {
   ...
   protected EStructuralFeature getFeatureToSynchronize() {
      return DbcmodelPackage.eINSTANCE.getDbcAxiom_AxiomContracts();
   }
   ...
   protected List getSemanticChildrenList() {
      ...
      List<DbCNodeDescriptor> childDescriptors = DbCDiagramUpdater
            .getDbcAxiomDbcAxiomCompartment_7064SemanticChildren(viewObject);
   ...
   private boolean isMyDiagramElement(View view) {
      return DbCAxiomContractEditPart.VISUAL_ID == DbCVisualIDRegistry
            .getVisualID(view);
   }
   ...
   protected void refreshSemantic() {
      ...
      List<DbCNodeDescriptor> childDescriptors = DbCDiagramUpdater
            .getDbcAxiomDbcAxiomCompartment_7064SemanticChildren((View) getHost()
                  .getModel());
