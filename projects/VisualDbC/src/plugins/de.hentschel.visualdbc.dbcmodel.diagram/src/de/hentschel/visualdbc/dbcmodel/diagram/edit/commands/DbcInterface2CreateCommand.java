 ...
 * @generated
 */
public class DbcInterface2CreateCommand extends EditElementCommand {

   /**
    * @generated
    */
   public DbcInterface2CreateCommand(CreateElementRequest req) {
   ...
   protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
      ...
      DbcInterface newElement = DbcmodelFactory.eINSTANCE.createDbcInterface();
    ...
    * @generated
    */
   protected void doConfigure(DbcInterface newElement,
