 ...
 * @generated
 */
public class DbcMethodCreateCommand extends EditElementCommand {

   /**
    * @generated
    */
   public DbcMethodCreateCommand(CreateElementRequest req) {
   ...
   protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
      ...
      DbcMethod newElement = DbcmodelFactory.eINSTANCE.createDbcMethod();
    ...
    * @generated
    */
   protected void doConfigure(DbcMethod newElement, IProgressMonitor monitor,
         IAdaptable info) throws ExecutionException {
