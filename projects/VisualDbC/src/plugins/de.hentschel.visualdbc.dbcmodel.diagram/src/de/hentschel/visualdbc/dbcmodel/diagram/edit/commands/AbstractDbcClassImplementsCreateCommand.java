 ...
 * @generated
 */
public class AbstractDbcClassImplementsCreateCommand extends EditElementCommand {
    ...
    * @generated
    */
   public AbstractDbcClassImplementsCreateCommand(
   ...
   public boolean canExecute() {
      ...
      if (source != null && false == source instanceof AbstractDbcClass) {
         return false;
      }
      ...
      return DbCBaseItemSemanticEditPolicy.getLinkConstraints()
            .canCreateAbstractDbcClassImplements_4005(getSource(), getTarget());
   }
   ...
   protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
      ...
      if (getSource() != null && getTarget() != null) {
         getSource().getImplements().add(getTarget());
      }
    ...
    * @generated
    */
   protected AbstractDbcClass getSource() {
      return (AbstractDbcClass) source;
   }
