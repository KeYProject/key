 ...
 * @generated
 */
public class DbCAxiomContractPreEditPart extends CompartmentEditPart implements
      ITextAwareEditPart {
    ...
    * @generated
    */
   public DbCAxiomContractPreEditPart(View view) {
      super(view);
   }
      ...
      if (parser == null) {
         parser = DbCParserProvider
               .getParser(
                     ...
                     getParserElement(),
                     DbCVisualIDRegistry
                           .getType(de.hentschel.visualdbc.dbcmodel.diagram.edit.parts.DbCAxiomContractPreEditPart.VISUAL_ID));
      }
      return parser;
   }
