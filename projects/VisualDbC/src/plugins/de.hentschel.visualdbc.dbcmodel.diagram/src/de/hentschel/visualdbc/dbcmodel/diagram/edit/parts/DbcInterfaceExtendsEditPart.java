...
import de.hentschel.visualdbc.dbcmodel.diagram.edit.policies.DbcInterfaceExtendsItemSemanticEditPolicy;

/**
 * @generated
 */
public class DbcInterfaceExtendsEditPart extends ConnectionNodeEditPart
    ...
    * @generated
    */
   public DbcInterfaceExtendsEditPart(View view) {
      super(view);
   }
   ...
   protected void createDefaultEditPolicies() {
      ...
      installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
            new DbcInterfaceExtendsItemSemanticEditPolicy());
   }
