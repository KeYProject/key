 ...
 * @generated
 */
public class DbcClass2ItemSemanticEditPolicy extends
      DbCBaseItemSemanticEditPolicy {

   /**
    * @generated
    */
   public DbcClass2ItemSemanticEditPolicy() {
      super(DbCElementTypes.DbcClass_3031);
   }
   ...
   protected Command getStartCreateRelationshipCommand(
      ...
      if (DbCElementTypes.DbcClassExtends_4003 == req.getElementType()) {
         return getGEFWrapper(new DbcClassExtendsCreateCommand(req,
   ...
   protected Command getReorientReferenceRelationshipCommand(
      ...
      case DbcClassExtendsEditPart.VISUAL_ID:
         return getGEFWrapper(new DbcClassExtendsReorientCommand(req));
