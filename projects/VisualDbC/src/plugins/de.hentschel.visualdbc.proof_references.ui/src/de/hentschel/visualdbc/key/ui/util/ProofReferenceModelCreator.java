 ...
 */
// TODO: Implement special handling of inner types
public class ProofReferenceModelCreator {
    ...
    * @throws DSException Occurred Exception.
    */
   private DbcProof makeSureProofExist(Proof proof, Services services) throws DSException {
      ...
      if (result == null) {
         ...
         if (input instanceof ContractPO) {
            ...
            AbstractDbcOperation dbcOperation = makeSureOperationExist(pm);
    ...
    * @throws DSException Occurred Exception.
    */
   private DbcProofReference makeSureProofReferenceExist(IProofReference<?> reference, Services services, DbcProof dbcProof) throws DSException {
      ...
      if (result == null) {
         ...
         if (reference.getTarget() instanceof IProgramMethod) {
            dbcReferencable = makeSureOperationExist((IProgramMethod)reference.getTarget());
         }
    ...
    * @throws DSException Occurred Exception.
    */
   private String toDbcReferenceKind(String kind) throws DSException {
    ...
    * @throws DSException Occurred Exception.
    */
   private DbcOperationContract makeSureOperationContractExist(FunctionalOperationContract contract, Services services) throws DSException {
      if (contract.getTarget() instanceof IProgramMethod) {
         DbcOperationContract result = operationContractMapping.get(contract);
         if (result == null) {
            AbstractDbcOperation dbcOperation = makeSureOperationExist((IProgramMethod)contract.getTarget());
    ...
    * @throws DSException Occurred Exception.
    */
   private DbCAxiomContract makeSureAxiomContractExist(final DependencyContract contract, final Services services) throws DSException {
      ClassAxiom ca;
    ...
    * @throws DSException Occurred Exception.
    */
   private AbstractDbcOperation makeSureOperationExist(IProgramMethod pm) throws DSException {
      if (!pm.isImplicit()) {
         AbstractDbcOperation result = operationMapping.get(pm);
         if (result == null) {
            AbstractDbcType dbcType = makeSureTypeExist(pm.getContainerType());
            if (pm.isConstructor()) {
    ...
    * @throws DSException Occurred Exception.
    */
   private AbstractDbcType makeSureTypeExist(KeYJavaType kjt) throws DSException {
      ...
      if (result == null) {
         ...
         if (ct.isInterface()) {
            ...
            dbcModel.getTypes().add(dbcClass);
            result = dbcClass;
         }
    ...
    * @throws DSException Occurred Exception.
    */
   private DbcEnumLiteral makeSureLiteralExist(IProgramVariable pv, Services services) throws DSException {
      ...
      if (result == null) {
         ...
         AbstractDbcType dbcType = makeSureTypeExist(((ProgramVariable)pv).getContainerType());
    ...
    * @throws DSException Occurred Exception.
    */
   private DbcAttribute makeSureAttributeExist(IProgramVariable pv, Services services) throws DSException {
      if (!(pv instanceof ProgramVariable)) {
         throw new DSException("\"" + pv + "\" is no ProgramVariable.");
      }
    ...
    */
   private Field toField(final ProgramVariable pv, Services services) {
    ...
    * @throws DSException Occurred Exception.
    */
   private DbcAxiom makeSureAxiomExist(ClassAxiom ca, Services services) throws DSException {
      if (KeyConnection.shouldIncludeClassAxiom(services, ca.getKJT(), ca)) {
         ...
         if (result == null) {
            ...
            AbstractDbcType dbcType = makeSureTypeExist(ca.getKJT());
    ...
    * @throws DSException Occurred Exception.
    */
   private DbcInvariant makeSureInvariantExist(ClassInvariant ci, Services services) throws DSException {
      ...
      if (result == null) {
         ...
         AbstractDbcType dbcType = makeSureTypeExist(ci.getKJT());
