...
/**
 * Special {@link DbcInterfaceItemProvider} in that children are filtered
 * for statistic purpose. That means that only provable children are returned.
 * @author Martin Hentschel
 */
public class StatisticDbcInterfaceItemProvider extends DbcInterfaceItemProvider implements ITableItemLabelProvider {
   /**
    * Constructor.
    * @param adapterFactory The parent {@link AdapterFactory}.
    */
   public StatisticDbcInterfaceItemProvider(AdapterFactory adapterFactory) {
