...
/**
 * Special {@link DbcOperationContractItemProvider} in that children are filtered
 * for statistic purpose. That means that only provable children are returned.
 * @author Martin Hentschel
 */
public class StatisticDbcOperationContractItemProvider extends DbcOperationContractItemProvider implements ITableItemLabelProvider {
   /**
    * Constructor.
    * @param adapterFactory The parent {@link AdapterFactory}.
    */
   public StatisticDbcOperationContractItemProvider(AdapterFactory adapterFactory) {
