...
/**
 * Special {@link DbcClassItemProvider} in that children are filtered
 * for statistic purpose. That means that only provable children are returned.
 * @author Martin Hentschel
 */
public class StatisticDbcClassItemProvider extends DbcClassItemProvider implements ITableItemLabelProvider {
   /**
    * Constructor.
    * @param adapterFactory The parent {@link AdapterFactory}.
    */
   public StatisticDbcClassItemProvider(AdapterFactory adapterFactory) {
