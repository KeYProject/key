...
/**
 * Special {@link DbcConstructorItemProvider} in that children are filtered
 * for statistic purpose. That means that only provable children are returned.
 * @author Martin Hentschel
 */
public class StatisticDbcConstructorItemProvider extends DbcConstructorItemProvider implements ITableItemLabelProvider {
   /**
    * Constructor.
    * @param adapterFactory The parent {@link AdapterFactory}.
    */
   public StatisticDbcConstructorItemProvider(AdapterFactory adapterFactory) {
   ...
   protected Collection<? extends EStructuralFeature> getAnyChildrenFeatures(Object object) {
      ...
      result.add(DbcmodelPackage.Literals.ABSTRACT_DBC_OPERATION__OPERATION_CONTRACTS);
      return result;
   }
