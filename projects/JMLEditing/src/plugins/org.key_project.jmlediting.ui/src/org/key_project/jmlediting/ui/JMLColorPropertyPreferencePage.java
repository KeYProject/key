...
import org.eclipse.swt.widgets.Label;
   ...
   private void initializeDefaults() {
      ...
      IEclipsePreferences preferences = InstanceScope.INSTANCE
            .getNode(Activator.PLUGIN_ID);
      preferences.put(COMMENT_COLOR.getLocalName(), DEFAULT_JML_COMMENT_COLOR.toString());
      ...
      private void updateValues() {
         ...
         if (color == null) {
            ...
            color = preferences.get(
                  COMMENT_COLOR.getLocalName(), null);
            }
      ...
      /**
       * Changes the String col in a RGB-representation of a color.
       * The format of the string is the outcome of the method RGB.toString()
       * @param col the string should have the format RGB {x, y, z}
         ...
         if (this.isProjectPreferencePage()) {
            ...
            try {
               if (this.useProjectSettings()) {
                  // Set property
                  project.setPersistentProperty(COMMENT_COLOR,
                        CommentColor.getColorValue().toString());
            ...
            // global properties
            preferences
               .put(COMMENT_COLOR.getLocalName(), CommentColor.getColorValue().toString());
