Automatic Verifier
==================
This folder contains all content of the Automatic Verifier.
...
------------------------------------------
- org.key_project.automaticverifier.feature
  // Provides the whole functionality
  - org.key_project.automaticverifier.product.ui // The whole functionality.
...
------------------------------------------
1. Open file org.key_project.automaticverifier.product.ui/AutomaticVerifier.product
...
2. Click on "Eclipse Product export wizard" in tab "Overview" of the
   opened "Product Configuration Editor"
3. Define "Root directory" e.g. "AutomaticVerifier" and "Destination Directory"
   e.g. "C:\Temp".
4. Finish the wizard.
