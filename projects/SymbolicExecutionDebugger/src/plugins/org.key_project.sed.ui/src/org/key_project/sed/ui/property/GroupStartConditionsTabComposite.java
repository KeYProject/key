...
public class GroupStartConditionsTabComposite extends AbstractNodeTreeTabComposite {
   /**
    * {@inheritDoc}
    */
   @Override
   ...
   protected PresentationContext createPresentationContext() {
      return new PresentationContext(ISEDConstants.ID_GROUP_START_CONDITIONS);
   }
