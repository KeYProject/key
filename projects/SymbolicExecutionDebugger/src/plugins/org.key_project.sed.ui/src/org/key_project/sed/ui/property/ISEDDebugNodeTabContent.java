...
/**
 * Defines the functionality required to show content in an {@link AbstractSEDDebugNodePropertySection}.
 * @author Martin Hentschel
 */
public interface ISEDDebugNodeTabContent extends IDisposable {
   /**
