...
/**
 * {@link ISection} implementation to show properties of {@link ODState}s.
 * @author Martin Hentschel
 */
public class StatePropertySection extends AbstractObjectDiagramPropertySection<ODState> {
   /**
    * Shows {@link ODState#getName()}.
    */
   ...
   @Override
   public void refresh() {
      ODState object = getBusinessObject();
      if (object != null) {
