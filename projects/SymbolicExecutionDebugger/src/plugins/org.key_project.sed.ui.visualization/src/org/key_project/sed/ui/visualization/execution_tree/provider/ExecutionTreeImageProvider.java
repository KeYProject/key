...
public class ExecutionTreeImageProvider extends AbstractImageProvider {
   ...
   protected void addAvailableImages() {
       ...
       addImageFilePath(IExecutionTreeImageConstants.IMG_BRANCH_STATEMENT, ROOT_FOLDER_FOR_IMG + "branch_node.gif");
       ...
       addImageFilePath(IExecutionTreeImageConstants.IMG_LOOP_STATEMENT, ROOT_FOLDER_FOR_IMG + "loop_node.gif");
       ...
       addImageFilePath(IExecutionTreeImageConstants.IMG_OPERATION_CONTRACT, ROOT_FOLDER_FOR_IMG + "use_operation_contract.gif");
       addImageFilePath(IExecutionTreeImageConstants.IMG_OPERATION_CONTRACT_NOT_NPC, ROOT_FOLDER_FOR_IMG + "use_operation_contract_not_npc.gif");
       addImageFilePath(IExecutionTreeImageConstants.IMG_OPERATION_CONTRACT_NOT_PRE, ROOT_FOLDER_FOR_IMG + "use_operation_contract_not_pre.gif");
       addImageFilePath(IExecutionTreeImageConstants.IMG_OPERATION_CONTRACT_NOT_PRE_NOT_NPC, ROOT_FOLDER_FOR_IMG + "use_operation_contract_not_pre_not_npc.gif");
       addImageFilePath(IExecutionTreeImageConstants.IMG_LOOP_INVARIANT, ROOT_FOLDER_FOR_IMG + "use_loop_invariant.gif");
       addImageFilePath(IExecutionTreeImageConstants.IMG_LOOP_INVARIANT_INITIALLY_INVALID, ROOT_FOLDER_FOR_IMG + "use_loop_invariant _initially_invalid.gif");
