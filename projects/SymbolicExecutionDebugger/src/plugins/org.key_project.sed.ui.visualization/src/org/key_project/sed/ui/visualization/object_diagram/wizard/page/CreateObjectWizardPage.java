...
/**
 * {@link WizardPage} to define the initial values of new {@link ODObject}s.
 * @author Martin Hentschel
 * @see CreateObjectWizard
 */
public class CreateObjectWizardPage extends WizardPage {
    ...
    */
   public CreateObjectWizardPage(String pageName) {
      super(pageName);
   ...
   protected void updatePageCompleted() {
      ...
      if (valid) {
         valid = !StringUtil.isTrimmedEmpty(getTypeValue());
         if (!valid) {
