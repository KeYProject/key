...
/**
 * {@link ISection} implementation to show properties of {@link ODObject}s.
 * @author Martin Hentschel
 */
public class ObjectPropertySection extends AbstractObjectDiagramPropertySection<ODObject> {
   /**
    * Shows {@link ODObject#getName()}.
    */
   private Text nameText;

   /**
    * Shows {@link ODObject#getType()}.
    */
   ...
   @Override
   public void refresh() {
      ODObject object = getBusinessObject();
      if (object != null) {
