...
/**
 * {@link WizardPage} to define the initial values of new {@link ODAssociation}s.
 * @author Martin Hentschel
 * @see CreateAssociationWizard
 */
public class CreateAssociationWizardPage extends WizardPage {
   /**
    ...
    */
   public CreateAssociationWizardPage(String pageName) {
      super(pageName);
      setTitle("Create Association");
      setDescription("Define the properties of the Association to create.");
   }
