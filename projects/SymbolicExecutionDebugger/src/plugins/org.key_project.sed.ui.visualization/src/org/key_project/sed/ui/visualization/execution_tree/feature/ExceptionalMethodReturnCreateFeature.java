...
/**
 * Implementation of {@link ICreateFeature} for {@link ISEDExceptionalMethodReturn}s.
...
public class ExceptionalMethodReturnCreateFeature extends AbstractDebugNodeCreateFeature {
   ...
   protected ISEDDebugNode createNewDebugNode(ISEDDebugTarget target,
      ...
      SEDMemoryExceptionalMethodReturn result = new SEDMemoryExceptionalMethodReturn(target, parent, thread);
      result.setName(name);
      return result;
   }
}