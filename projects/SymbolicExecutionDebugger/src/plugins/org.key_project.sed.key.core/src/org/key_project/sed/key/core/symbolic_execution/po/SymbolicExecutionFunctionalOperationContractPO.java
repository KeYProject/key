package org.key_project.sed.key.core.symbolic_execution.po;
 ...
 * for the special purpose of the symbolic execution tree extraction.
 * </p>
 * <p>
 ...
 * form {@code predicate SETAccumulate(HeapSort, MethodParameter1Sort, ... MethodParameterNSort)}. 
 * </p>
 * <p>
 * The extra predicate is used for two purposes:
 * <ul>
 *    <li>The proof is not closable. This is a required functionality of
 *        the symbolic execution tree extraction to filter invalid execution paths.
 ...
 *        variables not interested in (all the others which are no parameter of the predicate)</li>
 * </ul>
 * </p>
 * @author Martin Hentschel
 */
public class SymbolicExecutionFunctionalOperationContractPO extends FunctionalOperationContractPO {
    /**
     * Constructor.
     * @param initConfig The {@link InitConfig} to use.
     * @param contract The {@link FunctionalOperationContract} to prove.
     */
    public SymbolicExecutionFunctionalOperationContractPO(InitConfig initConfig, 
     ...
     * "SETAccumulate" which is used to filter invalid execution branches
