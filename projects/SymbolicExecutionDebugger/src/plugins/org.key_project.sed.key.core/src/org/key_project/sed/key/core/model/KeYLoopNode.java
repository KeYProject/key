 ...
 */
public class KeYLoopNode extends AbstractSEDLoopNode implements IKeYSEDDebugNode<IExecutionLoopNode> {
   /**
    * The {@link IExecutionLoopNode} to represent by this debug node.
    */
   private IExecutionLoopNode executionNode;
    ...
    * @param executionNode The {@link IExecutionLoopNode} to represent by this debug node.
    */
   public KeYLoopNode(KeYDebugTarget target, 
                      IKeYSEDDebugNode<?> parent, 
                      ISEDThread thread, 
                      IExecutionLoopNode executionNode) {
    ...
    */
   @Override
   public IExecutionLoopNode getExecutionNode() {
