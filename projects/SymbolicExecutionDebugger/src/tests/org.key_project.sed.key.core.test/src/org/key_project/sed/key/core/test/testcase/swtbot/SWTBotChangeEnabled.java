...
public class SWTBotChangeEnabled extends AbstractKeYDebugTargetTestCase {
   
   private static final String CALLER_PATH= ResourcesPlugin.getWorkspace().getRoot().getRawLocation().toString() + "/SWTBotChangeEnabled_test/src/BreakpointStopCallerAndLoop.java";
   ...
   public void test() throws Exception{
      ...
      doKeYDebugTargetTest("SWTBotChangeEnabled_test",
