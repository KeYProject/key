...
public class SWTBotHotCodeReplaceTerminateTestCase extends
   ...
   public void testHotCodeReplace() throws Exception{
      IKeYDebugTargetTestExecutor executor = new AbstractKeYDebugTargetTestExecutor() {
         ...
         public void test(SWTWorkbenchBot bot, IJavaProject project, IMethod method, String targetName, SWTBotView debugView, SWTBotTree debugTree, ISEDDebugTarget target, ILaunch launch) throws Exception {
            IPath classPath = new Path(ResourcesPlugin.getWorkspace().getRoot().getRawLocation().toString() + "/SWTBotHotCodeReplaceTerminateTestCase_testHotCodeReplace/src/CodeReplace.java");
            ...
            TestUtilsUtil.clickDirectly(bot, "Terminate");
            assertFalse(hotCodeReplaceDialog.isOpen());
            assertTrue(target.isTerminated());
            assertFalse(target.isDisconnected());
         }
      };
      doKeYDebugTargetTest("SWTBotHotCodeReplaceTerminateTestCase_testHotCodeReplace",
