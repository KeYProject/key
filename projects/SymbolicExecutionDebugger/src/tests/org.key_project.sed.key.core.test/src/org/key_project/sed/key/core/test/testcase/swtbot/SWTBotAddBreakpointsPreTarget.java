...
public class SWTBotAddBreakpointsPreTarget extends AbstractKeYDebugTargetTestCase {
   
   private static final String CALLER_PATH= ResourcesPlugin.getWorkspace().getRoot().getRawLocation().toString() + "/SWTBotAddBreakpointsPreTarget_test/src/BreakpointStopCallerAndLoop.java";
   ...
   public void test() throws Exception{
      ...
      doKeYDebugTargetTest("SWTBotAddBreakpointsPreTarget_test",
            ...
            8,
            executor,
            CALLER_PATH, 15,14,5,"NullPointerException");   
   } 
}
