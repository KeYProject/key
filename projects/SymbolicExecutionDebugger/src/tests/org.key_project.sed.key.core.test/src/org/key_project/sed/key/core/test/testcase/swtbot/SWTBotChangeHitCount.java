...
public class SWTBotChangeHitCount extends AbstractKeYDebugTargetTestCase {
   
   private static final String CALLER_PATH= ResourcesPlugin.getWorkspace().getRoot().getRawLocation().toString() + "/SWTBotChangeHitCount_test/src/BreakpointStopCallerAndLoop.java";
   ...
   public void test() throws Exception{
      ...
      doKeYDebugTargetTest("SWTBotChangeHitCount_test",
