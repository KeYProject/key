...
public class SWTBotChangeConditonWithErrorOKThenOKWithChange extends AbstractKeYDebugTargetTestCase {
   
   private static final String CALLER_PATH= ResourcesPlugin.getWorkspace().getRoot().getRawLocation().toString() + "/SWTBotChangeConditonWithErrorOKThenOKWithChange_test/src/BreakpointStopCallerAndLoop.java";
   ...
   public void test() throws Exception{
      IKeYDebugTargetTestExecutor executor = new AbstractKeYDebugTargetTestExecutor() {
         ...
         public void test(SWTWorkbenchBot bot, IJavaProject project, IMethod method, String targetName, SWTBotView debugView, SWTBotTree debugTree, ISEDDebugTarget target, ILaunch launch) throws Exception {            
            ...
            bot.styledText().setText("a==0");
            TestUtilsUtil.clickDirectly(bot,"OK");
            TestUtilsUtil.sleep(2000);
            assertEquals(mainShellText, bot.activeShell().getText());
            TestBreakpointsUtil.removeAllBreakpoints();
         }
      };
      doKeYDebugTargetTest("SWTBotChangeConditonWithErrorOKThenOKWithChange_test",
