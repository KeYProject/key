...
public class SWTBotChangeAccessModification extends AbstractKeYDebugTargetTestCase {
   
   private static final String CALLER_PATH= ResourcesPlugin.getWorkspace().getRoot().getRawLocation().toString() + "/SWTBotChangeAccessModification_test/src/BreakpointStopCallerAndLoop.java";
   ...
   public void test() throws Exception{
      IKeYDebugTargetTestExecutor executor = new AbstractKeYDebugTargetTestExecutor() {
         ...
         public void test(SWTWorkbenchBot bot, IJavaProject project, IMethod method, String targetName, SWTBotView debugView, SWTBotTree debugTree, ISEDDebugTarget target, ILaunch launch) throws Exception {            
            ...
            TestBreakpointsUtil.addSomeBreakpoints(CALLER_PATH, bot, 5, 3);
      ...
      doKeYDebugTargetTest("SWTBotChangeAccessModification_test",
