...
public class SWTBotRemoveExceptionBreakpoint extends AbstractKeYDebugTargetTestCase {
   
   private static final String CALLER_PATH= ResourcesPlugin.getWorkspace().getRoot().getRawLocation().toString() + "/SWTBotRemoveExceptionBreakpoint_test/src/BreakpointStopCallerAndLoop.java";
   ...
   public void test() throws Exception{
      IKeYDebugTargetTestExecutor executor = new AbstractKeYDebugTargetTestExecutor() {
         ...
         public void test(SWTWorkbenchBot bot, IJavaProject project, IMethod method, String targetName, SWTBotView debugView, SWTBotTree debugTree, ISEDDebugTarget target, ILaunch launch) throws Exception {            
            ...
            TestBreakpointsUtil.addSomeBreakpoints(CALLER_PATH, bot, 15, 14, 5, "NullPointerException", "ClassCastException");
      ...
      doKeYDebugTargetTest("SWTBotRemoveExceptionBreakpoint_test",
