...
public class SWTBotChangeConditonWithErrorCancel extends AbstractKeYDebugTargetTestCase {
   
   private static final String CALLER_PATH= ResourcesPlugin.getWorkspace().getRoot().getRawLocation().toString() + "/SWTBotChangeConditionWithErrorCancel_test/src/BreakpointStopCallerAndLoop.java";
   ...
   public void test() throws Exception{
      ...
      doKeYDebugTargetTest("SWTBotChangeConditionWithErrorCancel_test",
