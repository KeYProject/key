...
public class SWTBotChangeConditonWithErrorOKThenCancel extends AbstractKeYDebugTargetTestCase {
   
   private static final String CALLER_PATH= ResourcesPlugin.getWorkspace().getRoot().getRawLocation().toString() + "/SWTBotChangeConditionWithErrorOKThenCancel_test/src/BreakpointStopCallerAndLoop.java";
   ...
   public void test() throws Exception{
      ...
      doKeYDebugTargetTest("SWTBotChangeConditionWithErrorOKThenCancel_test",
