...
public class SWTBotRemoveMethodBreakpoint extends AbstractKeYDebugTargetTestCase {
   
   private static final String CALLER_PATH= ResourcesPlugin.getWorkspace().getRoot().getRawLocation().toString() + "/SWTBotRemoveMethodBreakpoint_test/src/BreakpointStopCallerAndLoop.java";
   ...
   public void test() throws Exception{
      IKeYDebugTargetTestExecutor executor = new AbstractKeYDebugTargetTestExecutor() {
         ...
         public void test(SWTWorkbenchBot bot, IJavaProject project, IMethod method, String targetName, SWTBotView debugView, SWTBotTree debugTree, ISEDDebugTarget target, ILaunch launch) throws Exception {            
            ...
            TestBreakpointsUtil.addSomeBreakpoints(CALLER_PATH, bot, 15, 14, 5, 7, "NullPointerException");
      ...
      doKeYDebugTargetTest("SWTBotRemoveMethodBreakpoint_test",
