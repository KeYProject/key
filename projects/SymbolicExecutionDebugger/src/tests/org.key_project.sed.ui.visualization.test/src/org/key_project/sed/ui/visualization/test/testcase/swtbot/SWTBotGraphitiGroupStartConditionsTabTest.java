...
/**
 * Tests the property page tab "Group Starts" in a Symbolic Execution Tree diagram.
 * @author Martin Hentschel
 */
public class SWTBotGraphitiGroupStartConditionsTabTest extends AbstractSWTBotGraphitiPropertyTabTest {
   /**
    * Tests the shown values and the existence of tab "Method Returns".
    */
   @Test
   public void testValuesAndTabExistence() throws Exception {
      doFixedExampleTest(SWTBotGroupStartConditionsTabTest.createFixedExampleSteps());
   }
