...
public class ProofTextViewer extends TextViewer {
   ...
   public ProofTextViewer(Composite parent, int i) {
      super(parent, i);
      initializeValues();
   }
   ...
   public void setBackgroundColorForHover(){
      ...
      int textOffset = JFaceTextUtil.getOffsetForCursorLocation(this);
