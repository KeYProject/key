...
Note that the linked list is experimental and unfinished. Another (perhaps more promising) approach to dealing with linked lists can be found in the "vstte10_3" example. 
