...
public final class Do extends JavaSourceElement implements LoopStatement {
    ...
    public Do withAttachedJml(ImmutableList<TextualJMLConstruct> attachedJml) {
        return new Do(attachedJml, body(), guard(), inits(), positionInfo(), updates());
    }

    public Do withBody(Statement body) {
        return new Do(attachedJml(), body, guard(), inits(), positionInfo(), updates());
    }

    public Do withGuard(IGuard guard) {
        return new Do(attachedJml(), body(), guard, inits(), positionInfo(), updates());
    }

    public Do withInits(ILoopInit inits) {
        return new Do(attachedJml(), body(), guard(), inits, positionInfo(), updates());
    }

    public Do withPositionInfo(PositionInfo positionInfo) {
        return new Do(attachedJml(), body(), guard(), inits(), positionInfo, updates());
    }

    public Do withUpdates(IForUpdates updates) {
        return new Do(attachedJml(), body(), guard(), inits(), positionInfo(), updates);
    }
    ...
    public String toString() {
        return "Do[attachedJml=%s, body=%s, guard=%s, inits=%s, positionInfo=%s, updates=%s]".formatted(attachedJml, body, guard, inits, positionInfo, updates);
    }
