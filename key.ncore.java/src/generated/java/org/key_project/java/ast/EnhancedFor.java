...
public final class EnhancedFor extends JavaSourceElement implements LoopStatement {
    ...
    public EnhancedFor(@EqEx ImmutableList<TextualJMLConstruct> attachedJml, Statement body, IGuard guard, ILoopInit inits, @EqEx @Nullable PositionInfo positionInfo, IForUpdates updates) {
    ...
    public EnhancedFor(@EqEx ImmutableList<TextualJMLConstruct> attachedJml, Statement body, IGuard guard, ILoopInit inits, IForUpdates updates) {
        this.attachedJml = Objects.requireNonNull(attachedJml);
        this.body = Objects.requireNonNull(body);
        this.guard = Objects.requireNonNull(guard);
        this.inits = Objects.requireNonNull(inits);
