...
@NullMarked()
public final class TypeRef extends JavaSourceElement implements TypeReferenceImp {
    ...
    public TypeRef(int dimensions, ProgramElementName name, @EqEx @Nullable PositionInfo positionInfo, ReferencePrefix prefix) {
    ...
    public TypeRef(int dimensions, ProgramElementName name, ReferencePrefix prefix) {
        this.dimensions = Objects.requireNonNull(dimensions);
        this.name = Objects.requireNonNull(name);
    ...
    public TypeRef withDimensions(int dimensions) {
        return new TypeRef(dimensions, name(), positionInfo(), prefix());
    }

    public TypeRef withName(ProgramElementName name) {
        return new TypeRef(dimensions(), name, positionInfo(), prefix());
    }

    public TypeRef withPositionInfo(PositionInfo positionInfo) {
        return new TypeRef(dimensions(), name(), positionInfo, prefix());
    }

    public TypeRef withPrefix(ReferencePrefix prefix) {
        return new TypeRef(dimensions(), name(), positionInfo(), prefix);
    }
    ...
    public String toString() {
        return "TypeRef[dimensions=%s, name=%s, positionInfo=%s, prefix=%s]".formatted(dimensions, name, positionInfo, prefix);
    }
