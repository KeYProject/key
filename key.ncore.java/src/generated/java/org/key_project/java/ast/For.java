...
public final class For extends JavaSourceElement implements LoopStatement {
    ...
    public For(ImmutableList<TextualJMLConstruct> attachedJml, Statement body, IGuard guard, ILoopInit inits, @EqEx @Nullable PositionInfo positionInfo, IForUpdates updates) {
    ...
    public For(ImmutableList<TextualJMLConstruct> attachedJml, Statement body, IGuard guard, ILoopInit inits, IForUpdates updates) {
        this.attachedJml = Objects.requireNonNull(attachedJml);
        this.body = Objects.requireNonNull(body);
        this.guard = Objects.requireNonNull(guard);
        this.inits = Objects.requireNonNull(inits);
