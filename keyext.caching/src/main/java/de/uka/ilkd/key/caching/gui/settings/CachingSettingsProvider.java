...
package de.uka.ilkd.key.caching.gui.settings;
...
import static de.uka.ilkd.key.caching.gui.settings.ProofCachingSettings.DISPOSE_COPY;
import static de.uka.ilkd.key.caching.gui.settings.ProofCachingSettings.DISPOSE_REOPEN;
import static de.uka.ilkd.key.caching.gui.settings.ProofCachingSettings.PRUNE_COPY;
import static de.uka.ilkd.key.caching.gui.settings.ProofCachingSettings.PRUNE_REOPEN;
