...
public class ProjectInfoManagementTest extends AbstractResourceTest {
   ...
   public void testDeclaringTypes() throws Exception {
      ...
      IProject project = KeY4EclipseResourcesTestUtil.initializeTest("ProjectInfoManagementTest_testDeclaringTypes", true, false, true, false, 1, true, false, false);
   ...
   public void testPackagesAndTypes() throws Exception {
      // Test empty project (step 0)
      IProject project = KeY4EclipseResourcesTestUtil.initializeTest("ProjectInfoManagementTest_testPackagesAndTypes", true, false, true, false, 1, true, false, false);
   ...
   public void testMethods() throws Exception {
      // Test empty project (step 0)
      IProject project = KeY4EclipseResourcesTestUtil.initializeTest("ProjectInfoManagementTest_testMethods", true, false, true, false, 1, true, false, false);
   ...
   public void testMethodContracts() throws Exception {
      // Test empty project (step 0)
      IProject project = KeY4EclipseResourcesTestUtil.initializeTest("ProjectInfoManagementTest_testMethodContracts", true, false, true, false, 1, true, false, false);
   ...
   public void testObserverFunctionsAndContracts() throws Exception {
      // Test empty project (step 0)
      IProject project = KeY4EclipseResourcesTestUtil.initializeTest("ProjectInfoManagementTest_testObserverFunctionsAndContracts", true, false, true, false, 1, true, false, false);
