 ...
 */
public class FunctionalOperationContractCompletion
        extends AbstractInteractiveRuleApplicationCompletion {
    /**
     * {@inheritDoc}
     */
    @Override
    ...
    public static class Perform
            extends AbstractInteractiveRuleApplicationCompletionPerform {
        /**
        ...
        public Perform(IBuiltInRuleApp app, Goal goal, boolean forced) {
            ...
            inst = UseOperationContractRule.computeInstantiation(
                app.posInOccurrence().subTerm(), getServices());
        ...
        public void createControl(Composite root) {
            ...
            /*
             * The TableColumnLayout together with the not visible
             * TableViewerColumn ensure that no vertical column lines are shown.
             */
            ...
            TableViewerColumn contractColumn = new TableViewerColumn(viewer,
                SWT.NONE);
            contractColumn.getColumn().setText("Kind");
            tableLayout.setColumnData(contractColumn.getColumn(),
                new ColumnWeightData(100));
            viewer.setContentProvider(
                ImmutableCollectionContentProvider.getInstance());
        ...
        public IBuiltInRuleApp finish() {
            // Similiar behavior as
            // de.uka.ilkd.key.gui.FunctionalOperationContractCompletion#complete(...).
            Contract contract = getSelectedContract();
            if (contract != null) {
                return ((UseOperationContractRule) getApp().rule())
                        .createApp(getApp().posInOccurrence())
         ...
         *
         * @return The selected {@link Contract} or {@code null} if not
         *         available.
         */
        protected Contract getSelectedContract() {
            @SuppressWarnings("unchecked")
            final List<Contract> selection = (List<Contract>) SWTUtil
                    .toList(viewer.getSelection());
