...
public class IconExporter extends TestCase {
   ...
   public void testExportImage() throws Exception {
      ...
      decorateImages(new IconToDecorate(hole17Image, decProofFileImage, 16, 16, 0, 0, "KeY4Eclipse/src/plugins/org.key_project.key4eclipse.common.ui/icons/prooffile16.png")
                     //, new IconToDecorate(hole17Image, decKeYFileImage, 16, 16, 0, 0, "KeY4Eclipse/src/plugins/org.key_project.key4eclipse.common.ui/icons/keyfile16.png")
                     );
      treatIconsToExport(new IconToExpoert(IconFactory.testGeneration(16), 0, 0, "KeY4Eclipse/src/plugins/org.key_project.key4eclipse.common.ui/icons/testGeneration.png"));
      ...
      decorateImages(//new IconToDecorate(hole17Image, empty16Image, 16, 16, 0, 0, "KeY4Eclipse/src/plugins/org.key_project.key4eclipse.resources/icons/projectIcon.png"), // This icon requires to fill the hole manually in white
                     new IconToDecorate(baseImage, infoImage, 12, 14, -3, -2, "KeY4Eclipse/src/plugins/org.key_project.key4eclipse.resources/icons/keyinfo12x14.png"),
                     new IconToDecorate(baseImage, PlatformUI.getWorkbench().getSharedImages().getImage(ISharedImages.IMG_DEC_FIELD_WARNING), 12, 14, -3, -2, "KeY4Eclipse/src/plugins/org.key_project.key4eclipse.resources/icons/keywarning12x14.png"),
                     new IconToDecorate(baseImage, PlatformUI.getWorkbench().getSharedImages().getImage(ISharedImages.IMG_DEC_FIELD_ERROR), 12, 14, -3, -2, "KeY4Eclipse/src/plugins/org.key_project.key4eclipse.resources/icons/keyerror12x14.png"));
      ...
      decorateImages(new IconToDecorate(hole17Image, decProofMetaFileImage, 16, 16, 0, 0, "KeY4Eclipse/src/plugins/org.key_project.key4eclipse.resources.ui/icons/proofmetafile16.png"));
      ...
      treatIconsToExport(new IconToExpoert(IconFactory.counterExample(16), 0, 0, "KeYIDE/src/plugins/org.key_project.keyide.ui/icons/counterExample.png"));
      treatIconsToExport(new IconToExpoert(IconFactory.keyHoleInteractive(16, 16), 0, 0, "KeYIDE/src/plugins/org.key_project.keyide.ui/icons/keyinteractive.png"));
      treatIconsToExport(new IconToExpoert(IconFactory.editFile(16), 0, 0, "KeYIDE/src/plugins/org.key_project.keyide.ui/icons/editFile.png"));
      decorateImages(new IconToDecorate(hole17Image, decProofFileImage, 16, 16, 0, 0, "KeYIDE/src/plugins/org.key_project.keyide.ui/icons/prooffile16.png"));
   }
