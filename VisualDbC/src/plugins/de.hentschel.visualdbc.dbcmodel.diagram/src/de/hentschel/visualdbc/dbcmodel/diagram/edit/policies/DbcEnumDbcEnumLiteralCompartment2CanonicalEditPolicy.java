 ...
 * @generated
 */
public class DbcEnumDbcEnumLiteralCompartment2CanonicalEditPolicy extends
      CanonicalEditPolicy {
   ...
   protected EStructuralFeature getFeatureToSynchronize() {
      return DbcmodelPackage.eINSTANCE.getAbstractDbcEnum_Literals();
   }
   ...
   protected List getSemanticChildrenList() {
      ...
      List<DbCNodeDescriptor> childDescriptors = DbCDiagramUpdater
            .getDbcEnumDbcEnumLiteralCompartment_7063SemanticChildren(viewObject);
   ...
   private boolean isMyDiagramElement(View view) {
      return DbcEnumLiteralEditPart.VISUAL_ID == DbCVisualIDRegistry
            .getVisualID(view);
   }
   ...
   protected void refreshSemantic() {
      ...
      List<DbCNodeDescriptor> childDescriptors = DbCDiagramUpdater
            .getDbcEnumDbcEnumLiteralCompartment_7063SemanticChildren((View) getHost()
                  .getModel());
