...
public abstract class LegacySpecifyNaturalStrategy extends DecorateLegacy<Nothing> {
    public LegacySpecifyNaturalStrategy(ISearchStrategy<Nothing> fallback) {
        super(fallback);
    }
    ...
    public final Iterable<SearchNode<Nothing>> reason(FirstPrompt reason, Nothing o, Supplier<SearchNodeBuilder<Nothing>> newBuilder) {
        ...
        b.text("You are an assistant for JML annotation.\n" +
                ...
                "If you are asked to provide JML code, your answers should always have the following format where the the <X> is substituted by the JML annotation suggested by you:\n" +
