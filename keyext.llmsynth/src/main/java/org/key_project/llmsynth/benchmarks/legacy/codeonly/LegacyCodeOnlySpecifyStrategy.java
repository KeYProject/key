...
public abstract class LegacyCodeOnlySpecifyStrategy extends DecorateLegacy<Nothing> {
    public LegacyCodeOnlySpecifyStrategy(ISearchStrategy<Nothing> fallback) {
        super(fallback);
    }
    ...
    public final Iterable<SearchNode<Nothing>> reason(FirstPrompt reason, Nothing o, Supplier<SearchNodeBuilder<Nothing>> newBuilder) {
        ...
        b.text("You are an assistant for JML annotation.\n" +
                ...
                "Given the code, your job is to provide a JML specification as asked for by the instructions.\n" +
                "You should only provide the JML annotation: Do not repeat the Java Code and do not provide any natural language descriptions.\n" +
