 ...
 */
public NewDependingOn{if(!((first instanceof SkolemTermSV)&&(second instanceof FormulaSV||second instanceof TermSV))){throw new RuntimeException("NewDependingOn: First SchemaVariable has to be a SkolemTermSV or FormulaSV, "+"the second one has to be a FormulaSV or a TermSV");}}
...
public boolean equals(Object o){if(!(o instanceof NewDependingOn nfi)){return false;}return(nfi.first==first()&&nfi.second==second());}
