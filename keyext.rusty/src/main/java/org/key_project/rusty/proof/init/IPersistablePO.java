 ...
 * ({@link de.uka.ilkd.key.proof.init.ProofOblInput}) with functionality
 ...
 * The returned {@link de.uka.ilkd.key.proof.init.IPersistablePO.LoadedPOContainer} contains the
 * instantiated {@link de.uka.ilkd.key.proof.init.ProofOblInput} together
