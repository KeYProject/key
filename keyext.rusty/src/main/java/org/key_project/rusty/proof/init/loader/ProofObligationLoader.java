 ...
 * the
 * initial sequent (called proof obligation). {@link ProofObligationLoader} are loaded with the help
 * of the
 * {@link java.util.ServiceLoader}, hence you need to register them into the {@code META-INF}
 * folder.
 * <p>
 * A {@link ProofObligationLoader} decides by itself whether it can handle a certain
 * {@link KeYUserProblemFile},
...
public interface ProofObligationLoader {
     ...
     * Currently, the identifier corresponds to the {@code class} entry in the
