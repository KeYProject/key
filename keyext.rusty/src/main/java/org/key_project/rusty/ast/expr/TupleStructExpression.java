...
public record TupleStructExpression(PathInExpression path,ImmutableArray<Expr>elements)implements Expr{@Override public void visit(Visitor v){v.performActionOnTupleStructExpression(this);}
