...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>dependencymodel</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class DependencymodelExample {
   /**
    * <!-- begin-user-doc -->
   ...
   public static void main(String[] args) {
      ...
      resourceSet.getPackageRegistry().put
         (DependencymodelPackage.eNS_URI, 
      ...
      if (args.length == 0) {
         ...
         try {
            Resource resource = resourceSet.createResource(URI.createURI("http:///My.dependencymodel"));
            Type root = DependencymodelFactory.eINSTANCE.createType();
