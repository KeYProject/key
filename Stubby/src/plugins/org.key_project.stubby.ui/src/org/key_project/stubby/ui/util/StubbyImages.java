...
/**
 * <p>
 * Provides the images for Stubby.
 * </p>
 * <p>
 ...
 */
public final class StubbyImages {
    /**
     * The key for the image that is used for the generate stubs wizard.
     */
    public static final String GENERATE_STUBS_WIZARD = "org.key_project.stubby.ui.generateStubsWizard";
    
    /**
     * Forbid instances.
     */
    private StubbyImages() {
    }
    ...
    protected static Image createImage(String key) {
        ...
        String path = null;
        if (GENERATE_STUBS_WIZARD.equals(key)) {
           path = "icons/generate_stubs_wizard.png";
        }
       ...
       if (!display.isDisposed()) {
          display.syncExec(new Runnable() {
            ...
            public void run() {
               ...
               registry.remove(GENERATE_STUBS_WIZARD);
            }
         });
       }
    }
