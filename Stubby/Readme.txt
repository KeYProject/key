...
This folder contains all content of the Stub Generator Stubby.

Fore more details about this project visit 
http://www.key-project.org/eclipse/Stubby
or contact Martin Hentschel (hentschel@cs.tu-darmstadt.de).


(1) Project Description
-----------------------
Stubby generates stubs for used API types annotated with default specifications.
