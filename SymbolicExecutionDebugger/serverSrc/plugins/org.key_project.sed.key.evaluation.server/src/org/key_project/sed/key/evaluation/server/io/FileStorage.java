...
public class FileStorage {
    ...
    */
   public static final String FORM_FILE_EXTENSION_WITH_DOT = ".xml";
   ...
   public static String store(AbstractFormInput<?> formInput, List<RandomFormInput> updatedOrders) throws IOException {
      File evaluationFolder = new File(FORM_STORAGE_LOCATION, formInput.getForm().getEvaluation().getName());
