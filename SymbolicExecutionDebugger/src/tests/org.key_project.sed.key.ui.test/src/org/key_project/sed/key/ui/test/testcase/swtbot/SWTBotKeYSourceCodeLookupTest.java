...
public class SWTBotKeYSourceCodeLookupTest extends AbstractSetupTestCase {
   ...
   public void testLookupMarkerInUI() throws Exception {
      ...
      try {
         ...
         // Launch method
         TestSEDKeyCoreUtil.launchKeY(method, null, null, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, Boolean.FALSE);
