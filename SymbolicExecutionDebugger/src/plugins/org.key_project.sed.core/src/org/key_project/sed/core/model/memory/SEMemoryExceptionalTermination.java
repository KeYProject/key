...
/**
 * Implementation of {@link ISEExceptionalTermination} that stores all
 * information in the memory.
 * @author Martin Hentschel
 */
public class SEMemoryExceptionalTermination extends AbstractSEExceptionalTermination implements ISEMemoryStackFrameCompatibleDebugNode, ISEMemoryNode {
   /**
    ...
    */
   public SEMemoryExceptionalTermination(ISEDebugTarget target, 
                                          ISENode parent,
                                          ISEThread thread,
                                          boolean verified) {
