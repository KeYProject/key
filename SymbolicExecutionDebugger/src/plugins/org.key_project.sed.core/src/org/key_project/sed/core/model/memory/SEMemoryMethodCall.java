...
/**
 * Implementation of {@link ISEMethodCall} that stores all
 * information in the memory.
 * @author Martin Hentschel
 */
public class SEMemoryMethodCall extends AbstractSEMethodCall implements ISEMemoryStackFrameCompatibleDebugNode, ISEMemoryNode, ISEMemoryGroupable {
   /**
    ...
    */
   private final List<ISEBranchCondition> methodReturnConditions = new LinkedList<ISEBranchCondition>();
    ...
    */
   public SEMemoryMethodCall(ISEDebugTarget target, 
                              ISENode parent, 
                              ISEThread thread) {
   ...
   public ISEBranchCondition[] getMethodReturnConditions()throws DebugException {
      return methodReturnConditions.toArray(new ISEBranchCondition[methodReturnConditions.size()]);
   }
    ...
    */
   public void addMethodReturnCondition(ISEBranchCondition methodReturnCondition) {
