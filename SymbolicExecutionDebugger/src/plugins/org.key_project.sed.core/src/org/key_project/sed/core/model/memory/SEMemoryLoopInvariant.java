...
/**
 * Implementation of {@link ISELoopInvariant} that stores all
 * information in the memory.
 * @author Martin Hentschel
 */
public class SEMemoryLoopInvariant extends AbstractSELoopInvariant implements ISEMemoryStackFrameCompatibleDebugNode, ISEMemoryNode {
   /**
    ...
    * @param thread The {@link ISEThread} in that this loop invariant is contained.
    */
   public SEMemoryLoopInvariant(ISEDebugTarget target, 
                                 ISENode parent, 
                                 ISEThread thread) {
