...
/**
 * Implementation of {@link ISETermination} that stores all
 * information in the memory.
 * @author Martin Hentschel
 */
public class SEMemoryTermination extends AbstractSETermination implements ISEMemoryStackFrameCompatibleDebugNode, ISEMemoryNode {
   /**
    ...
    */
   public SEMemoryTermination(ISEDebugTarget target, 
                               ISENode parent,
                               ISEThread thread,
                               boolean verified) {
