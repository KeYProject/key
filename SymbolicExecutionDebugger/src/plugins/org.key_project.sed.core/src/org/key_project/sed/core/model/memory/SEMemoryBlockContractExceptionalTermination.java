...
/**
 * Implementation of {@link ISEBlockContractExceptionalTermination} that stores all
 * information in the memory.
 * @author Martin Hentschel
 */
public class SEMemoryBlockContractExceptionalTermination extends AbstractSEBlockContractExceptionalTermination implements ISEMemoryStackFrameCompatibleDebugNode, ISEMemoryNode {
   /**
    ...
    */
   public SEMemoryBlockContractExceptionalTermination(ISEDebugTarget target, 
                                          ISENode parent,
                                          ISEThread thread,
                                          boolean verified) {
