 ...
 * from {@link AbstractSELoopCondition} instead of implementing this
 * interface directly. {@link SEMemoryLoopCondition} is also a default
 * implementation that stores all values in the memory.
 * </p>
 * @author Martin Hentschel
 * @see ISENode
 */
public interface ISELoopCondition extends ISENode, IStackFrame, ISEGroupable {
