 ...
 * from {@link AbstractSEExceptionalTermination} instead of implementing this
 * interface directly. {@link SEMemoryExceptionalTermination} is also a default
 * implementation that stores all values in the memory.
 * </p>
 * @author Martin Hentschel
 * @see ISENode
 */
public interface ISEExceptionalTermination extends ISETermination {
