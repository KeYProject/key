 ...
 * creates multiple child branches defined by branch conditions ({@link ISEBranchCondition}),
 * e.g. {@code if(x >= 0)}.
 * <p>
 ...
 * from {@link AbstractSEBranchStatement} instead of implementing this
 * interface directly. {@link SEMemoryBranchStatement} is also a default
