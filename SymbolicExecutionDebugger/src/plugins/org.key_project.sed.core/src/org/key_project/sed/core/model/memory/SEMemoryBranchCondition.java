...
/**
 * Implementation of {@link ISEBranchCondition} that stores all
 * information in the memory.
 * @author Martin Hentschel
 */
public class SEMemoryBranchCondition extends AbstractSEBranchCondition implements ISEMemoryStackFrameCompatibleDebugNode, ISEMemoryNode {
   /**
    ...
    */
   public SEMemoryBranchCondition(ISEDebugTarget target, 
                                   ISENode parent,
                                   ISEThread thread) {
