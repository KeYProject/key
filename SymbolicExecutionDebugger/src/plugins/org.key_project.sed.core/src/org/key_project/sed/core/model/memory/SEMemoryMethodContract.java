...
/**
 * Implementation of {@link ISEMethodContract} that stores all
 * information in the memory.
 * @author Martin Hentschel
 */
public class SEMemoryMethodContract extends AbstractSEMethodContract implements ISEMemoryStackFrameCompatibleDebugNode, ISEMemoryNode {
   /**
    ...
    * @param thread The {@link ISEThread} in that this method contract is contained.
    */
   public SEMemoryMethodContract(ISEDebugTarget target, 
                                  ISENode parent, 
                                  ISEThread thread) {
