 ...
 * from {@link AbstractSELoopBodyTermination} instead of implementing this
 * interface directly. {@link SEMemoryLoopBodyTermination} is also a default
 * implementation that stores all values in the memory.
 * </p>
 * @author Martin Hentschel
 * @see ISENode
 */
public interface ISELoopBodyTermination extends ISETermination {
