...
import org.key_project.sed.core.model.impl.AbstractSELoopBodyTermination;

/**
 * Implementation of {@link ISELoopBodyTermination} that stores all
 * information in the memory.
 * @author Martin Hentschel
 */
public class SEMemoryLoopBodyTermination extends AbstractSELoopBodyTermination implements ISEMemoryStackFrameCompatibleDebugNode, ISEMemoryNode {
   /**
    ...
    */
   public SEMemoryLoopBodyTermination(ISEDebugTarget target, 
                                          ISENode parent,
                                          ISEThread thread,
                                          boolean verified) {
