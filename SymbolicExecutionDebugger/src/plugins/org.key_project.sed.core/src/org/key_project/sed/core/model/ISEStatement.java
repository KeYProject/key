...
import org.key_project.sed.core.model.impl.AbstractSEStatement;
 ...
 * e.g. {@code int x =  1 + 2;}.
 * <p>
 * A symbolic statement is also a normal stack frame ({@link IStackFrame})
 * for compatibility reasons with the Eclipse debug API.
 * </p>
 * <p>
 * Clients may implement this interface. It is recommended to subclass
 * from {@link AbstractSEStatement} instead of implementing this
 * interface directly. {@link SEMemoryStatement} is also a default
 * implementation that stores all values in the memory.
 * </p>
 * @author Martin Hentschel
 * @see ISENode
 */
public interface ISEStatement extends ISENode, IStackFrame {
