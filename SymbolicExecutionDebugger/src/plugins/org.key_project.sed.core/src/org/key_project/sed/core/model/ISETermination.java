 ...
 * from {@link AbstractSETermination} instead of implementing this
 * interface directly. {@link SEMemoryTermination} is also a default
 * implementation that stores all values in the memory.
 * </p>
 * @author Martin Hentschel
 * @see ISENode
 */
public interface ISETermination extends ISENode, IStackFrame {
   /**
