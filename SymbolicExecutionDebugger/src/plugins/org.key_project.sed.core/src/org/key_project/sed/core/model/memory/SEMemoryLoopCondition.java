...
/**
 * Implementation of {@link ISELoopCondition} that stores all
 * information in the memory.
 * @author Martin Hentschel
 */
public class SEMemoryLoopCondition extends AbstractSELoopCondition implements ISEMemoryStackFrameCompatibleDebugNode, ISEMemoryNode, ISEMemoryGroupable {
   /**
    ...
    */
   public SEMemoryLoopCondition(ISEDebugTarget target, 
                              ISENode parent, 
                              ISEThread thread) {
