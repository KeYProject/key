...
/**
 * Implementation of {@link ISEMethodReturn} that stores all
 * information in the memory.
 * @author Martin Hentschel
 */
public class SEMemoryMethodReturn extends AbstractSEMethodReturn implements ISEMemoryStackFrameCompatibleDebugNode, ISEMemoryBaseMethodReturn {
   /**
    ...
    */
   public SEMemoryMethodReturn(ISEDebugTarget target, 
                                ISENode parent, 
                                ISEThread thread) {
