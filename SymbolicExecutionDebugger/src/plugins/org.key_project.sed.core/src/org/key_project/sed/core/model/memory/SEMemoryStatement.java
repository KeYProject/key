...
/**
 * Implementation of {@link ISEStatement} that stores all
 * information in the memory.
 * @author Martin Hentschel
 */
public class SEMemoryStatement extends AbstractSEStatement implements ISEMemoryStackFrameCompatibleDebugNode, ISEMemoryNode {
   /**
    ...
    */
   public SEMemoryStatement(ISEDebugTarget target, 
                             ISENode parent, 
                             ISEThread thread) {
