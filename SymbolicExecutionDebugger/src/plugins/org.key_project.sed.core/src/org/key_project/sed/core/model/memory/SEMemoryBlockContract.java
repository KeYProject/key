...
/**
 * Implementation of {@link ISEBlockContract} that stores all
 * information in the memory.
 * @author Martin Hentschel
 */
public class SEMemoryBlockContract extends AbstractSEBlockContract implements ISEMemoryStackFrameCompatibleDebugNode, ISEMemoryNode {
   /**
    ...
    */
   public SEMemoryBlockContract(ISEDebugTarget target, 
                                ISENode parent, 
                                ISEThread thread) {
