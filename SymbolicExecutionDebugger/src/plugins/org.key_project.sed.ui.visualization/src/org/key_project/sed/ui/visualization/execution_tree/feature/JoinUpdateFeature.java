...
/**
 * Implementation of {@link IUpdateFeature} for {@link ISEJoin}s.
 * @author Martin Hentschel
 */
public class JoinUpdateFeature extends AbstractDebugNodeUpdateFeature {
   /**
    * Constructor.
    * @param fp The {@link IFeatureProvider} which provides this {@link IUpdateFeature}.
    */   
   public JoinUpdateFeature(IFeatureProvider fp) {
      super(fp);
   }
