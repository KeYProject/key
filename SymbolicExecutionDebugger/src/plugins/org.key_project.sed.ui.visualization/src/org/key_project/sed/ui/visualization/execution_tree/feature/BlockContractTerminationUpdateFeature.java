...
/**
 * Implementation of {@link IUpdateFeature} for {@link ISEBlockContractTermination}s.
 * @author Martin Hentschel
 */
public class BlockContractTerminationUpdateFeature extends AbstractDebugNodeUpdateFeature {
   /**
    * Constructor.
    * @param fp The {@link IFeatureProvider} which provides this {@link IUpdateFeature}.
    */   
   public BlockContractTerminationUpdateFeature(IFeatureProvider fp) {
      super(fp);
   }
