 ...
 */
public class GraphitiCallStackFilter extends AbstractPropertySectionFilter {
   /**
    * {@inheritDoc}
    */
   @Override
   ...
   protected boolean accept(PictogramElement pe, AbstractGraphitiDebugNodePropertySection section) {
      try {
         ISENode debugNode = section.getDebugNode(pe);
         return debugNode != null && !ArrayUtil.isEmpty(debugNode.getCallStack());
      }
