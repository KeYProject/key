...
public class RadioButtonsManager extends AbstractQuestionInputManager {
   ...
   public RadioButtonsManager(FormToolkit toolkit, 
                              Composite parent, 
                              QuestionInput questionInput, 
                              RadioButtonsQuestion question,
   ...
   protected void createwithChildQuestionControls(FormToolkit toolkit, RadioButtonsQuestion question, ICreateControlCallback callback) {
   ...
   protected void createNoChildQuestionControls(FormToolkit toolkit, RadioButtonsQuestion question) {
   ...
   protected void createChoiceControl(final FormToolkit toolkit, final Choice choice) {
      ...
      button.addSelectionListener(new SelectionAdapter() {
         ...
         public void widgetSelected(SelectionEvent e) {
            handleButtonSelected(button, choice);
         }
      });
      buttons.add(button);
   }

   protected void handleButtonSelected(Button button, Choice choice) {
   ...
   protected void updateChoiceChildrenEnabled() {
      for (Entry<Choice, List<IQuestionInputManager>> entry : choiceManagers.entrySet()) {
         boolean enabled = isEnabled() && ObjectUtil.equals(entry.getKey().getValue(), questionInput.getValue());
