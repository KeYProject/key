...
public class RadioButtonsManager extends AbstractButtonsManager<RadioButtonsQuestion> {
   public RadioButtonsManager(FormToolkit toolkit, Composite parent, QuestionInput questionInput, RadioButtonsQuestion question, ICreateControlCallback callback) {
