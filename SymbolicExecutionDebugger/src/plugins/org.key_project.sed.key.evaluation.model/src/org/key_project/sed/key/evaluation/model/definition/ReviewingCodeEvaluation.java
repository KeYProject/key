...
public class ReviewingCodeEvaluation extends AbstractEvaluation {
   ...
   private QuestionPage createValueSearchQuestionPage(String pageName, String title) {
      ...
      CheckboxQuestion methodProblems = new CheckboxQuestion("methodProblems", 
                                                             ...
                                                             true,
                                                             new Choice("All array elements are considered during search in case that an element matches instance field value", "AllConsideredFound"), 
                                                             new Choice("All array elements are considered during search in case that no element matches instance field value", "AllConsideredNotFound"), 
                                                             new Choice("Not all array elements are considered during search in case that an element matches instance field value", "NotAllConsideredFound"), 
                                                             new Choice("Not all array elements are considered during search in case that no element matches instance field value", "NotAllConsideredNotFound"), 
                                                             new Choice("Index of first array element matching instance field value is returned", "FirstFoundReturned"),
                                                             new Choice("Not the index of first array element matching instance field value is returned", "NotFirstFoundReturned"), 
                                                             ...
                                                             new Choice("Value at returned array index might not be equal to the value to search (parameter value)", "WrongIndex", true), 
                                                             new Choice("Returned value might not be equal to the value to search (parameter value)", "WrongValue"), 
      ...
      CheckboxQuestion returnValue = new CheckboxQuestion("returnValue", 
                                                          ...
                                                          new Choice("-1 is returned if no element matches instance field value", "MinusOneNotFound", true),
                                                          new Choice("-1 might be returned if an element matches instance field value", "MinusOneFound"),
                                                          ...
                                                          new Choice("An integer within array bounds might be retruned if no element matches instance field value", "IndexNotFoundReturned"),
                                                          new Choice("An integer within array bounds is retruned if an element matches instance field value", "IndexFoundReturned", true));
   ...
   private TabQuestion createSetTab() {
      ...
      CheckboxQuestion methodProblems = new CheckboxQuestion("methodProblems", 
                                                             ...
                                                             new Choice("All ArrayListener of arrayListeners at call time might be informed about the change", "ArrayListenerInformed"), 
