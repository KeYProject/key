...
public class ReviewingCodeEvaluation extends AbstractEvaluation {
   ...
   private TabQuestion createSetTab() {
      ...
      CheckboxQuestion methodProblems = new CheckboxQuestion("methodProblems", 
                                                             ...
                                                             new Choice("All ArrayListener of arrayListeners might be informed about the change", "ArrayListenerInformed"), 
                                                             new Choice("Not all ArrayListener of arrayListeners might be informed about the change", "ArrayListenerNotInformed", true), 
