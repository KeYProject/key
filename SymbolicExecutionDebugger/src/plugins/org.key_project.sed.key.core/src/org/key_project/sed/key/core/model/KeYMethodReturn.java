...
/**
 * Implementation of {@link ISEMethodReturn} for the symbolic execution debugger (SED)
 * based on KeY.
 * @author Martin Hentschel
 */
public class KeYMethodReturn extends AbstractSEMethodReturn implements IKeYSENode<IExecutionMethodReturn>, IKeYBaseMethodReturn {
   /**
