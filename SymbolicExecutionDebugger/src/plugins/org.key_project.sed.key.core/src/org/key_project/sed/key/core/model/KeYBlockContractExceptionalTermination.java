...
/**
 * Implementation of {@link ISEBlockContractExceptionalTermination} for the symbolic execution debugger (SED)
 * based on KeY.
 * @author Martin Hentschel
 */
public class KeYBlockContractExceptionalTermination extends AbstractSEBlockContractExceptionalTermination implements IKeYTerminationNode<IExecutionTermination> {
   /**
    ...
    */
   public KeYBlockContractExceptionalTermination(KeYDebugTarget target, 
                                                 IKeYSENode<?> parent, 
                                                 KeYThread thread, 
