...
public class ProofCollections {
    public static ProofCollection automaticJavaDL() throws IOException {
        var settings = new ProofCollectionSettings(null, new ArrayList<>());
        ...
        comprehensions.provable("g.provable(./heap/comprehensions/sum2.key");
        comprehensions.provable("g.provable(./heap/comprehensions/sum3.key");
        comprehensions.provable("g.provable(./heap/comprehensions/segsum.key");
        comprehensions.provable("g.provable(./heap/comprehensions/bsum_negative.key");
        comprehensions.provable("g.provable(./heap/comprehensions/bsum_neg2.key");
        comprehensions.provable("g.provable(./heap/comprehensions/bsumSplit.key");
        comprehensions.provable("g.provable(./heap/comprehensions/bprodSplit.key");
        comprehensions.provable("g.notprovable(./heap/comprehensions/bsumSplitInvalid.key");
    ...
    public ProofCollection automaticInfFlow() {
        var settings = new ProofCollectionSettings(null, new ArrayList<>());
        var c = new ProofCollection(settings);
        /*
         * Defines a base directory.
