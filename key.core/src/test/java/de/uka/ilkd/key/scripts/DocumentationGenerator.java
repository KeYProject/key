...
/**
 * Generates the Markdown documentation page for all registered KeY proof script commands.
 * <p>
 * The output is written to {@code System.out} and is intended to be committed to the
 * {@code key-docs} repository.
 * <p>
 * Usage:
 * <ul>
 * <li>Without arguments: prints Markdown to standard output.</li>
 * <li>With one argument: redirects output to the given file path.</li>
 * </ul>
 * To update the documentation in {@code key-docs}, run this generator and redirect/write the
 * result to the target Markdown file in that repository. This is
 * `key-docs/docs/user/ProofScripts/commands.md`.
 */
        ...
        System.out.printf(
            """
                    ...
                    !!! note "Document generation"
                        ...
                        This document is generated by the class `DocumentGenerator`. Look for that in the sources
                        to find out how to produce a new revision of this document.
                    """,
