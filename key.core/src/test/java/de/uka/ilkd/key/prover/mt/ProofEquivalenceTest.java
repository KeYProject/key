...
/**
 * The equivalence gate for the goal-level multithreading effort (branch {@code bubel/mt-goals}).
 *
 * <p>
...
public class ProofEquivalenceTest {
    ...
    @ValueSource(
        strings = { "prop_chain.key", "prop_split.key", "fol_quant.key", "fol_split_skolem.key",
            "arith_poly.key" })
