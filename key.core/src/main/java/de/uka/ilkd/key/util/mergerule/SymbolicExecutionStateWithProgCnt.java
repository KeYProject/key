 ...
 */
public record SymbolicExecutionStateWithProgCnt(Term symbolicState,Term pathCondition,Term programCounter,@Nullable Node correspondingNode){
/**
 ...
 */
public SymbolicExecutionState toSymbolicExecutionState(){return new SymbolicExecutionState(symbolicState,pathCondition);}

@Override public String toString(){final Services services=getCorrespondingNode().proof().getServices();
