...
import de.uka.ilkd.key.rule.WhileInvariantRule.AnonUpdateData;
import de.uka.ilkd.key.rule.WhileInvariantRule.Instantiation;
...
@AutoService(WhileInvariantRule.WhileInvariantHook.class)
public class InfFlowWhileInvariantHook implements WhileInvariantRule.WhileInvariantHook {
    ...
    public void rewriteStandardGoals(Services services, Goal init, Goal preserve, Goal terminate,
        ...
        if (InfFlowCheckInfo.isInfFlow(preserve) && inst.inv.hasInfFlowSpec(services)) {
            ...
            InfFlowData infFlowData = setUpInfFlowValidityGoal(preserve, loopRuleApp, inst, guardJb,
    ...
    private static InfFlowData prepareSetUpOfInfFlowValidityGoal(final Goal infFlowGoal,
        ...
        WhileInvariantRule.instantiate(ruleApp, services);
