 ...
 * @param tb term builder
 */
public static Context inMethod(@NonNull IProgramMethod pm,TermBuilder tb){var classType=pm.getContainerType();var selfVar=createSelfVar(tb,classType,pm.isStatic());return inMethodWithSelfVar(pm,selfVar);}
 ...
 */
public static Context inMethodWithSelfVar(@NonNull IProgramMethod pm,LocationVariable selfVar){var mode=JMLInfoExtractor.getSpecMathModeOrDefault(pm);return new Context(mode,pm.getContainerType(),selfVar);}
 ...
 * @param tb term builder
 */
public static Context inClass(@NonNull KeYJavaType classType,boolean isStaticContext,TermBuilder tb){var selfVar=createSelfVar(tb,classType,isStaticContext);var mode=JMLInfoExtractor.getSpecMathModeOrDefault(classType);return new Context(mode,classType,selfVar);}
 ...
 */
public Context orWithSpecMathMode(@Nullable SpecMathMode mode){return mode==null?this:new Context(mode,this.classType,this.selfVar);}}
