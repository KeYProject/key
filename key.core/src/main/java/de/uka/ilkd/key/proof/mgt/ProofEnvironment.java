 ...
 * the environment is equal, there is an InitConfig contained to be used to start proofs of this
 * environment.
 */
public class ProofEnvironment {
    ...
    /**
     * registers a proof loaded with the given {@link ProofOblInput}. The
