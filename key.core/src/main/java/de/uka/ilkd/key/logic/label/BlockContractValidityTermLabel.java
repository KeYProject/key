 ...
 */
@Override public ProgramVariable exceptionVariable(){return exceptionVariable;}

/**
 * {@inheritDoc}
 */
@Override public ProgramVariable getTLChild(int i){if(i==0){return exceptionVariable();}return null;}
