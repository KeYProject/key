...
import de.uka.ilkd.key.java.ast.declaration.ArrayInitializer;
...
public class PrettyPrinter implements Visitor {
    ...
    private void performActionOnMemberDeclarations(ImmutableArray<MemberDeclaration> members) {
