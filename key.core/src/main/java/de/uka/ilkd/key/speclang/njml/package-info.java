 ...
 * are parsed and wrapped into {@code TextualJML*} part. Second these are interpreted and attached to
 * the {@link de.uka.ilkd.key.proof.mgt.SpecificationRepository}
 * This process happens in the legacy package {@link de.uka.ilkd.key.speclang.jml}.
 * <p>
