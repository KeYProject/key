...
class Sequent extends org.key_project.prover.sequent.Sequent {
    ...
    @Override
    protected org.key_project.prover.sequent.Sequent createSequent(Semisequent newAntecedent, Semisequent newSuccedent) {
        return newAntecedent.isEmpty() && newSuccedent.isEmpty() ?
                EMPTY_SEQUENT : new Sequent(newAntecedent,newSuccedent);
    }
