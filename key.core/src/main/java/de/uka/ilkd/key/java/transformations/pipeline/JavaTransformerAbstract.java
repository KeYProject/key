...
/**
 * {@link JavaTransformer} with an internal state towards the current
 ...
 */
@NullMarked
public abstract class JavaTransformerAbstract implements JavaTransformer {
    /**
     ...
     *        model information
     */
    public JavaTransformerAbstract(TransformationPipelineServices services) {
