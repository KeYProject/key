 ...
 */
@NullMarked
public class BlockContractExternalBuiltInRuleApp<T extends BlockContractExternalRule>
    ...
    @Override
    public BlockContractExternalBuiltInRuleApp<T> replacePos(final PosInOccurrence newOccurrence) {
        return new BlockContractExternalBuiltInRuleApp<>(builtInRule, newOccurrence, ifInsts,
            getStatement(), contract, heaps);
    }

    @Override
    public BlockContractExternalBuiltInRuleApp<T> setAssumesInsts(
    ...
    @Override
    public BlockContractExternalBuiltInRuleApp<T> tryToInstantiate(final Goal goal) {
        return (BlockContractExternalBuiltInRuleApp<T>) super.tryToInstantiate(goal,
