...
public final class SpecificationRepository {
    ...
    /**
     * Key for identification of block contracts.
     *
     * @param block the statement block in which the block occurs
     * @param file  given file
     * @param pos   counting multiple block contracts
     */
    private record BlockContractKey(StatementBlock block, URI file, Integer pos) {
    }

    /**
     * Key for identification of loop contracts.
     *
     * @param block the statement block in which the loop occurs
     * @param file  given file
     * @param pos   counting multiple loop contracts
     */
