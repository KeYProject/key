...
public class IntermediateProofReplayer {
                                ...
                                try {
                                    ...
                                    for (PartnerNode partnerNodeInfo : partnerNodesInfo) {
                                        Iterator<Node> children =
                                                partnerNodeInfo.partner.childrenIterator();
    ...
    private MergeRuleBuiltInRuleApp instantiateJoinApp(final MergeAppIntermediate joinAppInterm,
        ...
        for (PartnerNode partnerNodeInfo : partnerNodesInfo) {
            ...
            var partnerSEState =
                    sequentToSETriple(partnerNodeInfo.partner, partnerNodeInfo.pio, services);
            ...
            joinPartners = joinPartners.append(
                    new MergePartner(proof.getOpenGoal(partnerNodeInfo.partner), partnerNodeInfo.pio));
        }
    ...
    /**
     * Data class representing partner nodes for the merge rule replay.
     *
     * @param partner
     * @param pio
     * @param third
     * @author weigl
     */
    public record PartnerNode(Node partner, PosInOccurrence pio, NodeIntermediate third) {
    }
}
