        ...
        public Object visit(UnaryExpr n, Void arg) {
            ...
            switch (n.getOperator()) {
                ...
                case POSTFIX_INCREMENT:
                    if (value instanceof Integer) return 1 + (Integer) value;
                    if (value instanceof Long) return 1 + (Long) value;
                    if (value instanceof Byte) return 1 + (Byte) value;
                    if (value instanceof Short) return 1 + (Short) value;
                    if (value instanceof Double) return 1 + (Double) value;
                    if (value instanceof Float) return 1 + (Float) value;
                    throw new RuntimeException();
                ...
                case POSTFIX_DECREMENT:
                    ...
                    if (value instanceof Short) return ((Short) value) - 1;
