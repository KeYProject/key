...
public class FocusOnSelectionAndHideCommand
    ...
    private void hideAll(Sequent toKeep) throws ParserException, ScriptException {
        while (true) {
            ...
            if (g != null) {
                ...
                SequentFormula toHide = iterateThroughSequentAndFindNonMatch(g, toKeep);
    ...
    private SequentFormula iterateThroughSequentAndFindNonMatch(Goal g, Sequent toKeep)
        ...
        while (iterator.hasNext()) {
            ...
            /*
             * if(form.formula().equalsModRenaming(t) ){ isIn = true; }
             */
