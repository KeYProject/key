 ...
 * {@link EqualsModProperty} as parameters
 * to unify equality checks and hashing modulo different properties.
 *
...
public interface TermProperty {
     ...
     *
     * @param term the term to check for equality with <code>other</code>
     * @param other the object to check for equality with <code>term</code>
     * @return whether <code>term</code> and <code>other</code> are equal ignoring a certain
     *         property
     */
     ...
     * @return the hash code of <code>term</code>
     */
