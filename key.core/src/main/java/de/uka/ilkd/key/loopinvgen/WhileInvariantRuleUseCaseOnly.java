...
//
// public final class WhileInvariantRuleUseCaseOnly implements BuiltInRule {
// /**
...
//
// public static final WhileInvariantRuleUseCaseOnly INSTANCE = new WhileInvariantRuleUseCaseOnly();
//
// public static final Name NAME = new Name("Loop Invariant Use Case");
//
...
// final Term baseHeap = UpdateData.loopHeapAtPre;
...
//
// final Term heapAtPost = UpdateData.loopHeap;
...
// //-------------------------------------------------------------------------
//
// private WhileInvariantRuleUseCaseOnly() {
// }
//
//
// //-------------------------------------------------------------------------
...
// final ImmutableSet<ProgramVariable> localIns,
// final ImmutableSet<ProgramVariable> localOuts,
// final ImmutableList<AnonUpdateData>
// anonUpdateDatas,
// final Term anonUpdate,
// Services services)
// throws RuleAbortException {
...
// }
// // active must be while loop
// final SourceElement active = JavaTools.getActiveStatement(progPost.javaBlock());
// if (!(active instanceof While)) {
// return false;
// }
// return true;
// }
