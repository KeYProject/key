...
public class TermBuilder {
    ...
    public Term matrixRange(Term heap, Term matrix, Term rowStart, Term rowEnd, Term colStart,
            Term colEnd) {
    ...
    public Term unlabelRecursive(Term term) {
        ...
        return term.hasLabels() ? tf.createTerm(term.op(), subs, term.boundVars(), null) : term;
    }
    ...
    public Term relaxedRPred(Term locSet, Term counter) {
        final DependenciesLDT dependenciesLDT = services.getTypeConverter().getDependenciesLDT();
        return func(dependenciesLDT.getRelaxedRPred(), locSet, counter);
    }

    public Term relaxedWPred(Term locSet, Term counter) {
        final DependenciesLDT dependenciesLDT = services.getTypeConverter().getDependenciesLDT();
    ...
    public Term timestamp() {
        final DependenciesLDT dependenciesLDT = services.getTypeConverter().getDependenciesLDT();
        return this
                .var(locationVariable("timestamp", dependenciesLDT.getTimestamp().sort(), false));
    }
