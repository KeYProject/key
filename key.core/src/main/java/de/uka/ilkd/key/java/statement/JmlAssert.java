...
public class JmlAssert extends JavaStatement {
    ...
    public JmlAssert(TextualJMLAssertStatement.Kind kind, String label, KeyAst.Expression condition,
                     AssertionProofContext assertionProof, PositionInfo positionInfo) {
        super(positionInfo);
        this.kind = kind;
        this.optLabel = label;
    ...
    public JmlAssert(JmlAssert other) {
        this(other.kind, other.optLabel, other.condition,
                other.assertionProof, other.getPositionInfo());
    }
