 ...
 *
 * To create such a program use the static method {@link #createProgram(JTerm)} and provide as
 * argument the pattern for which you want to get a matcher.
 *
 * The program is executed by invoking
 * {@link TacletMatchProgram#match(JTerm, MatchConditions, Services)}.
 */
public class TacletMatchProgram {
     ...
     */
    public static TacletMatchProgram createProgram(JTerm pattern) {
     ...
     *
     * @param p_toMatch the {@link JTerm} to match
     ...
     */
    public MatchConditions match(JTerm p_toMatch, MatchConditions p_matchCond,
