...
public interface RuleCompletionHandler {
     ...
     *
     * @param models
     *        the partial models with all different possible instantiations found
     *        automatically
     * @param goal
     ...
     * @param forced
     *        a boolean indicating if the rule should be applied without any additional
     *        interaction from the user provided that the application object can be made complete
     *        automatically
