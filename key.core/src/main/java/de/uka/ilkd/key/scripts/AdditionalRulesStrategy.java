...
class AdditionalRulesStrategy extends FilterStrategy {
    ...
    private List<Pair<String, RuleAppCost>> parseAddRules(String additionalRules) {
        List<Pair<String, RuleAppCost>> result = new ArrayList<>();
    ...
    private Optional<RuleAppCost> lookup(String name) {
