...
public class ExpressionBuilder extends DefaultBuilder {
    ...
    @Override
    public Term visitElementary_state_update_term(
            KeYParser.Elementary_state_update_termContext ctx) {
        Term a = accept(ctx.a);
        Term b = accept(ctx.b);
        if (b != null) {
    ...
    @Override
    public Term visitElementary_dependency_update_term(
            KeYParser.Elementary_dependency_update_termContext ctx) {
