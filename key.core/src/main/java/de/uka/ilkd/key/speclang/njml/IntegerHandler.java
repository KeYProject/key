...
public class IntegerHandler extends LDTHandler {
    private final Map<JMLOperator, TypedOperator> jmlCheckedIntMap = new EnumMap<>(JMLOperator.class);
    private final Map<JMLOperator, TypedOperator> jmlCheckedLongMap = new EnumMap<>(JMLOperator.class);
    ...
    public IntegerHandler(Services services, SpecMathMode specMathMode) {
        ...
        jmlIntMap.put(UNSIGNED_SHIFT_RIGHT, new TypedOperator(intKjt, intLDT.getUnsignedshiftrightJint()));
        ...
        jmlCheckedIntMap.put(BITWISE_AND, new TypedOperator(intKjt, intLDT.getCheckedBitwiseAndInt()));
        jmlCheckedIntMap.put(BITWISE_OR, new TypedOperator(intKjt, intLDT.getCheckedBitwiseOrInt()));
        jmlCheckedIntMap.put(BITWISE_XOR, new TypedOperator(intKjt, intLDT.getCheckedBitwiseXOrInt()));
        jmlCheckedIntMap.put(SHIFT_RIGHT, new TypedOperator(intKjt, intLDT.getCheckedShiftRightInt()));
        jmlCheckedIntMap.put(SHIFT_LEFT, new TypedOperator(intKjt, intLDT.getCheckedShiftLeftInt()));
        jmlCheckedIntMap.put(UNSIGNED_SHIFT_RIGHT, new TypedOperator(intKjt, intLDT.getCheckedUnsignedShiftRightInt()));
        // jmlCheckedIntMap.put( new TypedOperator(intKjt,BITWISE_NEGATE, inCheckedtLDT.getBitwiseNegateInt()));
        jmlCheckedIntMap.put(UNARY_MINUS, new TypedOperator(intKjt, intLDT.getCheckedUnaryMinusInt()));
        ...
        jmlLongMap.put(UNSIGNED_SHIFT_RIGHT, new TypedOperator(longKjt, intLDT.getUnsignedshiftrightJlong()));
        // jmlLongMap.put(new TypedOperator(longKjt, BITWISE_NEGATE, intLDT.getBitwiseNegateJlong()));
        ...
        jmlCheckedLongMap.put(BITWISE_AND, new TypedOperator(longKjt, intLDT.getCheckedBitwiseAndLong()));
        jmlCheckedLongMap.put(BITWISE_OR, new TypedOperator(longKjt, intLDT.getCheckedBitwiseOrLong()));
        jmlCheckedLongMap.put(BITWISE_XOR, new TypedOperator(longKjt, intLDT.getCheckedBitwiseXOrLong()));
        jmlCheckedLongMap.put(SHIFT_RIGHT, new TypedOperator(longKjt, intLDT.getCheckedShiftRightLong()));
        jmlCheckedLongMap.put(SHIFT_LEFT, new TypedOperator(longKjt, intLDT.getCheckedShiftLeftLong()));
        jmlCheckedLongMap.put(UNSIGNED_SHIFT_RIGHT, new TypedOperator(longKjt, intLDT.getCheckedUnsignedShiftRightLong()));
        // jmlCheckedLongMap.put(new TypedOperator(longKjt, BITWISE_NEGATE, inCheckedtLDT.getBitwiseNegateLong()));
        jmlCheckedLongMap.put(UNARY_MINUS, new TypedOperator(longKjt, intLDT.getCheckedUnaryMinusLong()));
        ...
        // jmlBigintMap.put(new TypedOperator(bigIntKjt, UNSIGNED_SHIFT_RIGHT, intLDT.getUnsignedshiftrightJlong()));
        // jmlBigintMap.put(new TypedOperator(bigIntKjt, BITWISE_NEGATE, intLDT.getBitwiseNegate()));
