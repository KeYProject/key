...
public class FunctionOperationContractPOLoader implements ProofObligationLoader {
    ...
    public IPersistablePO.LoadedPOContainer loadFrom(InitConfig initConfig, Configuration properties) throws IOException {
        ...
        if (contract == null) {
            ...
            ProofOblInput po;
            boolean addUninterpretedPredicate = AbstractOperationPO.isAddUninterpretedPredicate(properties);
            boolean addSymbolicExecutionLabel = AbstractOperationPO.isAddSymbolicExecutionLabel(properties);
