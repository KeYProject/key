/**
 * <p> provides a representation for the term and sequent
 ...
 * de.uka.ilkd.key.logic.TermFactory}. </p>
 * <p> The function of {@link de.uka.ilkd.key.logic.Term}s (e.g., if
 ...
 * de.uka.ilkd.key.logic.Term} is constructed.</p>
 * <p> {@link de.uka.ilkd.key.logic.Sequent}s consist of two {@link
 ...
 * de.uka.ilkd.key.logic.sort.Sort#FORMULA}. </p>
 * <p> {@link de.uka.ilkd.key.logic.Sequent}s and {@link
