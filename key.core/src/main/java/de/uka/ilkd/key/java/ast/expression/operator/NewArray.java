 ...
 * constructors are predefined) and is not used as a Statement (since there are no side-effects in
...
public class NewArray extends TypeOperator implements Reference, ReferencePrefix {
     ...
     *
     * @param arguments
     *        an array of expressions describing the dimensions
     * @param typeRef
     *        a reference to the arraytype
     * @param init
     ...
     */
    public NewArray(
            Expression[] arguments, TypeReference typeRef, KeYJavaType keyJavaType,
    ...
    public SourceElement getLastElement() {
        return Objects.requireNonNullElse(arrayInitializer, this);
    }
