    ...
    private static class PosTableStringBackend extends StringBackend<Mark> {
        ...
        public void mark(Mark pair) {
            ...
            switch (markType) {
                ...
                case MARK_END_KEYWORD -> initPosTbl.addKeywordRange(new Range(keywordStarts.pop(), count()));
                case MARK_START_JAVA_BLOCK -> javaBlockStarts.push(count());
                case MARK_END_JAVA_BLOCK -> initPosTbl.addJavaBlockRange(new Range(javaBlockStarts.pop(), count()));
