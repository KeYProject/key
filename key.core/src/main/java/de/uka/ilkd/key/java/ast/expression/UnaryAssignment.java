...
public final class UnaryAssignment extends Operator
        implements ExpressionStatement, ProgramElementWithKind<UnaryAssignment.UnaryAssignmentKind> {
    ...
    public UnaryAssignment(PositionInfo pi, List<Comment> c, UnaryAssignmentKind kind, Expression sub) {
