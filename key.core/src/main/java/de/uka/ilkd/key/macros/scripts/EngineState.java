...
public class EngineState {
    private static final JFunction ELLIPSIS_FORMULA = new JFunction(new Name("__"), JavaDLTheory.FORMULA) ;
    ...
    public Term toTerm(String string, Sort sort) throws ParserException, ScriptException {
        final KeyIO io = getKeyIO();
        Namespace<JFunction> functions = io.getServices().getNamespaces().functions();
        functions.addSafely(ELLIPSIS);
        functions.addSafely(ELLIPSIS_FORMULA);
