...
public abstract class AbstractAuxiliaryContractImpl implements AuxiliaryContract {
    ...
    @Override
    public Term getModifiableClause(final LocationVariable heap, final ProgramVariable self,
            final Services services) {
    ...
    @Override
    public Term getFreeModifiableClause(final LocationVariable heap, final ProgramVariable self,
            final Services services) {
        return getTerm(
