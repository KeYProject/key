...
public class POSnippetFactory {
    ...
    public static @NonNull BasicPOSnippetFactory getBasicFactory(
            @NonNull FunctionalOperationContract contract,
            ProofObligationVars vars, @NonNull Services services) {
        return new BasicPOSnippetFactoryImpl(contract, vars, services);
    }

    public static @NonNull BasicPOSnippetFactory getBasicFactory(
            @NonNull LoopSpecification invariant,
            ProofObligationVars vars, ExecutionContext context, @NonNull Term guardTerm,
            @NonNull Services services) {
        return new BasicPOSnippetFactoryImpl(invariant, vars, context, guardTerm, services);
    }

    public static @NonNull BasicPOSnippetFactory getBasicFactory(
            @NonNull InformationFlowContract contract,
            ProofObligationVars vars, @NonNull Services services) {
        return new BasicPOSnippetFactoryImpl(contract, vars, services);
    }
    ...
    public static @NonNull InfFlowPOSnippetFactory getInfFlowFactory(
            @NonNull LoopSpecification invariant,
    ...
    public static @NonNull InfFlowPOSnippetFactory getInfFlowFactory(
            @NonNull BlockContract contract,
            @NonNull ProofObligationVars vars1, @NonNull ProofObligationVars vars2,
            ExecutionContext context,
            @NonNull Services services) {
