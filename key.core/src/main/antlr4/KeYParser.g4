...
sequential_update_term:
    a=parallel_term (SEMI parallel_term)*;
parallel_term:
...
update_term: (LBRACE u=parallel_term RBRACE) (atom_prefix | unary_formula | elementary_dependency_update_term);
...
varexpId: // weigl, 2021-03-12: This will be later just an arbitrary identifier. Only for backwards compatibility.
  ...
  | ONLY_ANON_EVENT_UPDATES
  | ONLY_INVERSE_ANON_EVENT_UPDATES
  | APPLY_ANON_EVENT_UPDATE_ON_RIGID
  | APPLY_INVERSE_ANON_EVENT_UPDATE_ON_RIGID
;
