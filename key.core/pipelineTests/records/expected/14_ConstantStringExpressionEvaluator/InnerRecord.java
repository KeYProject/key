class OuterClass {
    ...
    final class MyRecord extends Record {
        ...
        public void $init(OuterClass $ENCLOSING_THIS) {
            super.$init();
    ...
    public static OuterClass $createObject() {
        OuterClass __NEW__;
        //Created by CreateObjectBuilder.java:70
        __NEW__ = OuterClass.$allocate();
        __NEW__.$create()@OuterClass
        return __NEW__;
    }
}
