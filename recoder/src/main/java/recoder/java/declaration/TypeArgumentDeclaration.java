...
public class TypeArgumentDeclaration extends JavaNonTerminalProgramElement
    ...
    protected TypeArgumentDeclaration(TypeArgumentDeclaration proto) {
        ...
        if (proto.typeReference != null) { this.typeReference = proto.typeReference.deepClone(); }
        makeParentRoleValid();
    }
    ...
    public TypeReference getTypeReferenceAt(int index) {
        if (index == 0 && typeReference != null) { return typeReference; }
    ...
    public int getChildPositionCode(ProgramElement child) {
        // 0: typeReference
        if (child == typeReference) { return 0; }
        return -1;
    }
    ...
    /**
     * @param tr
     *        either a TypeReference, a URQ, or an MethodReference
     * @throws IllegalArgumentException
     *         if <code>tr</code> isn't of type TypeReference, URQ, or
     *         MethodReference
     */
    ...
    public ASTList<TypeArgumentDeclaration> getTypeArguments() {
        if (wildcardMode == WildcardMode.Any) { return null; }
    ...
    public SourceElement getFirstElement() {
        if (wildcardMode != WildcardMode.None) { return this; }
