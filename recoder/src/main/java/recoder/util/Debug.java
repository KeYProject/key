 ...
 * This file is part of KeY since 2ß21 - https://key-project.org
...
public class Debug {
    ...
    /**
     * Strings that are regarded as having a somewhat negative touch. Options with these values (or
    ...
    /**
     * Finds out whether the properties contain a key with the given name and whether it is set to a
     * positive value. Positives values are everything but "", "0", "false", "off", "no", "none".
     */
    ...
    /**
     * Print out a string if it the option is set. At first call, read the properties from file
     * .recoderrc.
     */
    ...
    /**
     * Receives a string with a stack trace for the caller of this method. The implementation
     * assumes that the output format of Throwable.printStackTrace does not change in future
     * versions of the JDK. The resulting string contains no exception name and does not end with a
     * linefeed.
     */
    ...
    /**
     * Returns the amount of memory used by the virtual machine. Generational garbage collectors
     * might obscure the result; therefore, the garbage collector is run until only minor changes
     * are observed.
     */
