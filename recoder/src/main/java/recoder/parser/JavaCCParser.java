...
public class JavaCCParser implements JavaCCParserConstants {
    ...
    private static void shiftToken() {
        if (current != token) {
            if (current != null) { while (current.next != token) { current = current.next; } }
            Token prev;
    ...
    static final public EnumDeclaration EnumDeclaration() throws ParseException {
        ...
        setPrefixInfo(result);
        if (declSpecs.size() != 0) { result.setDeclarationSpecifiers(declSpecs); }
        jj_consume_token(IDENTIFIER);
    ...
    static final public EnumConstantDeclaration EnumConstant() throws ParseException {
        ...
        label_12: while (true) {
            ...
            if (annotations == null) { annotations = new ASTArrayList<>(); }
            annot = AnnotationUse();
            annotations.add(annot);
        }
        jj_consume_token(IDENTIFIER);
    ...
    static final public FieldDeclaration FieldDeclaration() throws ParseException {
        ...
        tr = Type();
        if (!hasPrefixInfo) { copyPrefixInfo(tr, result); }
        result.setDeclarationSpecifiers(ml);
    ...
    static final public ParameterDeclaration FormalParameter() throws ParseException {
        ...
        label_41: while (true) {
            ...
            mod = AnnotationUse();
            if (ml == null) { ml = new ASTArrayList<>(); }
            setPrefixInfo(mod);
            setPostfixInfo(mod);
            ml.add(mod);
        }
        ...
        if (ml != null) { result.setDeclarationSpecifiers(ml); }
    ...
    static final public ConstructorDeclaration ConstructorDeclaration() throws ParseException {
        ...
        result.setIdentifier(id);
        result.setParameters(pdl);
        if (!ml.isEmpty()) { result.setDeclarationSpecifiers(ml); }
        if (nl != null) {
            int s = nl.size();
    ...
    static final public TypeReference Type() throws ParseException {
        ...
        if (jj_2_31(2147483647)) {
            ...
            label_46: while (true) {
                ...
                jj_consume_token(LBRACKET);
                jj_consume_token(RBRACKET);
                if (dimension == 0) { setPrefixInfo(result); }
                dimension++;
            }
        ...
        if (jj_2_50(2)) {
            ...
            case NEW:
                ...
                case LPAREN:
                    ...
                    result.setArguments(args);
                    if (cd != null) { ((New) result).setClassDeclaration(cd); }
                    break;
                case LBRACKET:
                    na = factory.createNewArray();
    ...
    static final public NewArray ArrayDimsAndInits(NewArray result) throws ParseException {
        ...
        if (sizes != null) { result.setArguments(sizes); }
    ...
    static final public If IfStatement() throws ParseException {
        ...
        if (elseStat != null) { result.setElse(elseStat); }
        setPostfixInfo(result);
        {
            if (true) { return result; }
        }
    ...
    static final public ASTList<LoopInitializer> ForInit() throws ParseException {
        ...
        if (varDecl != null) {
            ...
            for (Expression expr : exprs) { result.add((LoopInitializer) expr); }
        }
        {
            if (true) { return result; }
        }
    ...
    static final public AnnotationUseSpecification AnnotationUse() throws ParseException {
        ...
        result.setTypeReference(tr);
        if (list != null) { result.setElementValuePairs(list); }
        setPostfixInfo(result);
        {
            if (true) { return result; }
        }
        ...
        if (token.kind == kind) {
            ...
            if (++jj_gc > 100) {
                ...
                for (JJCalls jj_2_rtn : jj_2_rtns) {
                    JJCalls c = jj_2_rtn;
                    while (c != null) { if (c.gen < jj_gen) { c.first = null; } c = c.next; }
                }
            }
            return token;
        }
    ...
    static private void jj_add_error_token(int kind, int pos) {
        ...
        if (pos == jj_endpos + 1) {
            ...
            for (int i = 0; i < jj_endpos; i++) { jj_expentry[i] = jj_lasttokens[i]; }
    ...
    static public ParseException generateParseException() {
        ...
        for (int i = 0; i < 125; i++) { la1tokens[i] = false; }
        if (jj_kind >= 0) {
        ...
        for (int i = 0; i < jj_expentries.size(); i++) { exptokseq[i] = (int[]) jj_expentries.elementAt(i); }
