...
public final class JMLTransformer extends JavaTransformer {
    public static final EnumSet<JMLModifier> javaMods =
            EnumSet.of(JMLModifier.ABSTRACT, JMLModifier.FINAL, JMLModifier.PRIVATE, JMLModifier.PROTECTED,
     ...
     */
    private PositionedString convertToString(ImmutableList<JMLModifier> mods, ParserRuleContext ctx) {
    ...
    private String fillWithWhitespaces(de.uka.ilkd.key.java.Position pos, String s) {
        ...
        sb.append(" ".repeat(Math.max(0, pos.column())));
    ...
    private void transformAssertStatement(TextualJMLAssertStatement stat,
        ...
        de.uka.ilkd.key.java.Position pos = de.uka.ilkd.key.java.Position.fromOneZeroBased(
                ctx.start.getLine(),
