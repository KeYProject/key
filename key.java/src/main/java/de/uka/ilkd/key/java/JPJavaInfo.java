 ...
 */
public final class JPJavaInfo {
    public static final Logger LOGGER = LoggerFactory.getLogger(JPJavaInfo.class);


    private final Services services;
    private JPKeYProgModelInfo kpmi;
     ...
     */
    JPJavaInfo(JPKeYProgModelInfo kpmi, Services s) {
        this.kpmi = kpmi;
        services = s;
    }

    private JPJavaInfo(JPJavaInfo proto, Services s) {
     ...
     */
    public JPKeYProgModelInfo getKeYProgModelInfo() {
        return kpmi;
    }
     ...
     */
    public JPJavaInfo copy(Services serv) {
        return new JPJavaInfo(this, serv);
    }
