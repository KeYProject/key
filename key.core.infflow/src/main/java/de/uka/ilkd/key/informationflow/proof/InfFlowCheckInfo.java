...
public class InfFlowCheckInfo {
    public static final String PROPERTY_STRATEGY_INF_FLOW_CHECK = "INF_FLOW_CHECK_PROPERTY";
    ...
    public static void addInfFlow(StrategyProperties props) {
        props.put(PROPERTY_STRATEGY_INF_FLOW_CHECK, INF_FLOW_CHECK_TRUE);
    }
     ...
     * @param goal a goal.
     */
    public static void addInfFlow(final Goal goal) {
        final boolean oldInfFlowCheckInfoValue =
            goal.getStrategyInfo(INF_FLOW_CHECK_PROPERTY) == Boolean.FALSE;
        StrategyInfoUndoMethod undo =
            strategyInfos -> strategyInfos.put(INF_FLOW_CHECK_PROPERTY, oldInfFlowCheckInfoValue);
        goal.addStrategyInfo(INF_FLOW_CHECK_PROPERTY, false, undo);
    }
}
