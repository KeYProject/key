 ...
 * @author christoph
 */
class SelfcomposedBlockSnippet extends ReplaceAndRegisterMethod implements InfFlowFactoryMethod {
    ...
    public JTerm produce(BasicSnippetData d, ProofObligationVars poVars1,
        ...
        final JTerm exec1 = f1.create(BasicPOSnippetFactory.Snippet.BLOCK_EXEC_WITH_PRE);
        ...
        final JTerm exec2 = replaceQuantifiableVariables(
            f2.create(BasicPOSnippetFactory.Snippet.BLOCK_EXEC_WITH_PRE), qvsToReplace, d.services);
