 ...
 * @version 1 (7/28/25)
 */
public class InfFlowLoopInvariantBuiltInRuleApp extends LoopInvariantBuiltInRuleApp<InfFlowWhileInvariantRule> {

    private @Nullable IFProofObligationVars infFlowVars;

    protected InfFlowLoopInvariantBuiltInRuleApp(InfFlowWhileInvariantRule rule, PosInOccurrence pio,
    ...
    protected InfFlowLoopInvariantBuiltInRuleApp(InfFlowWhileInvariantRule rule, PosInOccurrence pio, LoopSpecification inv,
            TermServices services) {
        super(rule, pio, inv, services);
    }

    public InfFlowLoopInvariantBuiltInRuleApp(InfFlowWhileInvariantRule rule, PosInOccurrence pos, TermServices services) {
    ...
    public InfFlowLoopInvariantBuiltInRuleApp replacePos(PosInOccurrence newPos) {
        return new InfFlowLoopInvariantBuiltInRuleApp(builtInRule, newPos, ifInsts, spec, heapContext, services);
    }

    @Override
    public InfFlowLoopInvariantBuiltInRuleApp setAssumesInsts(ImmutableList<PosInOccurrence> ifInsts) {
        setMutable(ifInsts);
        return this;
    }
    ...
    public InfFlowLoopInvariantBuiltInRuleApp setLoopInvariant(LoopSpecification inv) {
        ...
        return new InfFlowLoopInvariantBuiltInRuleApp(builtInRule, pio, ifInsts, inv, heapContext, services);
    }
