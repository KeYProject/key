...
public class BasicTest {
    ...
    public void testBasic() {
        ...
        var example = "{a = a + b;\n" +
                ...
                "a = a - b;\n" +
                "}";
        var lexer = new org.key_project.rusty.parsing.RustyWhileLexer(CharStreams.fromString(example));
        ...
        services.getNamespaces().programVariables().add(Arrays.stream(new ProgramVariable[]{ a, a_old, b, b_old}).toList());

        var mod = tb.dia(new RustyBlock(block), tb.and(tb.equals(tb.var(a), tb.var(b_old)), tb.equals(tb.var(b), tb.var(a_old))));
        var t = tb.imp(
