...
public class InsertionTerm {
    ...
    public InsertionTerm(InsertionType type, JTerm term, PosInOccurrence pio) {
        Type = type;
        Term = term;
        PIOs  = ImmutableList.fromList(Collections.singleton(pio));
    }

    public InsertionTerm(InsertionType type, JTerm term, ImmutableList<PosInOccurrence> pios) {
        Type = type;
        Term = term;
        PIOs  = pios;
    }

    public InsertionTerm(InsertionType type, JTerm term, Collection<PosInOccurrence> pios) {
        Type = type;
        Term = term;
